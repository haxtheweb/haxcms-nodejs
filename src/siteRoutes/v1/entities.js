...
function buildEntityDescriptors(apiBasePath = '/x/api') {
  return [
    ...
    },
    {
      ...
      primaryKey: 'hash',
      endpoints: [
        `${apiBasePath}/v1/items/{idOrSlug}/revisions`,
        `${apiBasePath}/v1/items/{idOrSlug}/revisions/{revisionId}`,
        `${apiBasePath}/v1/items/{idOrSlug}/revisions/{revisionId}/restore`,
      ],
      filterableFields: [],
