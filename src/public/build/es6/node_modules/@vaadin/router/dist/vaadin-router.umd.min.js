!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).Vaadin = e.Vaadin || {});
}(this, function (e) {
  "use strict";
  ...
  function r(e, t) {
    for (var n = 0; n < t.length; n++) {
      var r = t[n];
      r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(e, (o = r.key, void 0, "symbol" == typeof (a = function (e, t) {
  ...
  function V(e, t) {
    for (var n, r = [], o = 0, a = 0, i = "", c = t && t.delimiter || B, u = t && t.delimiters || N, l = !1; null !== (n = M.exec(e));) {
      ...
      if (i += e.slice(a, h), a = h + s.length, f) i += f[1], l = !0;else {
        ...
        if (!l && i.length) {
          var g = i.length - 1;
          u.indexOf(i[g]) > -1 && (d = i[g], i = i.slice(0, g));
        }
        i && (r.push(i), i = "", l = !1);
  ...
  function K(e, t, n) {
    for (var r = (n = n || {}).strict, o = !1 !== n.start, a = !1 !== n.end, i = H(n.delimiter || B), c = n.delimiters || N, u = [].concat(n.endsWith || []).map(H).concat("$").join("|"), l = o ? "^" : "", s = 0 === e.length, f = 0; f < e.length; f++) {
      var h = e[f];
      if ("string" == typeof h) l += H(h), s = f === e.length - 1 && c.indexOf(h[h.length - 1]) > -1;else {
        var d = h.repeat ? "(?:" + h.pattern + ")(?:" + H(h.delimiter) + "(?:" + h.pattern + "))*" : h.pattern;
        t && t.push(h), h.optional ? h.partial ? l += H(h.prefix) + "(" + d + ")?" : l += "(?:" + H(h.prefix) + "(" + d + "))?" : l += H(h.prefix) + "(" + d + ")";
      }
    }
    return a ? (r || (l += "(?:" + i + ")?"), l += "$" === u ? "$" : "(?=" + u + ")") : (r || (l += "(?:" + i + "(?=" + u + "))?"), s || (l += "(?=" + i + "|" + u + ")")), new RegExp(l, D(n));
  }
  function W(e, t, n) {
    return e instanceof RegExp ? function (e, t) {
      ...
      for (var r = [], o = 0; o < e.length; o++) r.push(W(e[o], t, n).source);
      return new RegExp("(?:" + r.join("|") + ")", D(n));
    }(e, t, n) : function (e, t, n) {
      return K(V(e, n), t, n);
    }(e, t, n);
  }
  L.parse = T, L.compile = U, L.tokensToFunction = I, L.tokensToRegExp = S;
  ...
  var X = function () {
    ...
    return o(e, [{
      ...
      value: function (e) {
        var t;
        return g(e), (t = this.root.__children).push.apply(t, s(h(e))), this.getRoutes();
      }
    }, {
      key: "removeRoutes",
      value: function () {
      ...
      value: function (e) {
        ...
        function u(e) {
          ...
          return a = i || r.next(l), i = null, e || !a.done && function (e, t) {
            ...
            return null !== n && void 0 !== n && n !== O ? (c.result = n.result || n, c) : u(e, t, n);
          })) : (i = a, Promise.resolve(O));
        }
  ...
  function ne(e) {
    ...
    if (!(e instanceof X)) throw new TypeError("An instance of Resolver is expected");
    var n = new Map();
    return function (r, o) {
      var a = ee(n, r);
      ...
      if (!i) {
        ...
        for (var s = Y.parse(c), f = Y.tokensToFunction(s), h = Object.create(null), d = 0; d < s.length; d++) C(s[d]) || (h[s[d].name] = !0);
        i = {
          toPath: f,
          keys: h
      ...
      if (t.stringifyQueryParams && o) {
        ...
        var g = t.stringifyQueryParams(v);
        g && (p += "?" === g.charAt(0) ? g : "?".concat(g));
      }
      return p;
    };
  }
  ...
  var _e = function (e) {
      ...
      return o(s, [{
        ...
        value: function (e) {
          ...
          k(n.children) && (r = r.then(function () {
            ...
            ue(e) || k(n.children) || (e = n.children), function (e, t) {
              ...
              t.__children = [];
              for (var n = h(e), r = 0; r < n.length; r++) y(n[r]), t.__children.push(n[r]);
            }(e, n);
          }));
          var o = {
            redirect: function (t) {
          ...
          return r.then(function () {
            ...
            return ue(e) && (e instanceof HTMLElement || e.redirect || e === O) ? e : C(n.redirect) ? o.redirect(n.redirect) : n.bundle ? (t = n.bundle, C(t) ? w(t) : Promise.race(_.filter(function (e) {
              return e in t;
            }).map(function (e) {
              return w(t[e], e);
          ...
          return this.__findComponentContextAfterAllRedirects(n).then(function (r) {
            ...
            return function e(t) {
              ...
              return t.next(void 0, n, r).then(function (r) {
                return null === r || r === O ? a ? t : null !== n.parent ? e(t, n.parent, r) : r : r;
              });
            }(r).then(function (e) {
              if (null === e || e === O) throw x(o);
              return e && e !== O && e !== r ? t.__fullyResolveChain(o, e) : t.__amendWithOnBeforeCallbacks(r);
            });
          });
        }
      }, {
        ...
        value: function (e) {
          ...
          }) : r instanceof Error ? Promise.reject(r) : Promise.reject(new Error(d('Invalid route resolution result for path "'.concat(e.pathname, '". ') + 'Expected redirect object or HTML element, but got: "'.concat(function (e) {
        ...
        value: function (e) {
          ...
          if (e.__divergedChainIndex = 0, e.__skipAttach = !1, r.length) {
            ...
            } else for (var f = r.length - 1; f >= e.__divergedChainIndex; f--) a = this.__runOnBeforeLeaveCallbacks(a, e, {
              prevent: i
            }, r[f]);
          }
          if (!e.__skipAttach) for (var h = 0; h < o.length; h++) h < e.__divergedChainIndex ? h < r.length && r[h].element && (r[h].element.location = le(e, r[h].route)) : (a = this.__runOnBeforeEnterCallbacks(a, e, {
            prevent: i,
            redirect: c
        ...
        value: function () {
          ...
          if (!(e instanceof Node)) throw new TypeError(d("Expected router outlet to be a valid DOM Node (but got ".concat(e, ")")));
        }
      }, {
    ...
    ye = window.Vaadin && window.Vaadin.Flow && window.Vaadin.Flow.clients;
  function ge(e, t) {
  ...
  var we = function (e, t) {
    if (window.Vaadin.developmentMode) return ge(e, t);
  };
  function be() {}
  void 0 === window.Vaadin.developmentMode && (window.Vaadin.developmentMode = function () {
    try {
      return !!localStorage.getItem("vaadin.developmentmode.force") || ["localhost", "127.0.0.1"].indexOf(window.location.hostname) >= 0 && (ye ? !function () {
        if (ye) {
          var e = Object.keys(ye).map(function (e) {
            return ye[e];
          }).filter(function (e) {
