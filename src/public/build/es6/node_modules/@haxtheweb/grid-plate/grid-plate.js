...
class GridPlate extends LitElement {
  ...
  render() {
    return html`
      <div class="row">
        ${[1, 2, 3, 4, 5, 6].map(num => html`
            <div
              class="column ${this.columns < num ? "not-shown" : "drag-enabled"}"
              id="col${num}"
    ...
    return {
      ...
      settings: {
        configure: [{
          ...
          description: "Check box to force layout to stick regardless of screen size",
          inputMethod: "boolean"
        }, {
      ...
      saveOptions: {
        unsetAttributes: ["ready", "layouts", "columns", "options", "responsive-width", "responsive-size", "breakpoint-sm", "breakpoint-md", "breakpoint-lg", "breakpoint-xl"]
      },
      demoSchema: [{
        tag: "grid-plate",
        properties: {
        ...
        content: '<p slot="col-1">Column one content to replace</p><p slot="col-2">Column two content to replace</p>'
      }]
    };
  }
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (["responsiveSize", "layout", "layouts", "disableResponsive", "itemPadding", "itemMargin"].includes(propName)) {
