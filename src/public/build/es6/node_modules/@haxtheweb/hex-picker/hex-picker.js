...
class HexPicker extends LitElement {
  ...
  _fieldSetChange(event) {
    let colorValueLabel = this.shadowRoot.querySelector(`#${event.target.id}_out`);
  ...
  updated(changedProperties) {
    changedProperties.forEach((oldValue, propName) => {
      if (propName === "value" && this[propName]) {
        this.shadowRoot.querySelector(".color-square").style.backgroundColor = this.value;
        this.shadowRoot.querySelector("input").value = this.value;
        if (this.largeDisplay) {
          this.shadowRoot.querySelector(".large-display").style.backgroundColor = this.value;
        }
