  ...
  render() {
    return html`
      <div class="card">
        ...
        >
          ${this.imageSrc ? html` <img src="${this.imageSrc}" class="image" part="image" /> ` : ""}
  ...
  static get haxProperties() {
    return {
      ...
      demoSchema: [{
        ...
        content: '<h3 slot="heading">Accent Card</h3><h5 slot="subheading">A card with optional accent stylings.</h5><div slot="content"><p>This card is highly customizable to contain any content you\'d like</p></div>'
      }],
      saveOptions: {
