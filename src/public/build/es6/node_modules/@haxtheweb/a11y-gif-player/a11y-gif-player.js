 ...
 */
class A11yGifPlayer extends I18NMixin(IntersectionObserverMixin(SchemaBehaviors(LitElement))) {
  constructor() {
    super();
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "elementVisible" && this[propName]) {
        import("../a11y-details/a11y-details.js");
        ...
        if (this.shadowRoot && !this.srcWithoutAnimation && this.src) {
          // import registry
          import("../micro-frontend-registry/micro-frontend-registry.js").then(async () => {
  ...
  async generateStill(src) {
    ...
    const MicroFrontendRegistry = globalThis.MicroFrontendRegistry.requestAvailability();
    await import("../micro-frontend-registry/lib/microServices.js").then(e => {
