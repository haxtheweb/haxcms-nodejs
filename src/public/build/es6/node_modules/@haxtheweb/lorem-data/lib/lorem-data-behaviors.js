...
import { SimpleIconsetDemo } from "../../simple-icon/lib/simple-iconset-demo.js";
import { SimpleIcon } from "../../simple-icon/simple-icon.js";
import { SimpleIconLite } from "../../simple-icon/lib/simple-icon-lite.js";
import { SimpleIconIconsetsManifest } from "../../simple-icon/lib/simple-iconset-manifest.js";
import { HaxIconsetManifest } from "../../hax-iconset/lib/hax-iconset-manifest.js";
export const LoremDataBehaviors = function (SuperClass) {
  return class extends SuperClass {
    ...
    get icons() {
      return [...(SimpleIconIconsetsManifest || []), ...(HaxIconsetManifest || [])].map(iconset => ((iconset || {}).icons || []).map(icon => iconset.name == "icons" ? icon : `${iconset.name}:${icon}`)).flat();
    }
    get text() {
