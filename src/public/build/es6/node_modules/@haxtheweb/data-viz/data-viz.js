...
globalThis.DataViz.requestAvailability = () => {
  ...
  if (!globalThis.DataViz.instance && globalThis.document && globalThis.document.body) {
...
class DataViz extends LitElement {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("pouch-db-show-data", this.showDataFunction.bind(this), {
