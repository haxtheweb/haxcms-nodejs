 ...
 */
import{css as t,html as e}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as o,toJS as s}from"../../mobx/dist/mobx.esm.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/magic/site-collection-list.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../simple-cta/simple-cta.js";import{DDDAllStyles as r}from"../d-d-d/lib/DDDStyles.js";import"../simple-tooltip/simple-tooltip.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../scroll-button/scroll-button.js";import{licenseList as n}from"../license-element/license-element.js";class JourneyTheme extends i{static get tag(){return"journey-theme"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!1,this.siteTheme="",this.dataPrimary=2,this._items=[],this.location=null,this.activeItem={},this.basePath=null,this.manifest={},this.t={readMore:"Read more",home:"Home"};try{this.basePath=globalThis.document.querySelector("base").href}catch(t){this.basePath=globalThis.location.origin}o((()=>{this.manifest=s(a.manifest);let t=new n;this.manifest.license&&t[this.manifest.license]&&(this.licenseName=t[this.manifest.license].name,this.licenseLink=t[this.manifest.license].link,this.licenseImage=t[this.manifest.license].image),this._items=this.getItemChildren(null)})),o((()=>{this.activeItem=s(a.activeItem)})),o((()=>{let t=s(a.location);globalThis.document&&globalThis.document.startViewTransition?globalThis.document.startViewTransition((()=>{this.shadowRoot.querySelector(".lower-header-box").scrollIntoView(),this.location=t,this.shadowRoot.querySelector(".lower-header-box").scrollIntoView(),setTimeout((()=>{this.shadowRoot.querySelector(".lower-header-box").scrollIntoView()}),10)})):this.location=t}))}getItemChildren(t){if(this.manifest&&this.manifest.items)return this.manifest.items.filter((e=>e.parent===t))}static get properties(){return{...super.properties,activeItem:{type:Object},location:{type:String},basePath:{type:String},dataPrimary:{type:String,attribute:"data-primary",reflect:!0},_items:{type:Array},licenseName:{type:String},licenseLink:{type:String},licenseImage:{type:String},siteTheme:{type:String,reflect:!0,attribute:"site-theme"}}}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),t`
      :root {
      ...
      `]}static get styles(){return[r,super.styles,t`
        :host {
