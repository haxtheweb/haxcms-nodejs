...
import { varExists, varGet, localStorageGet, localStorageSet } from "../../../utils/utils.js";
    ...
    connectedCallback() {
      ...
      autorun(reaction => {
        ...
        if (__manifest && varExists(__manifest, "metadata.theme.variables.cssVariable")) {
          ...
          var color = varGet(__manifest, "metadata.theme.variables.cssVariable", null);
...
class HAXCMSThemeWiring {
  ...
  connect(element, injector) {
    ...
    this.windowControllers = new AbortController();
    globalThis.addEventListener("haxcms-active-item-changed", this._activeItemUpdate.bind(element), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("haxcms-edit-mode-changed", this._globalEditChanged.bind(element), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("haxcms-trigger-update", this._triggerUpdate.bind(element), {
      signal: this.windowControllers.signal
    });
