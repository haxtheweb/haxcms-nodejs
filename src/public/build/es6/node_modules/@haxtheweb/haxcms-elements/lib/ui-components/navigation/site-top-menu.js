        ...
        if (el) {
          ...
          setTimeout(() => {
            ...
            if (this.indicator == "arrow") {
              this.shadowRoot.querySelector("#indicator").style.left = dim.left + el.offsetWidth / 2 - this.arrowSize + "px";
              this.shadowRoot.querySelector("#indicator").style.top = dim.bottom;
            } else {
              this.shadowRoot.querySelector("#indicator").style.left = dim.left + "px";
              this.shadowRoot.querySelector("#indicator").style.top = dim.bottom;
