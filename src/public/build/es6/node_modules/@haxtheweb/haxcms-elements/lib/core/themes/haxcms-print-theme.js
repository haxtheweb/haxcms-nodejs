...
import { CleanTwo } from "../../../../clean-two/clean-two.js";
...
class HAXCMSPrintTheme extends CleanTwo {
  ...
  firstUpdated(changedProperties) {
    ...
    const replaceTag = Array.from(globalThis.document.body.querySelectorAll("haxcms-print-theme replace-tag"));
    for (let i = 0; i < replaceTag.length; i++) {
      replaceTag[i].runReplacement();
    }
    setTimeout(() => {
      const all = Array.from(globalThis.document.body.querySelectorAll("haxcms-print-theme *"));
