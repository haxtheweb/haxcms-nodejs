...
import { mediaKeys } from "../magic/site-view.js";
...
export class SiteViewsRoute extends HAXCMSI18NMixin(SimpleColors) {
  ...
  formValuesChanged(e) {
    ...
    this._formDebounce = setTimeout(() => {
      ...
      if (this._ready && settings && settings.displayFormat && settings.filters) {
        ...
        globalThis.history.pushState({}, "", decodeURIComponent(`./x/views?${params}`));
  ...
  render() {
    return html` <grid-plate
      ...
      ${this.loading ? html`<h3>Loading...</h3>` : html`<h3 class="views-controls">
            Results
    ...
    changedProperties.forEach((oldValue, propName) => {
      if (propName === "search" && oldValue && this.search) {
        ...
        if (!searchParams.display) {
          ...
          globalThis.history.replaceState({}, "", decodeURIComponent(`./x/views?${rawParams}`));
        }
      }
