...
export class HAXCMSButtonAdd extends SimpleToolbarButtonBehaviors(HAXCMSButton) {
  ...
  static get styles() {
    return [super.styles, ...this.iconStyles, ...this.labelStyles, ...this.tooltipStyles, ...this.simpleButtonCoreStyles, ...this.simpleButtonLayoutStyles, ...this.simpleButtonThemeStyles];
  }
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("haxcms-create-node-success", this.HAXCMSButtonClickResponse.bind(this), {
