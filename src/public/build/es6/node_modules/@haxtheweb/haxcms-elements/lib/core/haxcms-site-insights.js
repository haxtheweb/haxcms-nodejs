...
import { toJS } from "../../../../mobx/dist/mobx.esm.js";
...
import "../../../accent-card/accent-card.js";
import "../../../retro-card/retro-card.js";
import "../../../simple-img/simple-img.js";
import "../../../simple-fields/simple-fields.js";
import "../../../lesson-overview/lib/lesson-highlight.js";
import "../../../../@github/time-elements/dist/relative-time-element.js";
import "../../../iframe-loader/lib/loading-indicator.js";
import { learningComponentTypes, iconFromPageType } from "../../../course-design/lib/learning-component.js";
...
class HAXCMSShareDialog extends HAXCMSI18NMixin(LitElement) {
  ...
  refreshData() {
    ...
    switch (this.activeTab) {
      case "insights":
        MicroFrontendRegistry.call("@haxcms/insights", params, this._insightResponse.bind(this), this);
        break;
      case "linkchecker":
        MicroFrontendRegistry.call("@haxcms/linkChecker", params, this._insightResponse.bind(this), this);
        break;
      case "contentbrowser":
        MicroFrontendRegistry.call("@haxcms/contentBrowser", params, this._insightResponse.bind(this), this);
        break;
      case "mediabrowser":
        MicroFrontendRegistry.call("@haxcms/mediaBrowser", params, this._insightResponse.bind(this), this);
        break;
      // bad selection
      default:
        this.loading = false;
          ...
          <ul>
            ...
            <li>
              ...
              <ol class="recently-updated-items">
                ${data.updatedItems ? data.updatedItems.map(item => html` <li>
                                    ...
                                    >
                                      ...
                                      <div slot="footer">
                                        <ul class="stats">
                                          ...
                                          ${item.audio > 0 ? html`<li>
                                                <simple-icon
                                                  icon="av:music-video"
                                                ></simple-icon
                                                >${item.audio} ${this.t.audio}
                                              </li>` : ``}
                                          ${item.selfChecks > 0 ? html`<li>
                                                <simple-icon
                                          ...
                                          ${item.images > 0 ? html`<li>
                                                <simple-icon
                                                  icon="image:collections"
                                                ></simple-icon
                                                >${item.images} ${this.t.images}
                                              </li>` : ``}
                                          ${item.dataTables > 0 ? html`<li>
                                                <simple-icon
                                                  icon="image:grid-on"
                                                ></simple-icon
                                                >${item.dataTables}
                                          ...
                                          ${item.links > 0 ? html`<li>
                                                <simple-icon
                                                  icon="icons:link"
                                                ></simple-icon
                                                >${item.links} ${this.t.links}
                                              </li>` : ``}
                                          ${item.readTime > 0 ? html`<li>
                                                <simple-icon
                                                  icon="icons:chrome-reader-mode"
                                                ></simple-icon
                                                >${this.getReadingTime(item.readTime)}
                                                ${this.t.ofReading}
                                              </li>` : ``}
                                        </ul>
                                      </div>
                                  ...
                                  <li>
                                    ...
                                    >
                                      <div class="body">
                                        ...
                                        ${item.type == "video" && item.source.includes("videoseries") ? html`<iframe
                                              src="${item.source}"
                                            ></iframe>` : ``}
                                        ${item.type == "video" && !item.source.includes("videoseries") ? html`<video-player
                                              source="${item.source}"
                                            ></video-player>` : ``}
                                        ${item.type == "h5p" ? html`<iframe
                                              src="${item.source}"
                                            ></iframe>` : ``}
                                        ${item.type == "audio" ? html`<video-player
                                              source="${item.source}"
                                            ></video-player>` : ``}
                                        ${item.type == "document" ? html`<div>
                                              <a
                                                href="${item.source}"
                                                target="_blank"
                                        ...
                                        <div>
                                          ${item.itemId ? this.renderItemLinkById(item.itemId) : ``}
                                        </div>
                                      </div>
                                    </retro-card>
                                  </li>
  ...
  renderLinkCheck(links, key) {
    ...
    if (!this.linkResponseData[key]) {
      ...
      MicroFrontendRegistry.call("@core/linkValidator", {
        links: key
      }, this.linkValidationResponse.bind(this));
    }
    return html`
      <li class="link-status-${this.linkResponseData[key].ok}">
        ${this.linkResponseData[key].ok === "loading" ? html`<simple-icon
              icon="hax:loading"
              accent-color="grey"
            ></simple-icon>` : ``}
        ${this.linkResponseData[key].ok != "loading" ? this.linkResponseData[key].ok ? html`<simple-icon
                icon="check"
                accent-color="green"
              ></simple-icon>` : html`<simple-icon
                icon="clear"
                accent-color="red"
                title="${this.linkResponseData[key].status}"
              ></simple-icon>` : ``}
        ${this.linkResponseData[key].ok != "loading" ? this.linkResponseData[key].ok ? html`<a
                href="${key}"
                target="_blank"
                rel="noopener nofollow noreferrer"
                >${key}</a
              >` : html`${key}` : ``}
        (${links[key].map(linkUsage => html`
