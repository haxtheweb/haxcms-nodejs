import { html, css, unsafeCSS } from "../../../../lit/index.js";
import { store } from "./haxcms-site-store.js";
import { HaxStore, HAXStore } from "../../../hax-body/lib/hax-store.js";
import { autorun, toJS } from "../../../../mobx/dist/mobx.esm.js";
import "../ui-components/magic/site-view.js";
import { ResponsiveUtilityBehaviors } from "../../../responsive-utility/lib/responsive-utility-behaviors.js";
import { localStorageSet, winEventsElement, mimeTypeToName } from "../../../utils/utils.js";
...
import "../../../rpg-character/rpg-character.js";
import "../../../app-hax/lib/v1/app-hax-top-bar.js";
import "../../../app-hax/lib/v1/app-hax-user-menu.js";
import "../../../app-hax/lib/v1/app-hax-user-menu-button.js";
import { DDD } from "../../../d-d-d/d-d-d.js";
import { SuperDaemonInstance } from "../../../super-daemon/super-daemon.js";
import "../../../super-daemon/lib/super-daemon-search.js";
 ...
 */
class HAXCMSSiteEditorUI extends HAXCMSThemeParts(HAXCMSI18NMixin(winEventsElement(ResponsiveUtilityBehaviors(DDD)))) {
  static get styles() {
  ...
  selectFileToProcess() {
    import("../../../file-system-broker/file-system-broker.js").then(async e => {
      ...
      SuperDaemonInstance.waveWand(["", "/", {
        ...
        data: fileData,
        type: type
      }, "hax-agent", "Agent"], this.shadowRoot.querySelector("#merlin"), "coin2");
    });
  }
    ...
    switch (mode) {
      ...
      case "insert-file":
        if (mode === "upload") {
          ...
          this.dispatchEvent(new CustomEvent("hax-file-upload", {
            bubbles: true,
            cancelable: true,
            composed: true,
            detail: {
      ...
      case "create-branch":
        ...
        if (endpointCall) {
          if (mode === "insert-html") {
            response = await MicroFrontendRegistry.call(endpointCall, dataToPost);
            ...
            if (response.status == 200) {
              if (["create-sibling", "create-child"].includes(mode)) {
                ...
                if (response.data && response.data.contents != "") {
                  ...
                  await import("../../../outline-designer/outline-designer.js").then(async e => {
                    ...
                    b1.addEventListener("click", async e => {
                      ...
                      if (sumChanges == "") {
                        ...
                        confirmation = globalThis.confirm(`Saving will commit the following actions:\n${sumChanges}\nAre you sure?`);
                      }
                      if (confirmation) {
  ...
  insertElementsFromContentBlob(content) {
    ...
    if (!addToEnd && this.activeNode && this.activeNode.parentNode) {
      for (var i = div.children.length - 1; i > 0; i--) {
        ...
        this.activeNode.parentNode.insertBefore(div.children[i], this.activeNode.nextSibling);
      }
    } else {
  ...
  constructor() {
    ...
    SuperDaemonInstance.noResultsSlot = () => {
      return html`<div class="no-results">
        ...
        <a
          @click="${e => {
        HAXStore._haxStoreContribute("merlin", "POP,enhancement", SuperDaemonInstance.commandContext + " " + SuperDaemonInstance.value);
      }}"
    ...
    autorun(() => {
      ...
      if (UserScaffoldInstance.active && UserScaffoldInstance.memory.isLoggedIn && SuperDaemonInstance.programName === null && usAction.type === "drag") {
        this.activeDrag = true;
        this.activeType = usData.value || usData.architype;
      } else if (UserScaffoldInstance.active && UserScaffoldInstance.memory.isLoggedIn && SuperDaemonInstance.programName === null && usAction.type === "dragleave") {
        this.activeDrag = false;
        this.activeType = null;
      }
    });
  ...
  soundToggle() {
    ...
    if (!status) {
      store.toast("Sound off.. hey.. HELLO!?!", 2000, {
        fire: true
      });
    } else {
      store.toast("Can you hear me now? Good.", 2000, {
        hat: "random"
      });
      store.playSound("click");
    }
  ...
  dropEvent(e) {
    ...
    this.activeDrag = false;
    this.activeType = null;
    SuperDaemonInstance.waveWand(["", "/", e, "hax-agent", "Agent"], this.shadowRoot.querySelector("#merlin"));
  }
  dragenterEvent(e) {
    e.preventDefault();
  ...
  _logout() {
    globalThis.dispatchEvent(new CustomEvent("jwt-login-logout", {
      composed: true,
      bubbles: true,
      cancelable: false,
      detail: true
  ...
  updateAvailableButtons() {
    if (this.shadowRoot) {
      setTimeout(() => {
        ...
        ary.forEach(pair => {
          if (globalThis.appSettings && globalThis.appSettings[pair.varPath] && globalThis.appSettings[pair.varPath] != null && globalThis.appSettings[pair.varPath] != "" && globalThis.appSettings[pair.varPath] != "null") {
            if (pair.dep) {
              if (globalThis.appSettings[pair.dep] != null && globalThis.appSettings[pair.dep] != "" && globalThis.appSettings[pair.dep] != "null") {
  ...
  firstUpdated(changedProperties) {
        ...
        program: async (input, values) => {
          ...
          Object.keys(reg.registry.list).forEach(async tag => {
            ...
            if (globalThis.customElements.get(tag)) {
              if (globalThis.customElements.get(tag).haxProperties && globalThis.customElements.get(tag).haxProperties.gizmo) {
    ...
    SuperDaemonInstance.defineOption({
      ...
      value: {
        ...
        program: async (input, values) => {
          let results = [];
          ["clean-one", "clean-two", "learn-two-theme", "polaris-theme", "polaris-invent-theme", "ddd-brochure-theme", "collections-theme", "training-theme", "bootstrap-theme", "outline-player", "haxor-slevin"].forEach(async name => {
  ...
  enableLabExperiments() {
    // lecture player
    import("../../../video-player/lib/lecture-player.js");
    // AI chat bot
    import("../ui-components/magic/site-ai-chat.js");
  }
  ...
  async _cancelButtonTap(e) {
    ...
    if (body != this._originalContent && !globalThis.confirm(this.t.unsavedChangesWillBeLostIfSelectingOkAreYouSure)) {
      return false;
    }
    this.editMode = false;
  ...
  _manifestButtonTap(e) {
    ...
    // prettier-ignore
    import("./haxcms-site-dashboard.js").then(() => {
      ...
      setTimeout(() => {
        globalThis.dispatchEvent(new CustomEvent("haxcms-load-site-dashboard", {
          bubbles: true,
          composed: true,
          cancelable: false,
          detail: e.target
