...
import { generateResourceID } from "../../../../utils/utils.js";
...
class HAXCMSBackendBeaker extends LitElement {
  ...
  constructor() {
    ...
    globalThis.addEventListener("hax-app-picker-selection", this._appPicked.bind(this), {
      signal: this.windowControllers.signal
    });
  }
  /**
  ...
  _appPicked(e) {
    if (e.detail.connection.protocol === "dat") {
      ...
      reader.onload = event => {
        let fileLocation = "files/" + HAXStore.haxTray.shadowRoot.querySelector("#fileupload").files[0].name;
        ...
        HAXStore.haxTray.shadowRoot.querySelector("hax-tray-upload").newAssetConfigure();
      };
      reader.readAsArrayBuffer(HAXStore.haxTray.shadowRoot.querySelector("#fileupload").files[0]);
    }
  }
  /**
   * Save page data
  ...
  async saveNode(e) {
    ...
    await this.shadowRoot.querySelector("#beaker").write(this.activeItem.location, await HAXStore.activeHaxBody.haxToContent());
  ...
  async saveOutline(e) {
    ...
    this.shadowRoot.querySelector("#beaker").write("site.json", JSON.stringify(this.manifest, null, 2));
  ...
  async saveManifest(e) {
    ...
    await this.shadowRoot.querySelector("#beaker").write("site.json", JSON.stringify(this.manifest, null, 2));
    // simulate save events since they wont fire
