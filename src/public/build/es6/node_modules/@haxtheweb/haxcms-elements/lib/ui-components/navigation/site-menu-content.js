import { PageContentsMenu } from "../../../../page-contents-menu/page-contents-menu.js";
...
class SiteMenuContent extends HAXCMSThemeParts(PageContentsMenu) {
  ...
  constructor() {
    super();
    this.hierarchyTags = ["h1", "h2", "h3", "h4", "h5", "h6", "relative-heading", "video-player", "audio-player"];
    this.fallbackText = {
      "video-player": "Video",
      "audio-player": "Audio"
    };
    ...
    autorun(reaction => {
      ...
      if (this.contentContainer && this.contentContainer.HAXCMSThemeSettings && this.contentContainer.HAXCMSThemeSettings.siteMenuContent) {
        this.contentContainer.HAXCMSThemeSettings.siteMenuContent.addEventListener("scroll", this._applyScrollDetect.bind(this));
      }
      setTimeout(() => {
        this.updateMenu();
      }, 10);
  ...
  backToTop() {
    if (this.contentContainer.HAXCMSThemeSettings.themeTop && this.contentContainer.HAXCMSThemeSettings.themeTop.scrollIntoView) {
