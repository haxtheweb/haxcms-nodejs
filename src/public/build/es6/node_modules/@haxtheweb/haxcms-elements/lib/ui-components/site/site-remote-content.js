...
import { wipeSlot, lightChildrenToShadowRootSelector, unwrap } from "../../../../utils/utils.js";
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (this.elementVisible) {
        if ((propName === "uuid" || propName === "elementVisible") && this[propName] && !this.breakreference && !this.loading && !this.circularBlock) {
          this.loading = true;
          ...
          MicroFrontendRegistry.call("@haxcms/pageCache", {
            site: url,
            type: "link",
            uuid: this.uuid,
            data: true
        ...
        if (propName === "siteurl" && globalThis.HaxStore && !this.loading && !this.circularBlock) {
  ...
  static get haxProperties() {
    return {
      ...
      gizmo: {
        ...
        icon: "hax:remote",
        color: "grey",
        tags: ["Resource", "haxcms", "content", "remote", "reference", "url", "resource"],
        handles: [],
        meta: {
  ...
  async haxsetupActiveElementForm(props) {
    if (globalThis.HAXCMS) {
      if (Object.keys(this.itemManifest).length === 0 || this.__refresh) {
        ...
        if (this.siteurl) {
          const response = await MicroFrontendRegistry.call("@haxcms/siteManifest", {
            site: this.siteurl
          });
          if (response.data) {
