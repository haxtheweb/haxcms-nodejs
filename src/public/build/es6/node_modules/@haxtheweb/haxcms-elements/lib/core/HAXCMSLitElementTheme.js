 ...
 */
import { css, LitElement, render, unsafeCSS, html } from "../../../../lit/index.js";
...
import { editableTableDisplayStyles } from "../../../editable-table/lib/editable-table-behaviors.js";
...
class HAXCMSLitElementTheme extends HAXCMSTheme(ResponsiveUtilityBehaviors(LitElement)) {
  constructor() {
    ...
    autorun(reaction => {
      ...
      if (this.HAXCMSThemeSettings.autoScroll && this.shadowRoot && this.HAXCMSThemeSettings.scrollTarget && this.HAXCMSThemeSettings.scrollTarget.scrollIntoView) {
        if (this.isSafari) {
      ...
      setTimeout(() => {
        ...
        if (kidHeadings.length > 0) {
          kidHeadings.forEach(node => {
            ...
            node.addEventListener("pointerenter", this.hoverIntentEnter.bind(this));
            node.addEventListener("pointerleave", this.hoverIntentLeave.bind(this));
          });
        }
      }, 100);
      this.__disposer.push(reaction);
  ...
  copyLink(e) {
    ...
    // alter URL state
    let headingLink = globalThis.location.origin + globalThis.location.pathname + "#" + target.getAttribute("id");
