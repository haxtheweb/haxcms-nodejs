...
import { HaxUiBaseStyles } from "../../../hax-body/lib/hax-ui-styles.js";
...
class HAXCMSSiteDashboard extends SimpleColors {
  ...
  fieldDataLoaded() {
    ...
    requestAnimationFrame(() => {
      ...
      fields.find(item => item.property === "manifest").properties.find(item2 => item2.property === "theme").properties.find(item3 => item3.property === "regions").properties.map(item4 => {
  ...
  _saveSiteFieldsTap(e) {
    ...
    globalThis.dispatchEvent(new CustomEvent("haxcms-save-site-data", {
      bubbles: true,
      composed: true,
      cancelable: true,
