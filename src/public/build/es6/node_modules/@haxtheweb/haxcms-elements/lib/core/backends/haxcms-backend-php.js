  ...
  firstUpdated(changedProperties) {
    setTimeout(() => {
      ...
      if (this.jwt != null && this.jwt != "null" && this.jwt != "" && typeof this.jwt == "string") {
        ...
        globalThis.dispatchEvent(new CustomEvent("haxcms-not-logged-in", {
          bubbles: true,
          composed: true,
          cancelable: false,
          detail: this
    ...
    try {
      ...
      import("../haxcms-site-editor.js").then(e => {
        ...
        if (globalThis.appSettings) {
          ...
          store.cmsSiteEditor.instance.jwt = this.jwt;
          store.jwt = this.jwt;
          store.cmsSiteEditor.instance.saveNodePath = globalThis.appSettings.saveNodePath;
          store.cmsSiteEditor.instance.saveManifestPath = globalThis.appSettings.saveManifestPath;
          store.cmsSiteEditor.instance.saveOutlinePath = globalThis.appSettings.saveOutlinePath;
          store.cmsSiteEditor.instance.getSiteFieldsPath = globalThis.appSettings.getSiteFieldsPath;
          store.cmsSiteEditor.instance.getFormToken = globalThis.appSettings.getFormToken;
          store.cmsSiteEditor.instance.publishSitePath = globalThis.appSettings.publishSitePath;
          store.cmsSiteEditor.instance.syncSitePath = globalThis.appSettings.syncSitePath;
          store.cmsSiteEditor.instance.revertSitePath = globalThis.appSettings.revertSitePath;
          store.cmsSiteEditor.instance.createNodePath = globalThis.appSettings.createNodePath;
          store.cmsSiteEditor.instance.deleteNodePath = globalThis.appSettings.deleteNodePath;
          store.cmsSiteEditor.instance.getUserDataPath = globalThis.appSettings.getUserDataPath;
