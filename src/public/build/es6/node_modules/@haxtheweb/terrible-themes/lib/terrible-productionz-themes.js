 ...
 */
class TerribleProductionzThemes extends HAXCMSRememberRoute(HAXCMSThemeParts(HAXCMSLitElementTheme)) {
  /**
  ...
  constructor() {
    ...
    globalThis.document.body.style.backgroundImage = `url(${new URL("assets/header.jpg", import.meta.url).href}/../productionzbg.jpg)`;
  }
  /**
