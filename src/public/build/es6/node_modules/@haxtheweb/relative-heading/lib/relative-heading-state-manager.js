...
globalThis.RelativeHeadingStateManager.requestAvailability = () => {
  if (!globalThis.RelativeHeadingStateManager.instance) {
    globalThis.RelativeHeadingStateManager.instance = globalThis.document.createElement("relative-heading-state-manager");
...
class RelativeHeadingStateManager extends LitElement {
  ...
  constructor() {
    ...
    if (!globalThis.RelativeHeadingStateManager.instance) globalThis.RelativeHeadingStateManager.instance = this;
  }
  static get styles() {
    return [css`
   ...
   */
  get copyUrl() {
    return `${globalThis.location.href.replace(globalThis.location.hash, "")}#${this.copyHeading && this.copyHeading.id ? this.copyHeading.id : ""}`;
  }
