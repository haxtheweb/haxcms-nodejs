 ...
 */
import { LitElement, html, css, render, nothing } from "../../lit/index.js";
...
import "../code-editor/lib/code-pen-button.js";
import { nodeToHaxElement } from "../utils/utils.js";
...
class DocumentationPlayer extends LitElement {
  ...
  renderPlayListTemplate() {
    ...
    render(html` <div>
        ...
        ></code-pen-button>
        ${this.renderHAXInjectButton()}`, template);
  ...
  _injectHAX(e) {
    globalThis.dispatchEvent(new CustomEvent("hax-insert", {
      detail: {
