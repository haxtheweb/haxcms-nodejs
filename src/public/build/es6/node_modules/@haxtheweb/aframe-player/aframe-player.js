...
class AframePlayer extends SchemaBehaviors(LitElement) {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("es-bridge-aframePlayer-loaded", this._aframeLoaded.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.ESGlobalBridge.requestAvailability().load("aframePlayer", location);
  }
  _aframeLoaded(el) {
