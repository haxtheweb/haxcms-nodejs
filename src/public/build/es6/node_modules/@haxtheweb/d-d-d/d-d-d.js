...
import { DDDReset, DDDAllStyles, DDDFonts, DDDPulseEffect, DDDAnimations, DDDDataAttributes, ApplicationAttributeData } from "./lib/DDDStyles.js";
...
export class DDDSample extends DDDSuper(LitElement) {
  ...
  static get styles() {
    return [super.styles, ...DDDDataAttributes, css`
        :host {
          display: flex;
