...
import "../../page-section/page-section.js";
import "../../simple-cta/simple-cta.js";
import "../../video-player/video-player.js";
import "../../figure-label/figure-label.js";
import "../../stop-note/stop-note.js";
import "../../course-design/lib/learning-component.js";
import "../../course-design/lib/block-quote.js";
...
class DDDocs extends DDD {
  ...
  static get styles() {
    return [super.styles, DDDAllStyles, css`
        /* used for demo */
        :host {
          display: block;
        }
  ...
  renderDataAttributes() {
    return html`${Object.keys(ApplicationAttributeData).map(key => html`
      ...
      >
        ${Object.keys(ApplicationAttributeData.primary).map(key => html`
