 ...
 */
import{LitElement as t,html as e,css as s}from"../../../lit/index.js";import{DDDSuper as r}from"../d-d-d.js";export class DddStepsList extends(r(t)){static get tag(){return"ddd-steps-list"}constructor(){super()}static get properties(){return{...super.properties,dddPrimary:{type:String,attribute:"ddd-primary"}}}static get styles(){return[super.styles,s`
      :host {
        display: block;
        position: relative;
