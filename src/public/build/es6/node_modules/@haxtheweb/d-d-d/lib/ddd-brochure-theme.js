...
class DDDBrochureTheme extends HAXCMSRememberRoute(DDDSuper(HAXCMSLitElementTheme)) {
  constructor() {
    super();
  ...
  getSections() {
    ...
    sections.forEach(section => {
      items.push({
        id: section.getAttribute("id") || section.cleanAnchor(section.anchor),
        // shouldn't be possible but could be timing thing
  ...
  render() {
    return html`
      <header itemtype="http://schema.org/WPHeader">
        ...
        >
          ${this.getSections(this.sectionLoad).map(section => html`
              <a
