...
import "../../simple-picker/lib/simple-emoji-picker.js";
export class PageFlagComment extends LitElement {
  ...
  render() {
    return html`
      <div class="comment">
        ${this.editMode ? html`<simple-emoji-picker
              align-right
              label="Reaction"
              value="${this.mood}"
              @value-changed="${this.emojiChanged}"
            ></simple-emoji-picker>` : html`<div class="emoji" .innerHTML="${this.mood}"></div>`}
        ...
        <div class="comment__footer">
          <div class="comment__footer__actions">
            ${!this.readOnly ? html`
                  ${this.canEdit ? html`<simple-icon-button
