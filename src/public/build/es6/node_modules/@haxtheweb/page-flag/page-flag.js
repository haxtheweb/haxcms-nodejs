...
export class pageFlagManagerEl extends HTMLElement {
  ...
  connectedCallback() {
    globalThis.addEventListener("haxcms-user-data-updated", this.userDataUpdated.bind(this), {
...
globalThis.pageFlagManager.requestAvailability = () => {
  if (!globalThis.pageFlagManager.instance) {
    globalThis.pageFlagManager.instance = globalThis.document.createElement(pageFlagManagerEl.tag);
