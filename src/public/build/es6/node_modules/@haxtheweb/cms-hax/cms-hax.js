...
class CmsHax extends LitElement {
  ...
  _storeReady(e) {
    ...
    setTimeout(() => {
      ...
      this._noticeTagChanges(this.allowedTags, this.hidePanelOps, this.offsetMargin, this.elementAlign);
      this.__applyMO();
  ...
  constructor() {
    ...
    this.ready = false;
    globalThis.addEventListener("hax-store-ready", this._storeReady.bind(this), {
      once: true,
      passive: true,
      signal: this.windowControllersReady.signal
    });
    globalThis.addEventListener("hax-store-app-store-loaded", this._appstoreLoaded.bind(this), {
      once: true,
      passive: true,
      signal: this.windowControllersLoaded.signal
    });
    globalThis.addEventListener("hax-save-body-value", this._saveFired.bind(this), {
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (["allowedTags", "hidePanelOps", "offsetMargin", "elementAlign"].includes(propName)) {
        this._noticeTagChanges(this.allowedTags, this.hidePanelOps, this.offsetMargin, this.elementAlign);
      }
    });
  }
