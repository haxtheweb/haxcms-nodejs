...
class CMSToken extends PolymerElement {
  ...
  _handleTokenResponse(newValue, oldValue) {
    if (newValue !== null && typeof newValue.content !== typeof undefined) {
      ...
      if (globalThis.document.getElementById("cmstokenidtolockonto") != null) {
        ...
        globalThis.document.getElementById("cmstokenidtolockonto").innerHTML = newValue.editText;
  ...
  _tokenChanged(newValue, oldValue) {
    ...
    if (typeof newValue !== typeof undefined && newValue !== "" && !this.loading) {
      ...
      if (typeof this.tokenEndPoint === typeof undefined && typeof globalThis.cmstokenEndPoint !== typeof undefined) {
  ...
  connectedCallback() {
    ...
    globalThis.document.addEventListener("visibilitychange", this._windowVisibilityChanged.bind(this), {
