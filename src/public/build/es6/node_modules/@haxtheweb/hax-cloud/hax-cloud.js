...
import "../haxcms-elements/lib/core/haxcms-site-builder.js";
class HaxCloud extends DDD {
  ...
  constructor() {
    ...
    globalThis.addEventListener("manifest-changed", this.loadLocalHax.bind(this), {
  ...
  async downloadHAXLatest() {
    ...
    a.href = "https://github.com/elmsln/hax-single-site/archive/refs/heads/main.zip";
  ...
  async findLocalHaxCopy() {
    ...
    this.fileObjects = await broker.openDir(true, {
      mode: "readwrite"
    });
  ...
  loadLocalHax() {
    ...
    globalThis.document.querySelector("haxcms-backend-userfs").fileObjects = this.fileObjects;
