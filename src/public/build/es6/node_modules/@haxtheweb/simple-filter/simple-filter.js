  ...
  return class extends SuperClass {
    ...
    update(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        if (["items", "where", "like", "caseSensitive", "multiMatch"].includes(propName) && this.shadowRoot) {
          clearTimeout(this.__debounce);
          this.__debounce = setTimeout(() => {
            this.filtered = this._computeFiltered(this.items, this.where, this.like, this.caseSensitive, this.multiMatch);
          }, 250);
        }
