...
import { editBehaviors, editableTableStyles, tableHtmlProperties, displayProperties, dataProperties } from "./lib/editable-table-behaviors.js";
...
class EditableTable extends editBehaviors(DDD) {
   ...
   */
  focus() {
    let query = this.editMode ? "editable-table-edit" : "editable-table-display",
