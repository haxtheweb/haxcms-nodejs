...
import { DDDPulseEffectSuper } from "../../d-d-d/d-d-d.js";
...
const SimpleToolbarButtonBehaviors = function (SuperClass) {
  return class extends SuperClass {
     ...
     */
    get iconTemplate() {
      return !this.hasIcon ? "" : html`<simple-icon-lite
            id="icon"
            aria-hidden="true"
     ...
     */
    get labelTemplate() {
      return !this.hasLabel ? "" : html`<span
            id="label"
    ...
    get buttonInnerTemplate() {
      return this.iconPosition === "right" || this.iconPosition === "bottom" ? html`${this.labelTemplate} ${this.iconTemplate}` : html`${this.iconTemplate} ${this.labelTemplate}`;
    }
    /**
     ...
     */
    get buttonTemplate() {
      return this.radio ? html` <button
              id="button"
              aria-checked="${this.isToggled ? "true" : "false"}"
              aria-describedby="${!!this.describedby && this.describedby !== "" ? this.describedby : undefined}"
            ...
            ${this.tooltipTemplate}` : this.toggles ? html` <button
                id="button"
              ...
              ${this.tooltipTemplate}` : html` <button
                id="button"
                aria-describedby="${!!this.describedby && this.describedby !== "" ? this.describedby : undefined}"
                class="simple-toolbar-button"
                ?disabled="${this.disabled}"
    ...
    static get styles() {
      ...
      return [styles, this.iconStyles, this.labelStyles, this.tooltipStyles, this.simpleButtonCoreStyles, this.simpleButtonLayoutStyles, this.simpleButtonThemeStyles];
    }
  };
};
/**
