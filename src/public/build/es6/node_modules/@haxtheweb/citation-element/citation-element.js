...
import { licenseList } from "../license-element/license-element.js";
import { generateResourceID } from "../utils/utils.js";
import { DDDSuper } from "../d-d-d/d-d-d.js";
import { DDDReset } from "../d-d-d/lib/DDDStyles.js";
/**
 * `citation-element`
  ...
  render() {
    return html`
      ...
      <cite
        ...
        >
        by
        ${this.creator}${this.licenseName ? html`, licensed under
              <a
                class="license-link"
                rel="noopener noreferrer"
                target="_blank"
  ...
  static get haxProperties() {
    return {
      ...
      gizmo: {
        ...
        icon: "editor:title",
        color: "grey",
        tags: ["Authoring", "content", "citation", "reference", "cc0", "cc-by", "cc-by-sa", "cc-by-nd", "cc-by-nc", "cc-by-nc-sa", "cc-by-nc-nd"],
        handles: [{
          type: "citation",
          source: "source",
          title: "title",
