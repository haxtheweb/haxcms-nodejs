...
import { ImgPanZoom } from "../../img-pan-zoom/img-pan-zoom.js";
...
class ImgViewViewer extends FullscreenBehaviors(ImgPanZoom) {
  ...
  _button(config = {}, top = false) {
    ...
    return !config ? "" : !config.toggleProp || !this[config.toggleProp] ? html`
            <button
              .id="${config.id || undefined}"
