...
import { DDDDataAttributes, DDDPulseEffect } from "../../d-d-d/lib/DDDStyles.js";
...
class LecturePlayer extends DDDSuper(LitElement) {
  static get styles() {
    return [super.styles, DDDDataAttributes, DDDPulseEffect, css`
        :host {
  ...
  setJumbotronAttributes() {
    ...
    this.querySelectorAll("[data-lecture-slide]").forEach(anchor => {
      let header = this.querySelector(`#${anchor.getAttribute("data-associatedID")}`);
      console.log(header);
  ...
  getNextSiblingHTML(element) {
    ...
    stopIDs = stopIDs.filter(item => item !== element.id && item !== globalThis.document.querySelector(`[data-associatedID="${element.id}"]`).id);
    console.log(stopIDs);
    while (nextSibling) {
  ...
  addPrevNextListeners() {
    ...
    nextSlideBtn.addEventListener("click", () => {
      const anchorsWithId = globalThis.document.querySelectorAll("[data-lecture-slide][id]").length;
      ...
      const nextSlide = this.activeIndex.split("-")[1] < anchorsWithId ? parseInt(this.activeIndex.split("-")[1]) + 1 : null;
      if (nextSlide) {
  ...
  updateJumbotron() {
    ...
    if (activeAnchor) {
      ...
      jumbotronHeading.innerText = activeAnchor.getAttribute("data-lecture-heading");
      ...
      jumbotronContent.innerHTML = activeAnchor.getAttribute("data-lecture-content");
  ...
  checkDisabledButtons() {
    ...
    if (activeIndex !== globalThis.document.querySelectorAll("[data-lecture-slide]").length) {
