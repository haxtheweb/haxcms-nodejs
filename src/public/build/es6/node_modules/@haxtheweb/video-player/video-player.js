...
import { IntersectionObserverMixin } from "../intersection-element/lib/IntersectionObserverMixin.js";
import { MediaBehaviorsVideo } from "../media-behaviors/media-behaviors.js";
 ...
 */
class VideoPlayer extends IntersectionObserverMixin(MediaBehaviorsVideo(SchemaBehaviors(I18NMixin(DDD)))) {
  //styles function
  static get styles() {
  ...
  // render function
  render() {
    return html` ${this.elementVisible ? html`${!this.isA11yMedia ? html` <div
                class="responsive-video-container"
                .lang="${this.lang || "en"}"
              >
                ${this.sandboxed ? html`` : html` <webview
              ...
              <slot hidden></slot>` : html` <a11y-media-player
  ...
  static get haxProperties() {
    return {
      ...
      gizmo: {
        ...
        color: "red",
        tags: ["Audio / Video", "Media", "youtube", "watch", "vimeo", "twitch", "mp4", "webm", "ogg", "video-player", "a11y", "media-player"],
        handles: [{
          type: "video",
          type_exclusive: true,
          source: "source",
      ...
      saveOptions: {
        unsetAttributes: ["__utils", "__stand-alone", "colors", "playing", "__forcePaused"]
      },
      demoSchema: [{
        tag: "video-player",
        properties: {
  ...
  get iframed() {
    ...
    if (this.sourceData && this.sourceData.length > 0 && this.sourceData[0] !== undefined && globalThis.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src) && !this.sandboxed) {
      return true;
    }
    return false;
  }
  ...
  get sandboxed() {
    ...
    if (this.sourceData && this.sourceData.length > 0 && typeof this.sourceData[0] !== undefined && globalThis.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src)) {
  ...
  get sourceData() {
    ...
    slotted.forEach(slot => {
      if (this.sources.filter(source => source.src === slot.src).length < 1) this.sources.unshift({
        src: slot.src,
  ...
  setSourceData() {
    ...
    if (this.sourceData && this.sourceData.length > 0 && this.sourceData[0] !== undefined && typeof this.sourceData[0].src !== typeof undefined) {
      this.sourceType = globalThis.MediaBehaviors.Video.getVideoType(this.sourceData[0].src);
    }
  }
  playEvent(e) {
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "source" && this.sourceType && typeof oldValue !== typeof undefined) {
        let type = globalThis.MediaBehaviors.Video.getVideoType(this.sourceData[0].src);
  ...
  firstUpdated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      if (propName === "allowBackgroundPlay" && this[propName] && this.__setVisChange) {
        ...
        this.windowControllers = new AbortController();
        globalThis.document.addEventListener("visibilitychange", this._visChange.bind(this), {
  ...
  pause() {
    if (this.shadowRoot && this.shadowRoot.querySelector("a11y-media-player").__playing) {
  ...
  _visChange(e) {
    setTimeout(() => {
      if (globalThis.document.visibilityState === "visible" && !this.playing && this.__forcePaused) {
