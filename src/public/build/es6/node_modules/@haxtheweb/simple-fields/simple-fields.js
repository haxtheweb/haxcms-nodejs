...
class SimpleFields extends SimpleFieldsLite {
  ...
  get schemaConversion() {
    return this.elementizer || {
      ...
      type: {
        ...
        "html-block": {
          defaultSettings: {
            import: "@haxtheweb/simple-fields/lib/simple-fields-html-block.js",
        ...
        string: {
          format: {
            ...
            fileupload: {
              defaultSettings: {
                import: "@haxtheweb/simple-fields/lib/simple-fields-upload.js",
            ...
            url: {
              defaultSettings: {
                import: "@haxtheweb/simple-fields/lib/simple-fields-url-combo.js",
  ...
  _convertField(field, conversion = this.fieldsConversion, settings = {}) {
    ...
    convKeys.forEach(key => {
      ...
      if (convVal) settings = this._convertField(field, convVal, convData, settings);
    });
    return settings;
  }
  ...
  fieldsToSchema(fields) {
    ...
    if (fields && fields.forEach) {
      fields.forEach(field => {
        let prop = !field.property ? field.attribute ? field.attribute : "" : field.property;
