...
export const SimpleFieldsBaseStyles = [css`
    :host {
      visibility: visible;
  ...
  `];
export const SimpleFieldsLabelStyles = [css`
  ...
  `];
export const SimpleFieldsTooltipStyles = [css`
    simple-tooltip,
  ...
  `];
export const SimpleFieldsButtonStyles = [...SimpleFieldsTooltipStyles, css`
    button,
  ...
  `];
export const SimpleFieldsDescriptionStyles = [css`
    *[part="field-desc"],
    *[part="error-desc"],
    *[part="error-meta"] {
  ...
  `];
export const SimpleFieldsFieldsetStyles = [css`
    fieldset {
