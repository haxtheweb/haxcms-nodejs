...
class SimpleFieldsLite extends LitElement {
  ...
  constructor() {
    ...
    if (globalThis.WCGlobalBasePath) {
      ...
      this.basePath = new URL("./simple-fields-lite.js", import.meta.url).href + "/../../../../";
    }
    ...
    schemaKeys.forEach(key => {
      ...
      if (data && data.element) {
        let id = `${prefix}${key}`,
          ...
          wrapper = schemaProp.properties || schemaProp.items || schemaProp.noWrap || data.noWrap ? element : globalThis.document.createElement("simple-fields-container"),
          value = this._getValue(`${prefix}${key}`),
          elementProperties = !Object.getPrototypeOf(element) && !Object.getPrototypeOf(element).constructor ? false : Object.getPrototypeOf(element).constructor.properties;
        ...
        this._configElement(wrapper, desc, data.descriptionProperty, data.descriptionSlot);
