...
class SimpleFieldsTagList extends SimpleFieldsFieldBehaviors(SimpleColors) {
  ...
  removeTag(e) {
    this.tagList = [...this.tagList.filter(i => {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("simple-tag-dragstart", this._handleGlobalTagDrag.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("simple-tag-drop", this._handleGlobalTagDrop.bind(this), {
      signal: this.windowControllers.signal
    });
  }
