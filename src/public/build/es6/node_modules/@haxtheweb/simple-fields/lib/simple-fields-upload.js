 ...
 */
class SimpleFieldsUpload extends I18NMixin(SimpleFieldsFieldsetBehaviors(LitElement)) {
  static get tag() {
    return "simple-fields-upload";
  }
  static get styles() {
    return [super.styles, ...SimpleFieldsButtonStyles, css`
        :host {
          pointer-events: all;
          overflow: visible;
  ...
  constructor() {
    ...
    this.registerLocalization({
      ...
      localesPath: new URL("../locales/simple-fields.es.json", import.meta.url).href + "/../",
      locales: ["es"]
    });
  ...
  _takeSelfie(e) {
    if (!this.camera) {
      import("../../simple-login/lib/simple-camera-snap.js").then(() => {
  ...
  _voiceRecorder(e) {
    if (!this.voice) {
      import("../../voice-recorder/voice-recorder.js").then(() => {
        this.voice = globalThis.document.createElement("voice-recorder");
        this.voice.addEventListener("voice-recorder-recording-blob", this.__newAudioShowedUp.bind(this));
