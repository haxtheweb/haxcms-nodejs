...
import { SimpleFieldsButtonStyles, SimpleFieldsTooltipStyles } from "./simple-fields-ui.js";
export class SimpleTag extends SimpleTagLiteSuper(DDD) {
  ...
  calculateAccentColor(value) {
    ...
    this.style.setProperty("--simple-fields-button-color", `var(--simple-colors-fixed-theme-grey-${contrastLevel}, black)`);
    // set accent color
    return colorName;
  }
  ...
  static get styles() {
    return [super.styles, SimpleFieldsButtonStyles, SimpleFieldsTooltipStyles, css`
        :host {
