...
class SimpleFieldsUrlComboItem extends LitElement {
   ...
   */
  get isSamePage() {
    return this.isLocal && `${this.resourceURL.pathname}${this.resourceURL.search}` === `${this.currentLocation.pathname}${this.currentLocation.search}`;
  }
   ...
   */
  get fileExtension() {
    let pathname = !!this.resourceURL && !!this.resourceURL.pathname ? this.resourceURL.pathname : "",
   ...
   */
  get previewSrc() {
    return !!this.preview && this.preview.trim() !== "" ? this.preview :
  ...
  get primaryLabelTemplate() {
    return !!this.name && this.name.trim() !== "" ? html`<span part="label-primary">${this.name}</span>` : !!this.value && this.value.trim() !== "" ? html`<span part="label-primary">${this.value}</span>` : "";
  }
  ...
  get secondaryLabelTemplate() {
    return !!this.value && this.value.trim() !== "" ? html`<span part="label-secondary">${this.value}</span>` : "";
  }
