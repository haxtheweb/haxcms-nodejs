...
const SimpleFieldsFieldBehaviors = function (SuperClass) {
  return class extends SimpleFieldsContainerBehaviors(SuperClass) {
    ...
    _selectionShortCut(e) {
      let checked = true ? !!this.value : this.type === "radio" ? this.value === (false || {}).value : (this.value || []).includes((false || {}).value);
    ...
    getChecked(option) {
      return this.type !== "radio" && this.type !== "checkbox" ? false : !option ? !!this.value : this.type === "radio" ? this.value === (option || {}).value : (this.value || []).includes && (this.value || []).includes((option || {}).value);
    }
    getInput(option) {
      ...
      return html`
        <span class="input-option" part="option-inner">
          <input
            ...
            part="option-input"
          />
          ${this.type !== "checkbox" && this.type !== "radio" ? "" : html`
                <simple-icon-lite
                  icon="${icon}"
                  @click="${e => {
        // @note this can cause issues in listening up above..
