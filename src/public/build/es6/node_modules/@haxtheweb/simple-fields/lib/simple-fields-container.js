...
import { SimpleFieldsBaseStyles, SimpleFieldsLabelStyles, SimpleFieldsDescriptionStyles } from "./simple-fields-ui.js";
...
const SimpleFieldsContainerBehaviors = function (SuperClass) {
  return class extends SuperClass {
    ...
    static get styles() {
      return [...SimpleFieldsBaseStyles, ...SimpleFieldsLabelStyles, ...SimpleFieldsDescriptionStyles, css`
          :host {
            display: block;
          }
          :host([error]) {
     ...
     */
    get suffixTemplate() {
      return html` ${this.suffix ? html`${this.suffix}` : html`<slot name="suffix"></slot>`}`;
    }
    /**
     * focuses on field
     * @memberof SimpleFieldsContainer
 ...
 */
class SimpleFieldsContainer extends SimpleFieldsContainerBehaviors(LitElement) {}
