...
class H5PElement extends LitElement {
  ...
  // render function
  render() {
    return html` ${!this.source ? html`<h5p-wrapped-element><slot></slot></h5p-wrapped-element>` : html`<div
          class="h5p-container"
  ...
  async H5PDepsLoader() {
    ...
    const basePath = new URL("./lib/h5p-resizer.js", import.meta.url).href + "/../";
    ...
    await globalThis.ESGlobalBridge.requestAvailability().load("h5p-jquery", basePath + "h5p/js/jquery.js");
    globalThis.addEventListener("es-bridge-h5p-jquery-loaded", this.h5pJqueryReady.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("es-bridge-h5p-" + this.__h5pDepsLength + "-loaded", this.h5pReadyCallback.bind(this), {
      signal: this.windowControllers.signal
    });
  }
  generateUUID() {
  ...
  firstUpdated(changedProperties) {
    ...
    if (this.source && globalThis.ESGlobalBridge.requestAvailability().imports["h5p-" + this.__h5pDepsLength] === true && this.contentId) {
  ...
  async h5pJqueryReady(e) {
    for (var i in this.h5pJSDeps) {
      await globalThis.ESGlobalBridge.requestAvailability().load("h5p-" + i, this.h5pJSDeps[i]);
    }
  }
  h5pReadyCallback(e) {
    if (this.contentId) {
  ...
  async setupH5P(id = 1, displayOptions = {}) {
    ...
    const basePath = new URL("./lib/h5p-element.js", import.meta.url).href + "/../";
    H5PIntegration.core = {
...
class H5PStandalone {
  ...
  async init() {
    ...
    globalThis.H5PIntegration.pathIncludesVersion = this.pathIncludesVersion = await this.checkIfPathIncludesVersion();
