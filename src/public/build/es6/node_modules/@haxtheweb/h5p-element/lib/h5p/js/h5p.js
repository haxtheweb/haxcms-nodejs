...
H5P.init = function (target) {
  ...
  if (H5P.fullscreenSupported === undefined) {
     ...
     * @type {boolean}
     */
    H5P.fullscreenSupported = !H5PIntegration.fullscreenDisabled && !H5P.fullscreenDisabled && (!(H5P.isFramed && H5P.externalEmbed !== false) || !!(globalThis.document.fullscreenEnabled || globalThis.document.webkitFullscreenEnabled || globalThis.document.mozFullScreenEnabled));
...
H5P.communicator = function () {
  ...
  return globalThis.postMessage && globalThis.addEventListener ? new Communicator() : undefined;
}();
...
H5P.fullScreen = function ($element, instance, exitCallback, body, forceSemiFullScreen) {
  ...
  if (H5P.isFramed && H5P.externalEmbed === false) {
    ...
    globalThis.parent.H5P.fullScreen($element, instance, exitCallback, H5P.$body.get(), forceSemiFullScreen);
