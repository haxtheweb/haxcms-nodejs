...
class A11yTabs extends ResponsiveUtilityBehaviors(LitElement) {
  ...
  _activeTabChanged(newValue, oldValue) {
    ...
    globalThis.dispatchEvent(new CustomEvent("a11y-tabs-active-changed", {
      cancelable: true,
      detail: this
    }));
  ...
  _tabButton(tab, i) {
    return html`
      <button
        ...
        role="tab"
        part="${tab.id === this.activeTab && !this.disabled ? "tab-active" : this.disabled || tab.disabled ? "tab-disabled" : ""} tab tab-${tab.id}"
      >
