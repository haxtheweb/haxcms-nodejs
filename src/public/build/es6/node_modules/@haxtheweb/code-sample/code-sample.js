 ...
 */
import { LitElement, html, css, render } from "../../lit/index.js";
...
class CodeSample extends LitElement {
  ...
  haxgizmoRegistration(store) {
    let list = ["javascript", "js", "json", "css", "php", "yaml", "xml", "html"];
    for (var i in list) {
      store.keyboardShortcuts["```" + list[i]] = {
        ...
        content: `<template preserve-content="preserve-content">${this.getExample(list[i])}</template>`
      };
    }
