 ...
 * @element clean-one
 */
class CleanOne extends LTIResizingMixin(PrintBranchMixin(PDFPageMixin(EmailPageMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(HAXCMSRememberRoute(DDDSuper(HAXCMSLitElementTheme))))))))) {
  //styles function
  static get styles() {
            ...
            <header class="site-header">
              <div class="btn-container">
                <div class="pull-left">
                  ...
                  ${MicroFrontendRegistry.has("@haxcms/siteToHtml") ? this.PrintBranchButton("bottom") : html`
                        <site-print-button
                          class="btn js-toolbar-action"
                          part="print-btn"
                        ></site-print-button>
                      `}
                  ${MicroFrontendRegistry.has("@core/htmlToPdf") ? this.PDFPageButton("bottom") : ``}
                </div>
  ...
  constructor() {
    ...
    // prettier-ignore
    import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js");
