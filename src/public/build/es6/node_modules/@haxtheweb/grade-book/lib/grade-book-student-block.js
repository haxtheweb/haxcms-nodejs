    ...
    return html`
      <grid-plate layout="1-2" disable-responsive>
        ...
        <div slot="col-2">
          ...
          <ul>
            ${this.student.userId ? html`<li>${this.t.userID}: ${this.student.userId}</li>` : ``}
            ${this.student.prefName ? html`<li>${this.t.preferredName}: ${this.student.prefName}</li>` : ``}
            ${this.student.email ? html`<li>
                  <a href="mailto:${this.student.email}"
                    >${this.t.emailAddress}</a
                  >
                </li>` : ``}
            ${this.student.notes ? html`<li>${this.t.notes}: ${this.student.notes}</li>` : ``}
            ${this.student.interests ? html`<li>
