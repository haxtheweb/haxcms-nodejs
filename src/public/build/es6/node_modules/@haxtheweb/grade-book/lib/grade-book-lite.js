...
import "../../simple-icon/lib/simple-icon-button-lite.js";
import "../../simple-icon/lib/simple-icons.js";
import "../../hax-iconset/lib/simple-hax-iconset.js";
import "../../simple-icon/simple-icon.js";
...
import { SimpleFilterMixin } from "../../simple-filter/simple-filter.js";
import { MicroFrontendRegistry } from "../../micro-frontend-registry/micro-frontend-registry.js";
...
class GradeBookLite extends UIRenderPieces(I18NMixin(SimpleFilterMixin(SimpleColors))) {
  ...
  PDFPageButton(position = "auto") {
    return html`
      ${MicroFrontendRegistry.has("@core/htmlToPdf") ? html` <div class="pdf-page-btn">
  ...
  async downloadPDFviaMicro(e) {
    ...
    if (response.status == 200 && response.data) {
      ...
      link.href = globalThis.URL.createObjectURL(b64toBlob(response.data, "application/pdf"));
  ...
  async createHashLink(e) {
    ...
    if (response.status == 200 && response.data) {
      globalThis.open(`https://secure-feedback.vercel.app/?message=${response.data}`, "_blank");
    }
    this.__hashLoading = false;
  }
