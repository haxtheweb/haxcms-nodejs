...
class LetterGradePicker extends LitElement {
  ...
  render() {
    return html`
      <div class="wrapper">
        ...
        ${GradeBookStore.gradeScale.map((scale, index) => html`
            <button
  ...
  clickScore(e) {
    ...
    const scaleItem = toJS(GradeBookStore.gradeScale.find(item => {
  ...
  scoreUpdated(e) {
    ...
    const newScore = Math.round(e.detail.value / this.possible * 100 * 100) / 100;
    const scaleItem = toJS(GradeBookStore.gradeScale.find(item => {
