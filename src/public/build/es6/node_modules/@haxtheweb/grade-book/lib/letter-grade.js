...
class LetterGrade extends LitElement {
  ...
  render() {
    return html`
      <div class="wrap">
        ...
        ${this.showScale && this._letterIndex !== null ? html`<div class="score">
              (${this.score}/${this.total} ${this.pointsSystem})
            </div>` : ``}
        ${this.showScale && this._letterIndex !== null ? html`<div class="range">
              ${this.gradeScale[this._letterIndex].lowRange}% -
              ${this.gradeScale[this._letterIndex].highRange}%
            </div>` : ``}
      </div>
      ${this.mini ? html`<simple-tooltip position="top"
            >${this.label}<br />${this.score != null ? html`(${this.score}/${this.total} ${this.pointsSystem})` : ``}</simple-tooltip
          >` : ``}
    `;
  }
  ...
  updated(changedProperties) {
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (["total", "score", "gradeScale"].includes(propName) && !this.displayOnly) {
