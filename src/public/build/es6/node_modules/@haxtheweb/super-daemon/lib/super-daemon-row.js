...
export class SuperDaemonRow extends SimpleColors {
  ...
  render() {
    return html`
      ...
      >
        ${this.icon ? html`<simple-icon-lite
              icon="${this.icon}"
              class="result-icon"
            ></simple-icon-lite>` : ``}
        ${this.image ? html`<img src="${this.image}" class="result-image" alt="" />` : ``}
        ${this.textCharacter ? html`<span class="result-textCharacter"
        ...
        <div class="tags" part="tags">
          ${this.tags.map((tag, i) => html` <simple-tag
                accent-color="${this.pickColor(i)}"
                value="${tag}"
                part="tag tag-${i}"
              ></simple-tag>`)}
        </div>
        ${this.more ? html`<simple-icon-button
              class="more"
              ?dark="${this.dark}"
            ...
            ></simple-icon-button>` : html`<div class="more"></div>`}
      </button>
      ${this.more ? html`<details
            id="details"
