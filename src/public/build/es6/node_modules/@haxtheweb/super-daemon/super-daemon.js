...
import "../simple-icon/lib/simple-icon-button.js";
...
class SuperDaemon extends SimpleColors {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("super-daemon-define-option", this.defineOptionEvent.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("super-daemon-element-method", this.elementMethod.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("super-daemon-element-click", this.elementClick.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("super-daemon-run-program", this.runProgramEvent.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("super-daemon-voice-command", this._addVoiceCommand.bind(this), {
      signal: this.windowControllers.signal
    });
  ...
  async runProgram(like = null, context = "/", values = {}, program = null, name = null, search = "") {
  ...
  runProgramEvent(e) {
    if (e.detail) {
      ...
      this.like = "";
      this.runProgram(null, data.context, this._programValues, data.program, data.name, "");
    } else {
      this.runProgram("", "/");
      this._programValues = {};
    }
  ...
  miniCancel() {
    if (this.activeNode && this.activeNode.focus && this.mini && !this.wand && this.activeRange && this.activeSelection) {
      try {
  ...
  promptMerlin(e) {
    ...
    this.listeningForInput = false;
    this.hal.speak(this.randomResponse(["I'm here", "Yes?", "What?", "What can I do for you?", "What do you need?", "How can I help?"]), this.santaMode).then(e => {
  ...
  updated(changedProperties) {
    ...
    if (changedProperties.has("context")) {
      this.dispatchEvent(new CustomEvent("super-daemon-context-changed", {
        bubbles: true,
        composed: true,
        detail: {
          value: this.context
    ...
    if (changedProperties.has("voiceSearch") && this.voiceSearch) {
      import("../hal-9000/hal-9000.js").then(() => {
...
globalThis.SuperDaemonManager.requestAvailability = () => {
  if (!globalThis.SuperDaemonManager.instance) {
    globalThis.SuperDaemonManager.instance = globalThis.document.createElement("super-daemon");
    globalThis.document.body.appendChild(globalThis.SuperDaemonManager.instance);
  }
  return globalThis.SuperDaemonManager.instance;
};
export const SuperDaemonInstance = globalThis.SuperDaemonManager.requestAvailability();