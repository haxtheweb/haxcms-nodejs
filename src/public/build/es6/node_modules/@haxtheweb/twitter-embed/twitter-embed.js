...
class TwitterEmbed extends LitElement {
  ...
  constructor() {
    super();
    this.lang = globalThis.document.body.getAttribute("xml:lang") || globalThis.document.body.getAttribute("lang") || globalThis.document.documentElement.getAttribute("xml:lang") || globalThis.document.documentElement.getAttribute("lang") || globalThis.navigator.language || FALLBACK_LANG;
  ...
  haxgizmoRegistration(store) {
    globalThis.dispatchEvent(new CustomEvent("i18n-manager-register-element", {
      detail: {
        ...
        localesPath: new URL("./locales/twitter-embed.haxProperties.es.json", import.meta.url).href + "/../",
        locales: ["es"]
      }
    }));
  }
  ...
  updated(changedProperties) {
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "tweet" && this[propName] && (this[propName].includes("twitter.com") || this[propName].includes("x.com"))) {
