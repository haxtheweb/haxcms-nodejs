...
import{html as e,css as a}from"../../../lit/index.js";import{HAXCMSLitElementTheme as t}from"../../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSMobileMenuMixin as o}from"../../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as r}from"../../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as n}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{MicroFrontendRegistry as d}from"../../micro-frontend-registry/micro-frontend-registry.js";import{HAXCMSRememberRoute as s}from"../../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as l}from"../../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{EmailPageMixin as p}from"../../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{PrintBranchMixin as m}from"../../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as c}from"../../haxcms-elements/lib/core/utils/PDFPageMixin.js";import"../../scroll-button/scroll-button.js";import"../../haxcms-elements/lib/ui-components/site/site-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../../haxcms-elements/lib/ui-components/layout/site-region.js";import{autorun as h,toJS as g}from"../../../mobx/dist/mobx.esm.js";import{DDDSuper as u}from"../../d-d-d/d-d-d.js";import{HAXCMSToastInstance as v}from"../../haxcms-elements/lib/core/haxcms-toast.js";import{LTIResizingMixin as f}from"../../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import"./polaris-media-banner.js";class PolarisFlexTheme extends(f(r(s(p(c(m(l(i(o(u(t))))))))))){static get styles(){return[super.styles,a`
    ...
    `}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},siteDescription:{type:String},imageLink:{type:String},image:{type:String},imageAlt:{type:String},pageDescription:{type:String},pageMedia:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"polaris-flex-theme"}appStoreReady(e){if(globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()){let e=globalThis.HaxStore.requestAvailability();["polaris-cta","polaris-mark","polaris-story-card","polaris-tile","media-quote"].map((a=>{let t=globalThis.document.createElement(a);e.haxAutoloader.appendChild(t)})),this.windowControllersLoaded.abort()}}constructor(){super(),v.style.setProperty("--rpg-character-toast-display","none"),v.style.setProperty("--rpg-character-toast-mid-background-image","none"),v.style.setProperty("--rpg-character-toast-right-background-image","none"),v.style.setProperty("--rpg-character-toast-left-background-image","none"),v.style.setProperty("--rpg-character-toast-mid-padding",0),v.style.setProperty("--rpg-character-toast-height","96px"),v.style.backgroundColor="light-dark(var(--ddd-accent-6), var(--ddd-primary-4))",this.windowControllersLoaded=new AbortController,globalThis.addEventListener("hax-store-app-store-loaded",this.appStoreReady.bind(this),{once:!0,passive:!0,signal:this.windowControllersLoaded.signal}),this.searchTerm="",this.imageAlt="",this.image="",this.imageLink="",this.pageDescription="",this.pageMedia="",this.__disposer=this.__disposer?this.__disposer:[],h((e=>{if(n.themeData&&n.themeData.variables){const e=g(n.themeData.variables);this.imageAlt=e.imageAlt,this.image=e.image,this.imageLink=e.imageLink}this.__disposer.push(e)})),h((e=>{this.siteDescription=g(n.siteDescription),this.__disposer.push(e)})),h((e=>{this.activeManifestIndex=g(n.activeManifestIndex),this.__disposer.push(e)})),h((e=>{let a=g(n.activeItem);this.pageDescription=a.description,this.__disposer.push(e)})),h((e=>{let a=g(n.activeItem);g(n.activeId);a.metadata&&a.metadata.image?this.pageMedia=a.metadata.image:this.pageMedia="",this.__disposer.push(e)})),h((e=>{n.activeItem&&n.activeItem.metadata&&n.activeItem.metadata.updated&&(this.pageTimestamp=g(n.activeItem.metadata.updated)),this.__disposer.push(e)}))}siteModalClick(e){import("../../haxcms-elements/lib/ui-components/site/site-search.js").then((e=>{"search"!==n.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search");const a=new URLSearchParams(n.currentRouterLocation.search),t=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");t.focus(),a.get("search")&&(t.value=a.get("search"),setTimeout((()=>{t.select()}),0))}))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}customElements.define(PolarisFlexTheme.tag,PolarisFlexTheme);export{PolarisFlexTheme};