...
import { HAXCMSLitElementTheme } from "../../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";
import { HAXCMSThemeParts } from "../../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";
import { HAXCMSMobileMenuMixin } from "../../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";
import { HAXCMSOperationButtons } from "../../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";
...
import { HAXCMSRememberRoute } from "../../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";
import { QRCodeMixin } from "../../haxcms-elements/lib/core/utils/QRCodeMixin.js";
import { EmailPageMixin } from "../../haxcms-elements/lib/core/utils/EmailPageMixin.js";
import { PrintBranchMixin } from "../../haxcms-elements/lib/core/utils/PrintBranchMixin.js";
import { PDFPageMixin } from "../../haxcms-elements/lib/core/utils/PDFPageMixin.js";
...
import "../../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";
import "../../haxcms-elements/lib/ui-components/navigation/site-menu.js";
import "../../haxcms-elements/lib/ui-components/layout/site-modal.js";
import "../../haxcms-elements/lib/ui-components/layout/site-region.js";
import { autorun, toJS } from "../../../mobx/dist/mobx.esm.js";
import { DDDSuper } from "../../d-d-d/d-d-d.js";
import { HAXCMSToastInstance } from "../../haxcms-elements/lib/core/haxcms-toast.js";
import { LTIResizingMixin } from "../../haxcms-elements/lib/core/utils/LTIResizingMixin.js";
 ...
 */
class PolarisInventTheme extends LTIResizingMixin(HAXCMSOperationButtons(HAXCMSRememberRoute(EmailPageMixin(PDFPageMixin(PrintBranchMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(DDDSuper(HAXCMSLitElementTheme)))))))))) {
  //styles function
  static get styles() {
  ...
  firstUpdated(changedProperties) {
    ...
    this.HAXCMSThemeSettings.scrollTarget = this.shadowRoot.querySelector("#main");
    globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget = this.HAXCMSThemeSettings.scrollTarget;

    // hook up the scroll target
    this.shadowRoot.querySelector("scroll-button").target = this.shadowRoot.querySelector("#main");
  }
  // render function
  render() {
    return html`
      ...
      <div class="content site-inner">
        <div class="nav">
          ...
          ${MicroFrontendRegistry.has("@core/htmlToPdf") ? this.PDFPageButton("right") : ``}
          ${MicroFrontendRegistry.has("@haxcms/siteToHtml") ? this.PrintBranchButton("right") : html`<replace-tag
  ...
  appStoreReady(e) {
    if (globalThis.HaxStore && globalThis.HaxStore.requestAvailability()) {
      ...
      ["polaris-cta", "polaris-mark", "polaris-story-card", "polaris-tile", "media-quote"].map(name => {
  ...
  constructor() {
    ...
    globalThis.addEventListener("hax-store-app-store-loaded", this.appStoreReady.bind(this), {
      once: true,
      passive: true,
  ...
  siteModalClick(e) {
    // prettier-ignore
    import("../../haxcms-elements/lib/ui-components/site/site-search.js").then(m => {
