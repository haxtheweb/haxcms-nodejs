...
import "../haxcms-elements/lib/ui-components/blocks/site-children-block.js";
 ...
 */
class PolarisTheme extends HAXCMSOperationButtons(PDFPageMixin(PrintBranchMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(DDDSuper(HAXCMSLitElementTheme))))))) {
  //styles function
  static get styles() {
