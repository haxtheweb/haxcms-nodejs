...
import { remoteLinkBehavior } from "../utils/lib/remoteLinkBehavior.js";
...
import { DDDMarginPadding, DDDBorders } from "../d-d-d/lib/DDDStyles.js";

// register the iconset
SimpleIconsetStore.registerIconset("stopnoteicons", `${new URL("./stop-note.js", import.meta.url).href}/../lib/svgs/stopnoteicons/`);
...
class StopNote extends I18NMixin(remoteLinkBehavior(DDD)) {
   ...
   */
  static get styles() {
    return [super.styles, DDDBorders, DDDMarginPadding, css`
        :host {
          display: block;
          color: black;
          width: auto;
