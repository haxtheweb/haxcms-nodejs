...
globalThis.DynamicImportRegistry.requestAvailability = () => {
  if (!globalThis.DynamicImportRegistry.instance && globalThis.document && globalThis.document.body) {
    globalThis.DynamicImportRegistry.instance = globalThis.document.createElement("dynamic-import-registry");
    globalThis.document.body.appendChild(globalThis.DynamicImportRegistry.instance);
  }
...
class DynamicImportRegistry extends HTMLElement {
  ...
  constructor(delayRender = false) {
    ...
    this.list = {};
    this.__loaded = {};
    this.basePath = new URL("./dynamic-import-registry.js", import.meta.url).href + "/../../../";
  ...
  connectedCallback() {
    globalThis.addEventListener("dynamic-import-registry--register", this.registerDefinitionEvent.bind(this), {
  ...
  async loadDefinition(tag) {
    ...
    if (!globalThis.customElements.get(tag) && this.list[tag] && !this.__loaded[tag]) {
      // let's assume it's there cause we got here
      // this can help things on polyfill environments
      this.__loaded[tag] = true;
      try {
        return await import(`${this.basePath}${this.list[tag]}`).then(module => {
