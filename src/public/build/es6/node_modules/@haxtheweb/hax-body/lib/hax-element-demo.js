  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      if (propName === "renderTag" && this[propName]) {
        ...
        if (this.activePickerSchema !== -1 && globalThis.document.querySelector("hax-picker") && globalThis.document.querySelector("hax-picker")._elements && globalThis.document.querySelector("hax-picker")._elements.length > 0) {
          ...
          el = haxElementToNode(globalThis.document.querySelector("hax-picker")._elements[this.activePickerSchema]);
