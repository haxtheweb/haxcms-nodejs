...
export const HaxUiFields = [css`
  ...
  `];
export const HaxUiSingletons = [css`
 ...
 */
export const HaxUiBaseStyles = [...HaxUiText, ...HaxUiSpacing, ...HaxUiFields, ...HaxUiTooltip, ...HaxUiSingletons, ...HaxUiColors];
export const HaxHexagon = [css`
    hexagon-loader {
      display: none;
      margin: 0 auto;
      z-index: 1000;
...
export const HaxTrayDetail = [css`
    #tray-detail {
      font-family: var(--hax-ui-font-family);
  ...
  `];
export const HaxTrayDetailHeadings = [css`
    h5 {
      font-size: var(--hax-tray-detail-topic-font-size);
    }
    h6 {
