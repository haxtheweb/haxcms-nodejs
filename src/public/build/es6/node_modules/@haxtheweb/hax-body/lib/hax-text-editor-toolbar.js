...
import { RichTextEditorToolbarBehaviors } from "../../rich-text-editor/lib/toolbars/rich-text-editor-toolbar.js";
 ...
 */
class HaxTextEditorToolbar extends RichTextEditorToolbarBehaviors(I18NMixin(HaxContextBehaviors(LitElement))) {
  //styles function
  static get styles() {
    return [
    //super.styles,
    ...super.baseStyles, ...super.stickyStyles, css`
        :host {
  ...
  constructor() {
    ...
    globalThis.HaxTextEditorToolbarConfig.inlineGizmos = globalThis.HaxTextEditorToolbarConfig.inlineGizmos || {};
    globalThis.HaxTextEditorToolbarConfig.default = window.HaxTextEditorToolbarConfig.default || [...this.defaultConfig];
    ...
    globalThis.addEventListener("hax-register-properties", this._handleElementRegister.bind(this));
  }
  /**
  ...
  get advancedInlineButtonGroup() {
    return {
      ...
      buttons: [this.strikethroughButton, this.markButton, this.abbrButton, this.codeButton, this.underlineButton]
    };
  }
  /**
  ...
  updated(changedProperties) {
    ...
    if (this.__ready) {
      changedProperties.forEach((oldValue, propName) => {
        if (propName === "parentSchema" || propName === "target") this.updateBlocks();
  ...
  async _setInlineElement(tag, props) {
    ...
    if (!tag || !props || !!globalThis.HaxTextEditorToolbarConfig.inlineGizmos[tag] || tag.indexOf("-") < 0) return;
    let element = {
        ...props
      },
      gizmo = props.gizmo || {},
      ...
      handlesInline = handles.filter(handle => handle.type === "inline").length > 1,
  ...
  updateToolbarElements() {
    ...
    this.__updated = true;
    let buttons = Object.keys(globalThis.HaxTextEditorToolbarConfig.inlineGizmos || {}).map(key => globalThis.HaxTextEditorToolbarConfig.inlineGizmos[key]);
    return buttons.length === 0 ? [...(this.defaultConfig || [])] : [...(this.defaultConfig || []), {
      type: "button-group",
