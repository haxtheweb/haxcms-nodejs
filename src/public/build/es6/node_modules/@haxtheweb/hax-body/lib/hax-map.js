...
import { normalizeEventPath, nodeToHaxElement } from "../../utils/utils.js";
import { HaxTrayDetailHeadings } from "./hax-ui-styles.js";
...
class HaxMap extends I18NMixin(SimpleColors) {
   ...
   */
  static get styles() {
    return [super.styles, ...HaxTrayDetailHeadings, css`
        :host {
          display: block;
        }
        .container {
  ...
  render() {
    return html`${this.hidden ? `` : html` <h5>${this.t.contentStatistics}</h5>
          <div class="stats">
            <div class="stat">
      ...
      return html`
                <li
                  class="${element.parent ? `parent-${element.parent}` : "no-parent"} ${["h1", "h2", "h3", "h4", "h5", "h6", element.tag].includes(element.parent) ? "" : "is-child"}"
                >
                  <hax-toolbar-item
