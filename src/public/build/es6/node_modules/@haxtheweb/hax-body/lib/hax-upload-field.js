...
import { SimpleFieldsUpload } from "../../simple-fields/lib/simple-fields-upload.js";
import { winEventsElement, localStorageGet } from "../../utils/utils.js";
...
class HaxUploadField extends winEventsElement(I18NMixin(SimpleFieldsUpload)) {
  ...
  _fileAboutToUpload(e) {
    if (this._canUpload()) {
      ...
      if (targets.length === 1) {
        ...
        HAXStore.haxAppPicker.presentOptions(targets, type, `${this.t.whereUpload} ${type}?`, "app");
      } else {
  ...
  _haxAppPickerSelection(e) {
    ...
    if (HAXStore.connectionRewrites.appendJwt != null) {
      requestEndPoint += "&" + HAXStore.connectionRewrites.appendJwt + "=" + localStorageGet(HAXStore.connectionRewrites.appendJwt);
    }
