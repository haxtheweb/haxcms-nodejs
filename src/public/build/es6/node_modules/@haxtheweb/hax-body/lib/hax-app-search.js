...
class HaxAppSearch extends LitElement {
  ...
  requestUrl(url = "", params = {}) {
    ...
    if (HAXStore.connectionRewrites.appendUploadEndPoint != null && params.__HAXAPPENDUPLOADENDPOINT__) {
    ...
    if (HAXStore.connectionRewrites.appendJwt != null && params.__HAXJWT__) {
      params[HAXStore.connectionRewrites.appendJwt] = localStorageGet(HAXStore.connectionRewrites.appendJwt);
    }
      ...
      if (data != null) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (typeof map.gizmo.type !== typeof undefined) {
            ...
            media[i].type = HAXStore.mimeTypeToGizmoType(this._resolveObjectPath(map.gizmo.mimetype, data[i]));
