...
class HaxAppPicker extends LitElement {
   ...
   */
  presentOptions(elements, type = "element", title = "Select an option", pickerType = "gizmo", target = window) {
    ...
    this.target = target;
    setTimeout(() => {
      this.shadowRoot.querySelector('[modal-id="hax-picker"]').openModal(target);
    }, 0);
  }
  render() {
    return html`
