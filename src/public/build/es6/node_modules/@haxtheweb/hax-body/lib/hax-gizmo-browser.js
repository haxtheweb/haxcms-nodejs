...
import { haxElementToNode } from "../../utils/utils.js";
...
import "../../simple-toolbar/lib/simple-button-grid.js";
import "../../simple-popover/lib/simple-popover-selection.js";
    ...
    return html`${this.hidden ? `` : html`<div class="toolbar-inner" part="toolbar">
          ...
          >
            <simple-button-grid columns="5" always-expanded part="grid">
              ${this.recentGizmoList.map((gizmo, i) => html` <simple-popover-selection
                    data-index="${i}"
          ...
          ${this.categories.map(tag => html` <a11y-collapse
                heading="${this.ucfirst(tag)}"
                heading-button
              >
                <simple-button-grid columns="3" always-expanded part="grid">
                  ${this.filtered.map((gizmo, i) => html`${gizmo && gizmo.tags && gizmo.tags.includes(tag) ? html` <simple-popover-selection
                            data-index="${i}"
                            @opened-changed="${this._hoverForPreviewChange}"
                            event="hover"
                          >
