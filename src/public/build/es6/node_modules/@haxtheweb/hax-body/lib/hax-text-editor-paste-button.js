...
import { RichTextEditorButtonBehaviors } from "../../rich-text-editor/lib/buttons/rich-text-editor-button.js";
/**
 ...
 */
class HaxTextEditorPasteButton extends RichTextEditorButtonBehaviors(LitElement) {
  /**
  ...
  sendCommand(e) {
    if (navigator && globalThis.navigator.clipboard) HAXStore._onPaste({
      ...e,
