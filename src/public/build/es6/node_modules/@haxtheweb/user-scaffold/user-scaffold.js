 ...
 */
import { localStorageSet, localStorageGet, localStorageDelete, validURL } from "../utils/utils.js";
...
globalThis.UserScaffold.requestAvailability = () => {
  ...
  if (!globalThis.UserScaffold.instance && globalThis.document && globalThis.document.body) {
    globalThis.UserScaffold.instance = globalThis.document.createElement("user-scaffold");
    globalThis.document.body.appendChild(globalThis.UserScaffold.instance);
  }
  return globalThis.UserScaffold.instance;
};
export const UserScaffoldInstance = globalThis.UserScaffold.requestAvailability();
