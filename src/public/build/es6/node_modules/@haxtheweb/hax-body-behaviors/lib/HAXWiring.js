 ...
 * }
 */
import { SimpleFields } from "../../simple-fields/simple-fields.js";
import "./HAXFields.js";
...
export class HAXWiring {
  constructor() {
    ...
    this.setup = (props, tag = "", context = this) => {
      ...
      if (typeof globalThis.HaxStore !== typeof undefined && globalThis.HaxStore.instance != null && globalThis.HaxStore.instance.ready) {
    ...
    this._haxStoreReady = e => {
      if (e.detail && typeof this.tagName !== typeof undefined && typeof this.haxProperties !== typeof undefined) {
        ...
        if (tag != "" && typeof globalThis.HaxStore === typeof undefined) {
        ...
        } else if (tag != "" && typeof globalThis.HaxStore.instance.elementList[tag.toLowerCase()] === typeof undefined) {
          const evt = new CustomEvent("hax-register-properties", {
            bubbles: true,
            composed: true,
            cancelable: true,
          ...
          context.dispatchEvent(evt);
        } else if (typeof this.tagName !== typeof undefined && typeof globalThis.HaxStore.instance.elementList[this.tagName.toLowerCase()] === typeof undefined) {
          const evt = new CustomEvent("hax-register-properties", {
            bubbles: true,
            composed: true,
            cancelable: true,
     ...
     * properties in order to be able to bubble up the properties for a tag.
     */
    this.setHaxProperties = async (props = {}, tag = "", context = document, isReady = false) => {
      ...
      if (props.api == "1") {
        ...
        if (typeof props.gizmo === typeof undefined) {
          ...
          if (typeof props.gizmo.iconLib !== typeof undefined) {
            ...
            if (globalThis.WCGlobalBasePath) {
              ...
              basePath = new URL("./HAXWiring.js", import.meta.url).href + "/../../../../";
            }
        ...
        if (typeof props.settings !== typeof undefined) {
          ...
          for (let i = 0; i < props.settings.developer.length; i++) {
            props.settings.developer[i] = this.validateSetting(props.settings.developer[i]);
          ...
          if (globalThis.HaxStore) {
            props = globalThis.HaxStore.requestAvailability().designSystemHAXProperties(props, tag);
          }
    ...
    this.getHaxJSONSchema = (type, haxProperties, target = this) => {
      ...
      // just to be safe
      if (haxProperties.gizmo && haxProperties.gizmo.tag && globalThis.customElements.get(haxProperties.gizmo.tag)) {
    ...
    this.getHaxJSONSchemaType = inputMethod => {
      var method = new SimpleFields().fieldsConversion.inputMethod[inputMethod] || new SimpleFields().fieldsConversion;
...
export const HAXElement = function (SuperClass) {
  return class extends SuperClass {
    ...
    setHaxProperties(props, tag = "", context = this) {
      ...
      if (globalThis.HaxStore && globalThis.HaxStore.instance != null && globalThis.HaxStore.instance.ready) {
