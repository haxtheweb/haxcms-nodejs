...
class SimpleLoginCamera extends HTMLElement {
  ...
  constructor() {
    ...
    if (globalThis.WCGlobalBasePath) {
      ...
      this.basePath = new URL("./simple-login-camera.js", import.meta.url).href + "/../../../../";
    }
    this.t = {
      record: "Record",
      pause: "Pause record",
    ...
    globalThis.dispatchEvent(new CustomEvent("i18n-manager-register-element", {
      detail: {
        ...
        localesPath: new URL("../locales/simple-login.es.json", import.meta.url).href + "/../",
    ...
    globalThis.addEventListener("es-bridge-msr-loaded", this._msrLoaded.bind(this), {
    ...
    globalThis.document.addEventListener("DOMContentLoaded", this.documentLoaded.bind(this), {
      signal: this.windowControllers.signal
    });
  ...
  _msrLoaded(e) {
    ...
    this._shadow.querySelector("#wrapper").addEventListener("click", () => {
      this.dispatchEvent(new CustomEvent("site-listing-video-activate", {
        detail: this,
        bubbles: true,
        composed: true
      }));
