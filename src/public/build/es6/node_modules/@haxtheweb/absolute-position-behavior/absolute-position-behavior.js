...
const AbsolutePositionBehaviorClass = function (SuperClass) {
  return class extends SuperClass {
    ...
    updated(changedProperties) {
      ...
      if (this.shadowRoot && !this.hidden) {
        changedProperties.forEach((oldValue, propName) => {
          ...
          if (["allowOverlap", "fitToVisibleBounds", "for", "offset", "position", "justify", "positionAlign", "target", "hidden", "sticky"].includes(propName) && this[propName] !== oldValue) updatePosition = true;
        });
    ...
    setPosition() {
      this.__observe = true;
      globalThis.AbsolutePositionStateManager.requestAvailability().loadElement(this);
    }
    ...
    unsetPosition() {
      this.__observe = false;
      globalThis.AbsolutePositionStateManager.requestAvailability().unloadElement(this);
    }
    ...
    updatePosition() {
      ...
      if (!this.auto || this.__observe === true) {
        globalThis.AbsolutePositionStateManager.requestAvailability().positionElement(this);
      }
    }
    /**
 ...
 */
class AbsolutePositionBehavior extends AbsolutePositionBehaviorClass(LitElement) {}
