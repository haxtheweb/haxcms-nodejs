 ...
 *
 */
import "../dynamic-import-registry/dynamic-import-registry.js";
  ...
  return new Promise((resolve, reject) => {
    ...
    if (globalThis.WCAutoloadRegistryFileProcessed) {
      ...
      setTimeout(async () => {
        ...
        if (globalThis.WCAutoloadRegistryFile && !globalThis.WCAutoloadRegistryFileProcessed) {
          // support single string or multiple registries
          if (typeof globalThis.WCAutoloadRegistryFile === "string") {
            globalThis.WCAutoloadRegistryFile = [globalThis.WCAutoloadRegistryFile];
          }
          for (var i = 0; i < globalThis.WCAutoloadRegistryFile.length; i++) {
            await fetch_retry(globalThis.WCAutoloadRegistryFile[i], {
              priority: "high"
...
globalThis.addEventListener("dynamic-import-registry--new-registration", globalThis.WCAutoload.postLoaded);
/**
 * `wc-registry`
