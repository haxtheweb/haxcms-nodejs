...
class SimpleModal extends LitElement {
  ...
  render() {
    ...
    >
      <div id="titlebar" part="titlebar" class=${this.title ? "full" : "empty"}>
        ...
        <div></div>
        ${!this.modal ? html`<simple-icon-button-lite
                id="close"
                dark
                icon="${this.closeIcon}"
                @click="${this.close}"
  ...
  firstUpdated() {
    import("../../web-dialog/index.js").then(e => {
      setTimeout(() => {
        this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.backgroundColor = "var(--ddd-theme-default-potential70)";
      }, 0);
    });
  }
   ...
   */
  show(title, mode, elements, invokedBy, id = null, modalClass = null, styles = null, clone = false, modal = false) {
