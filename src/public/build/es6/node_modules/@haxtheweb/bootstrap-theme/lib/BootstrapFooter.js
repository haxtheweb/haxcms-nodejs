...
class BootstrapFooter extends LitElement {
  ...
  constructor() {
    ...
    autorun(reaction => {
      ...
      if (this._activeItem !== storeActiveItemIndex || this._routerManifest !== storeRouterManifest) {
        ...
        if (storeRouterManifest.items[storeActiveItemIndex - 1]) {
          this._backwardItem = storeRouterManifest.items[storeActiveItemIndex - 1];
        }
        if (storeRouterManifest.items[storeActiveItemIndex + 1]) {
          this._forwardItem = storeRouterManifest.items[storeActiveItemIndex + 1];
        }
      }
