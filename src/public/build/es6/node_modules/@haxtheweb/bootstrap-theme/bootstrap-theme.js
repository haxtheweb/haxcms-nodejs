...
import { HAXCMSUserStylesMenuMixin } from "../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";
 ...
 */
class BootstrapTheme extends HAXCMSThemeParts(BootstrapUserStylesMenuMixin(HAXCMSMobileMenuMixin(HAXCMSLitElementTheme))) {
  /**
   * Convention we use
   */
  static get tag() {
      ...
      <div class="site ">
        <div class="menu-outline">
          <div class="site-title" part="site-title">
            ${this.__siteImage ? html`<img class="site-img" src=${this.__siteImage} />` : ``}
  ...
  _loadScripts() {
    ...
    globalThis.ESGlobalBridge.requestAvailability().load("jquery", basePath + jqueryPath);
    globalThis.addEventListener(`es-bridge-jquery-loaded`, this._jqueryLoaded.bind(this));
  }
  _bootstrapLoaded(e) {
  ...
  _loadBootstrap() {
    ...
    globalThis.ESGlobalBridge.requestAvailability().load("bootstrap", basePath + bootstrapPath);
    globalThis.addEventListener(`es-bridge-bootstrap-loaded`, this._bootstrapLoaded.bind(this));
  }
  _jqueryLoaded(e) {
    this._jquery = true;
    this._loadBootstrap();
