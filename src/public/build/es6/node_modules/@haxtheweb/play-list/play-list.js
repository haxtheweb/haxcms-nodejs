...
import { haxElementToNode, nodeToHaxElement, copyToClipboard } from "../utils/utils.js";
...
class PlayList extends LitElement {
  ...
  render() {
    return html`
      ${this.items.length > 0 && !this.edit ? html`
            <sl-carousel
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "edit" && !this[propName] && oldValue) {} //this.mirrorLightDomToItems();
      ...
      if (propName == "slide" && this.shadowRoot && typeof oldValue !== typeof undefined) {
        ...
        if (this.shadowRoot.querySelector(".carousel") && this.shadowRoot.querySelector(".carousel").activeSlide !== this[propName]) {
