import { css, html, unsafeCSS } from "../../lit/index.js";
import { toJS, autorun } from "../../mobx/dist/mobx.esm.js";
import { localStorageSet, localStorageGet } from "../utils/utils.js";
...
import "../simple-toolbar/lib/simple-toolbar-button.js";
...
`;
  ...
  playSound(sound = "coin2") {
    return new Promise(resolve => {
      if (store.soundStatus && store.appReady) {
        ...
        this.audio = new Audio(new URL(`./lib/assets/sounds/${playSound}.mp3`, import.meta.url).href);
  ...
  connectedCallback() {
    ...
    globalThis.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", darkToggle, {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("jwt-logged-in", this._jwtLoggedIn.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("jwt-login-refresh-error", this._tokenRefreshFailed.bind(this), {
      signal: this.windowControllers.signal
    });
  }
  ...
  constructor() {
    ...
    this.activeItem = {};
    this.phrases = {
      new: ["What's ya name?", "HAX to the moon", "Welcome to the Jungle", "We like to party", "Build something awesome", "Everything is awesome!", "Everything is cool", "When you're part of the team", "When you're living our dream", "Welcome to the up-side-down"],
      return: ["Welcome back, take 2?", "That wasn't very long", "Stranger thiings have happened", "Student driven platform", "Faculty centered platform", "Instructional designer influenced platform", "Free, Open, Community driven", "One brick at a time..", "Sup?", "You again? Awesome!", "Let's do this", "There can only be one ring...", "There is another", "Fancy that, I love HAX and you show up"]
    };
    this.isNewUser = null;
    this.basePath = "/";
    this.searchTerm = "";
    ...
    autorun(() => {
      ...
      requestAnimationFrame(() => {
        if (toJS(store.darkMode)) {
          ...
          store.toast("I'm ascared of the dark", 2000, {
            fire: true
          });
          this.dark = true;
          ...
          store.toast("Sunny day it is", 2000, {
            hat: "random"
          });
          this.dark = false;
  ...
  login() {
    import("./lib/v1/app-hax-site-login.js").then(() => {
      ...
      import("../simple-modal/simple-modal.js").then(() => {
        setTimeout(() => {
  ...
  firstUpdated(changedProperties) {
    ...
    autorun(() => {
      ...
      if (!toJS(store.soundStatus)) {
        ...
        store.toast("You can hear me now? Good.", 2000, {
          hat: "random"
        });
      }
    });
    ...
    autorun(async () => {
      if (toJS(store.appReady) && store.AppHaxAPI && toJS(store.isLoggedIn) && toJS(store.appSettings) && toJS(store.refreshSiteList)) {
  ...
  siteReadyToGo(e) {
    import("../multiple-choice/lib/confetti-container.js").then(module => {
      setTimeout(() => {
