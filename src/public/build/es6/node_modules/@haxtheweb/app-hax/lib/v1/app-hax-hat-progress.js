...
import "../../../promise-progress/promise-progress.js";
export class AppHaxHatProgress extends SimpleColors {
  ...
  firstUpdated(changedProperties) {
    ...
    setTimeout(() => {
      this.shadowRoot.querySelector("#progress2").addEventListener("value-changed", e => {
        this.shadowRoot.querySelector("#value").textContent = e.detail.value;
      });
      this.shadowRoot.querySelector("#progress2").addEventListener("max-changed", e => {
        this.max = e.detail.value;
      });
      this.shadowRoot.querySelector("#progress2").addEventListener("promise-progress-finished", e => {
        if (e.detail.value) {
          ...
          text.addEventListener("click", () => {
            store.appEl.reset();
            setTimeout(() => {
              globalThis.location = createResponse.slug.replace("index.html", "");
            }, 0);
          });
          ...
          this.dispatchEvent(new CustomEvent("promise-progress-finished", {
            composed: true,
            bubbles: true,
            cancelable: true,
            detail: true
