 ...
 * @element clean-one
 */
class AppHaxTheme extends HAXCMSRememberRoute(PrintBranchMixin(PDFPageMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(SimpleColorsSuper(DDDSuper(HAXCMSLitElementTheme)))))))) {
  //styles function
  static get styles() {
  ...
  HAXCMSGlobalStyleSheetContent() {
    ...
    return [...super.HAXCMSGlobalStyleSheetContent(), css`
        body {
          margin: 0;
          padding: 0;
