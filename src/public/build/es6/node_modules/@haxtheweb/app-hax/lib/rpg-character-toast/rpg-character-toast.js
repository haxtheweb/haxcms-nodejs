...
export class RPGCharacterToast extends SimpleToastEl {
      ...
      <div class="bubble bubble-wrapper" part="bubble-wrapper">
        ...
        <span class="bubble mid" part="bubble-mid">
          ...
          ${this.future ? html` <future-terminal-text
                ...
                glitch-max="3"
                glitch-duration="40"
              ></future-terminal-text>` : html`<div class="message">${this.text}</div>`}
          ${this.awaitingMerlinInput ? html`<simple-icon-lite
                class="awaiting-input"
                icon="hax:loading"
              ></simple-icon-lite>` : ``}
          ${!this.merlin ? html`<div class="buttons">
                <slot></slot
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("rpg-character-toast-hide", this.hideSimpleToast.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("rpg-character-toast-show", this.showSimpleToast.bind(this), {
      signal: this.windowControllers.signal
    });
  }
  hideSimpleToast(e) {
