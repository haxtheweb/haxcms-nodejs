...
export class AppHaxSiteLogin extends SimpleColors {
  ...
  async checkPassword() {
    ...
    globalThis.dispatchEvent(new CustomEvent("jwt-login-login", {
      composed: true,
      bubbles: true,
      cancelable: false,
      detail: {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("jwt-login-login-failed", this._jwtLoginFailed.bind(this), {
      signal: this.windowControllers.signal
    });
  }
