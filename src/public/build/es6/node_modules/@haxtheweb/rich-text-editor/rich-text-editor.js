  ...
  return class extends SuperClass {
    ...
    _handleClick(e) {
      ...
      if (!this.disabled && !this.editable && !this.__toolbar) {
        //get toolbar by id
        let toolbar,
          filter = !this.toolbarId ? [] : (globalThis.RichTextEditorToolbars || []).filter(toolbar => toolbar.id === this.toolbarId);
        //get toolbar by type
        if (filter.length === 0) {
          filter = !this.type ? [] : (globalThis.RichTextEditorToolbars || []).filter(toolbar => toolbar.type === this.type);
        }
        //get any toolbar
        ...
        if (filter[0]) {
          ...
          //make toolbar
          toolbar = globalThis.document.createElement(this.type || "rich-text-editor-toolbar");
        }
