 ...
 */
const RichTextToolbarStyles = [...RichTextStyles, css`
    :host {
      --simple-toolbar-border-color: var(--rich-text-editor-border-color, #ddd);
      --simple-toolbar-border-width: var(--rich-text-editor-border-width, 1px);
...
const RichTextEditorButtonBehaviors = function (SuperClass) {
  return class extends RichTextEditorRangeBehaviors(SimpleToolbarButtonBehaviors(SuperClass)) {
    /**
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        ...
        if (["shortcutKeys", "tagsList", "tagClickCallback"].includes(propName)) this.updateButtonRegistry();
      });
    }
    /**
     ...
     */
    sendCommand(event) {
      this._handleCommand(this.operationCommand, this.operationCommandVal, this.range);
...
export { RichTextEditorButton, RichTextEditorButtonBehaviors, RichTextStyles, RichTextToolbarStyles };