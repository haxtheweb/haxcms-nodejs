...
class RichTextEditorLink extends RichTextEditorPromptButtonBehaviors(LitElement) {
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      if (propName === "allowTarget") {
        this.fields = !this.allowTarget ? [...this.defaultFields] : [...this.defaultFields, {
          property: "target",
          title: "Target",
  ...
  getValue() {
    return {
      ...super.getValue(),
      target: !!this.allowTarget && !!this.targetedNode && this.targetedNode.getAttribute && this.targetedNode.getAttribute("target") ? this.targetedNode.getAttribute("target") : "_blank",
