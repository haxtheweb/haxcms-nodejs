...
const RichTextEditorPromptButtonBehaviors = function (SuperClass) {
  return class extends RichTextEditorButtonBehaviors(SuperClass) {
     ...
     */
    get setsInnerHTML() {
      let innerHTML = (this.fields || []).filter(field => field.property === "innerHTML");
    ...
    close() {
      ...
      this.dispatchEvent(new CustomEvent("rich-text-editor-prompt-close", {
        bubbles: true,
        cancelable: true,
        composed: true,
        detail: this
    ...
    confirm(val) {
      this.value = val;
      this.dispatchEvent(new CustomEvent("rich-text-editor-prompt-confirm", {
        bubbles: true,
        cancelable: true,
        composed: true,
        detail: this
 ...
 */
class RichTextEditorPromptButton extends RichTextEditorPromptButtonBehaviors(LitElement) {}
