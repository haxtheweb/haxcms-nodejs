...
class RichTextEditorPrompt extends RichTextEditorRangeBehaviors(LitElement) {
  static get styles() {
    return [...RichTextToolbarStyles, css`
        #prompt {
          display: block;
          width: 300px;
          max-width: 300px;
  ...
  constructor() {
    ...
    globalThis.addEventListener("rich-text-editor-prompt-open", this.open.bind(this));
  ...
  firstUpdated(changedProperties) {
    ...
    this.__highlight.addEventListener("change", e => setTimeout(this._handleChange(e), 300));
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      if (["__focused", "__hovered", "__opened"].includes(propName)) setTimeout(this._handleChange.bind(this), 300);
    });
  }
  /**
...
globalThis.RichTextEditorPrompt.requestAvailability = () => {
  if (!globalThis.RichTextEditorPrompt.instance) {
    globalThis.RichTextEditorPrompt.instance = globalThis.document.createElement("rich-text-editor-prompt");
