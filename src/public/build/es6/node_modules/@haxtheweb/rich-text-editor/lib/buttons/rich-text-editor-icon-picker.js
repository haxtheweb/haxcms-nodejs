...
import { SimpleIconPicker } from "../../../simple-icon-picker/simple-icon-picker.js";
/**
 ...
 */
class RichTextEditorIconPicker extends RichTextEditorPickerBehaviors(LitElement) {
  /**
  ...
  _pickerChange(e) {
    ...
    this.commandVal = e.detail.value ? `<simple-icon-lite icon="${e.detail.value}"></simple-icon-lite>` : "";
