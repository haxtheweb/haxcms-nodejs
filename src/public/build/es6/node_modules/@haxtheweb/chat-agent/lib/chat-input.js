...
class ChatInput extends DDD {
  ...
  handleSendButton() {
    ...
    if (ChatStore.promptCharacterLimit > 0 && INPUTTED_PROMPT.length > ChatStore.promptCharacterLimit) {
    ...
    switch (direction) {
      case "up":
        if (this.previousMessagesIndex > 1) {
          ...
          while (this.chatLog[this.previousMessagesIndex].author !== this.userName && this.previousMessagesIndex >= 1) {
            this.previousMessagesIndex--;
            if (this.previousMessagesIndex < 1) {
              this.previousMessagesIndex++;
              break;
      ...
      case "down":
        if (this.previousMessagesIndex < this.messageIndex) {
          this.previousMessagesIndex++;
          while (this.chatLog[this.previousMessagesIndex].author !== this.userName && this.previousMessagesIndex < this.messageIndex) {
            this.previousMessagesIndex++;
            if (this.previousMessagesIndex >= this.messageIndex) {
