...
import { SimpleFieldsForm } from "../../simple-fields/lib/simple-fields-form.js";
...
class HaxElementListSelector extends LitElement {
  ...
  constructor() {
    ...
    if (globalThis.WCGlobalBasePath) {
      ...
      this.basePath = new URL("./hax-element-list-selector.js", import.meta.url).href + "/../../../../";
    }
    ...
    setTimeout(() => {
      globalThis.addEventListener("a11y-tabs-active-changed", this._activeTabChanged.bind(this));
    }, 0);
