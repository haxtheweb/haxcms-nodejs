...
class HAXElementCardList extends LitElement {
  ...
  render() {
    return !this.showCardList ? `` : html`
          ...
          >
            ${this.productList.map((el, i) => html`
                <product-card
                ...
                >
                  ...
                  <div slot="details-collapse-content">
                    <ul>
                      <li>
                        <strong>Tags:</strong> ${el.schema.gizmo.tags.map(group => html` ${group}, `)}
                      </li>
                      ...
                      ${el.schema.gizmo.meta ? html`
                            ${Object.keys(el.schema.gizmo.meta).map(mel => html`
                                <li>
                  ...
                  <div slot="demo-collapse-content">
                    ${el.schema.demoSchema && el.showDemo ? html`
