    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName !== "shortName" && globalThis.DISQUS) {
        ...
        this._timeout = setTimeout(() => {
          DisqusInstance.rebuildConfiguration(this, this.pageIdentifier, this.pageURL, this.pageTitle, this.lang);
        }, 100);
      }
    });
  }
...
globalThis.DisqusSingleton.requestAvailability = () => {
  if (!globalThis.DisqusSingleton.instance && globalThis.document && globalThis.document.body) {
    globalThis.DisqusSingleton.instance = globalThis.document.createElement(DisqusBroker.tag);
    globalThis.document.body.insertAdjacentElement("afterbegin", globalThis.DisqusSingleton.instance);
  }
...
globalThis.disqus_config = globalThis.disqus_config || function () {
  this.language = "en";
