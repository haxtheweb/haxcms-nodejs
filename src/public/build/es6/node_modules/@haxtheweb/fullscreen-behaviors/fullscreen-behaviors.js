...
const FullscreenBehaviors = function (SuperClass) {
  return class extends SuperClass {
    ...
    toggleFullscreen(mode = globalThis.document.fullscreenElement !== this.fullscreenTarget) {
      if (!mode || document.fullscreenElement && globalThis.document.exitFullscreen) globalThis.document.exitFullscreen();
