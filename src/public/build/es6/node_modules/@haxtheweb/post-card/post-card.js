 ...
 * @element post-card
 */
const postCardLines = new URL(`./lib/assets/postcard-lines.png`, import.meta.url).href;
const entireCardBg = new URL(`./lib/assets/postcard-bg.jpg`, import.meta.url).href;
export class PostCard extends LitElement {
  ...
  constructor() {
    ...
    this.photoSrc = new URL(`./lib/assets/postcard-photo-stock.jpg`, import.meta.url).href;
    this.stampSrc = new URL(`./lib/assets/postcard-stamp-stock.jpg`, import.meta.url).href;
    this.postMarkLocations = "insert - locations - here";
    globalThis.dispatchEvent(new CustomEvent("i18n-manager-register-element", {
      detail: {
        context: this,
        namespace: "post-card",
        localesPath: new URL("./locales/post-card.es.json", import.meta.url).href + "/../",
