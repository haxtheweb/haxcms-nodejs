(function () {
  ...
  function GitGraph(options) {
    ...
    // Canvas init
    this.canvas = this.element ? this.element : globalThis.document.getElementById(this.elementId) || options.canvas;
  ...
  function Template(options) {
     ...
     */
    this.branch.labelRotation = options.branch.labelRotation !== undefined ? options.branch.labelRotation : null;
