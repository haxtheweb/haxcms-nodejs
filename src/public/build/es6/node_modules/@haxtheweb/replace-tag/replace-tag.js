  ...
  return class extends SuperClass {
    ...
    runReplacement() {
      ...
      if (this.getAttribute("with")) {
        ...
        import("../wc-autoload/wc-autoload.js").then(() => {
          ...
          globalThis.WCAutoload.process().then(() => {
            ...
            globalThis.WCAutoload.requestAvailability().registry.loadDefinition(this.getAttribute("with"));
          });
        });
      } else {
  ...
  constructor() {
    ...
    if (customElements.get(this.getAttribute("with"))) {
      ...
      customElements.whenDefined(this.getAttribute("with")).then(response => {
        ...
        setTimeout(() => {
          globalThis.document.body.querySelectorAll('replace-tag[with="' + props.with + '"]').forEach(el => {
            el.runReplacement();
          });
        }, 0);
      });
