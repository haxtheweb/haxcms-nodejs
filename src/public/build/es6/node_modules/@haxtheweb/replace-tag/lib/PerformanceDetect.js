...
globalThis.PerformanceDetectManager.requestAvailability = () => {
  if (!globalThis.PerformanceDetectManager.instance) {
    globalThis.PerformanceDetectManager.instance = globalThis.document.createElement("performance-detect");
...
export const DeviceDetails = globalThis.PerformanceDetectManager.requestAvailability();
class PerformanceDetect extends HTMLElement {
  ...
  async updateDetails() {
    ...
    if (navigator) {
      ...
      if (globalThis.navigator.connection && globalThis.navigator.connection.effectiveType && ["slow-2g", "2g", "3g"].includes(navigator.connection.effectiveType)) {
