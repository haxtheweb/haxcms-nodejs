...
export function WCRegistryLoaderCSS(auto = false, parent = "*", selectorBase = ":not(:defined)") {
...
const loadingStylesResizeEvent = function () {
  ...
  WCRegistryLoaderCSSDebounce2 = setTimeout(() => {
    ...
    if (globalThis.document.body.querySelectorAll("replace-tag,:not(:defined)").length > 0) {
      WCRegistryLoaderCSS();
    } else {
