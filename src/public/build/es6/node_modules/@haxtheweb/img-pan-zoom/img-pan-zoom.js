...
class ImgPanZoom extends LitElement {
  ...
  render() {
    return html`
      ...
      ${!this.dzi ? html`
            ${this.hideSpinner || this.loaded ? `` : html`
                  <div id="loader">
                    <hexagon-loader
  ...
  constructor() {
    ...
    const basePath = new URL("./img-pan-zoom.js", import.meta.url).href.replace("/img-pan-zoom.js", "/");
    let location = `${basePath}lib/openseadragon/openseadragon.min.js`;
    globalThis.addEventListener("es-bridge-openseadragon-loaded", this._openseadragonLoaded.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.ESGlobalBridge.requestAvailability().load("openseadragon", location);
  ...
  _initOpenSeadragon() {
    setTimeout(() => {
      ...
      if (!this.viewer) this.viewer = new OpenSeadragon({
        ...
        prefixUrl: `${new URL("./img-pan-zoom.js", import.meta.url).href}/../lib/openseadragon/images/`,
