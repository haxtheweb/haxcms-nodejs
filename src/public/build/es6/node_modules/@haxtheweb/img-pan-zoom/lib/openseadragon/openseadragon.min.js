...
!function ($) {
  ...
  $.extend($, {
    ...
    addEvent: function () {
      if (globalThis.addEventListener) return function (e, t, i, n) {
    ...
    getUrlProtocol: function (e) {
      var t = e.match(/^([a-z]+:)\/\//i);
      return null === t ? globalThis.location.protocol : t[1].toLowerCase();
    },
  ...
  !function () {
    ...
    switch (navigator.appName) {
      case "Microsoft Internet Explorer":
        ...
        break;
      case "Netscape":
        if (globalThis.addEventListener) if (0 <= t.indexOf("Firefox")) {
    ...
    var i,
      n,
      o,
      r = globalThis.location.search.substring(1).split("&");
...
!function (m) {
  ...
  function E(e) {
    globalThis.location != window.parent.location && m.MouseTracker.resetAllMouseTrackers();
