...
class SimpleTooltip extends LitElement {
  ...
  _getAnimationType(type) {
    ...
    if (this.animationConfig[type] && typeof this.animationConfig[type][0].name === "string") {
      ...
      if (this.animationConfig[type][0].timing && this.animationConfig[type][0].timing.delay && this.animationConfig[type][0].timing.delay !== 0) {
        ...
        if (type === "entry") {
          globalThis.document.documentElement.style.setProperty("--simple-tooltip-delay-in", timingDelay + "ms");
        } else if (type === "exit") {
          globalThis.document.documentElement.style.setProperty("--simple-tooltip-delay-out", timingDelay + "ms");
        }
      }
  ...
  _delayChange(newValue) {
    ...
    if (newValue !== 500) {
      globalThis.document.documentElement.style.setProperty("--simple-tooltip-delay-in", newValue + "ms");
    }
  }
}
