...
class CodeEditor extends SchemaBehaviors(LitElement) {
  ...
  constructor() {
    ...
    if (globalThis.WCGlobalBasePath) {
      ...
      this.libPath = new URL("./code-editor.js", import.meta.url).href + "/../../../";
    }
  ...
  ${this.placeholder}</code></pre>
      <slot hidden></slot>
      ${this.showCodePen ? html`<div class="code-pen-container" part="code-pen">
  ...
  getTheme(theme) {
    let watch = globalThis.matchMedia && theme == "auto",
      dark = watch && globalThis.matchMedia("(prefers-color-scheme: dark)").matches,
      light = watch && globalThis.matchMedia("(prefers-color-scheme: light)").matches,
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "showCodePen") {
        ...
        if (this[propName] && !globalThis.customElements.get("code-pen-button")) {
