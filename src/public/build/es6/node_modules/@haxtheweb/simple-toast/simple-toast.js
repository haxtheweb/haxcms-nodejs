...
class SimpleToast extends SimpleColors {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("simple-toast-hide", this.hideSimpleToast.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("simple-toast-show", this.showSimpleToast.bind(this), {
      signal: this.windowControllers.signal
    });
  }
  /**
