...
import { JSONOutlineSchemaItem } from "../json-outline-schema/lib/json-outline-schema-item.js";
...
import { encapScript, haxElementToNode } from "../utils/utils.js";
/**
 * `outline-designer`
  ...
  render() {
    return html` <div class="controls">
      ...
      value: "below"
        ...
        >
        ${this.hasDeletedItems() ? html`<simple-icon-button-lite
              icon="delete"
              @click="${this.toggleDelete}"
              class="control"
              >${!this.hideDelete ? "Hide Deleted" : "Show Deleted"}</simple-icon-button-lite
            >` : ``}
      </div>
      <ul id="list">
