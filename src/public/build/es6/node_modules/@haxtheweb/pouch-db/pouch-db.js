...
class PouchDb extends HTMLElement {
   ...
   */
  connectedCallback() {
    globalThis.addEventListener("user-engagement", this.userEngagmentFunction.bind(this), {
      signal: this.windowControllers.signal
    });
    globalThis.addEventListener("pouch-db-get-data", this.getDataFunction.bind(this), {
      signal: this.windowControllers.signal
    });
  }
