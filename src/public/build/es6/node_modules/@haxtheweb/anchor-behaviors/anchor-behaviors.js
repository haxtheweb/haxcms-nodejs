...
globalThis.AnchorBehaviors.getTarget = (element = null) => {
  ...
  let getParams = () => {
      let str = globalThis.location.hash.substring(1).replace(/^(.+)&?/, "id=$1") || globalThis.location.search.substring(1) || "",
