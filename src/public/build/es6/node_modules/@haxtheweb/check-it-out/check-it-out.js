...
class CheckItOut extends IntersectionObserverMixin(LitElement) {
  ...
  renderLogic() {
    return html`
      ${["code", "pdf"].includes(this.type) ? html`<div class="container">
            <iframe-loader>
              <iframe
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "modal" && this[propName] && this.elementVisible) {
        // prettier-ignore
        import("../simple-modal/lib/simple-modal-template.js").then(() => {
          if (this.shadowRoot) {
            this.shadowRoot.querySelector('[modal-id="m1"]').associateEvents(this.shadowRoot.querySelector('[controls="m1"]'));
          }
        });
      }
