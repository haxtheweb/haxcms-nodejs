...
class MapMenuHeader extends I18NMixin(LitElement) {
  ...
  render() {
    return html` <a tabindex="-1" href="${this.url}" title="${this.itemtitle}">
        <button>
          ${!this.published ? html`<simple-icon-lite
                id="unpublished"
          ...
          ${this.icon ? html`
                <simple-icon-lite
                  ...
                  id="icon"
                ></simple-icon-lite>
                ${this.iconLabel ? html`<simple-tooltip for="icon"
      ...
      ${this.editControls && this.active ? html` <div class="ops">
            <haxcms-button-add
              class="op"
              type="child"
  ...
  constructor() {
    ...
    this.registerLocalization({
      context: this,
      namespace: "map-menu",
      localesPath: new URL("../locales/map-menu.es.json", import.meta.url).href + "/../",
      locales: ["es"]
    });
    setTimeout(() => {
