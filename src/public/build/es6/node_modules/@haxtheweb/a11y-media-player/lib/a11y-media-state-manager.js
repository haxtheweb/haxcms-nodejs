...
globalThis.A11yMediaStateManager.requestAvailability = () => {
  if (!globalThis.A11yMediaStateManager.instance && globalThis.document) {
    globalThis.A11yMediaStateManager.instance = globalThis.document.createElement("a11y-media-state-manager");
...
class A11yMediaStateManager extends LitElement {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("a11y-player-playing", this.__stickyManager.bind(this), {
      signal: this.windowControllers.signal
    });

    // listen for a player toggling fullscreen mode
    globalThis.addEventListener("fullscreen-toggle", this._handleFullscreen.bind(this), {
      signal: this.windowControllers.signal
    });
