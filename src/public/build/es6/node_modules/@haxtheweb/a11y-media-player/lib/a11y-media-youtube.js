...
class A11yMediaYoutube extends LitElement {
  ...
  static warmConnections() {
    ...
    A11yMediaYoutube.addPrefetch("preconnect", "https://www.youtube-nocookie.com");
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName === "duration" && this.duration > 0) this._handleMediaLoaded();
  ...
  _preloadVideo(auto = false) {
    ...
    if (load) {
      ...
      A11yMediaYoutube.addPrefetch("preload", `https://img.youtube.com/vi/${this.videoId.replace(/[\?&].*/, "")}/hqdefault.jpg`, "image");
