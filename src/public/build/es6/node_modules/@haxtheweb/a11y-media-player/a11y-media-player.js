...
import { FullscreenBehaviors } from "../fullscreen-behaviors/fullscreen-behaviors.js";
...
import "../simple-range-input/simple-range-input.js";
...
class A11yMediaPlayer extends FullscreenBehaviors(DDD) {
    ...
    return html` <div class="sr-only" ?hidden="${!this.mediaCaption}">
      ...
      <div id="player-section">
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            ...
            ${this.videoId && this.__playerReady ? html`
                  <a11y-media-youtube
                    id="youtube-${this.id}"
      ...
      this.toggleMute();
          ...
          <div id="controls-right">
            ...
            ></a11y-media-button>
            ${this.isYoutube ? html` <a11y-media-button
                  accent-color="${this.accentColor}"
                  ?dark="${this.dark}"
                  class="hide-sticky"
  ...
  get playerStyle() {
    let height = this.audioNoThumb ? "60px" : "unset",
      paddingTop = this.fullscreen || this.audioNoThumb || this.audioOnly || this.height ? `unset` : `${100 / this.aspect}%`,
  ...
  print() {
    let cues = this.transcriptTrack.cues,
      title = this.mediaTitle && this.mediaTitle.trim() != "" ? `${this.mediaTitle} (${this._getLocal(this.localization, "transcript", "label")})` : this._getLocal(this.localization, "transcript", "label"),
      print = globalThis.open("", "", "left=0,top=0,width=552,height=477,toolbar=0,scrollbars=0,status =0");
  ...
  play() {
     ...
     */
    this.dispatchEvent(new CustomEvent("a11y-player-playing", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  getloadedTracks() {
    ...
    if (!media) {
      primary = globalThis.document.createElement(this.querySelectorAll('source[type*="audio"]').length > 0 || !hasVideo ? "audio" : "video");
  ...
  setPlaybackRate(value) {
     ...
     */
    globalThis.dispatchEvent(new CustomEvent("playback-rate-changed", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  setVolume(value = 70) {
     ...
     */
    globalThis.dispatchEvent(new CustomEvent("volume-changed", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  toggleCC(mode) {
     ...
     * @event cc-toggle
     */
    globalThis.dispatchEvent(new CustomEvent("cc-toggle", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  toggleFullscreen(mode) {
     ...
     */
    globalThis.dispatchEvent(new CustomEvent("fullscreen-toggle", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  toggleLoop(mode) {
     ...
     * @event loop-toggle
     */
    globalThis.dispatchEvent(new CustomEvent("loop-toggle", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  togglePlay() {
     ...
     * @event play-toggle
     */
    globalThis.dispatchEvent(new CustomEvent("play-toggle", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  toggleMute(mode) {
     ...
     * @event muted-toggle
     */
    globalThis.dispatchEvent(new CustomEvent("muted-toggle", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
  ...
  firstUpdated(changedProperties) {
     ...
     */
    globalThis.dispatchEvent(new CustomEvent("responsive-element", {
      detail: {
        element: this,
        attribute: "responsive-size",
     ...
     * @event a11y-player
     */
    globalThis.dispatchEvent(new CustomEvent("a11y-player", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: this
