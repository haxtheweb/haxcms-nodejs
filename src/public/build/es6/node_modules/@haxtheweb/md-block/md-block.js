...
class MdBlock extends DDD {
  ...
  render() {
    return html` <div>
      ${this.markdown && this.source == "" ? html` <marked-element markdown="${this.markdown}">
            <div slot="markdown-html"></div>
          </marked-element>` : html` <marked-element>
            <div slot="markdown-html"></div>
            <script
              type="text/markdown"
  ...
  static get haxProperties() {
    return {
      ...
      gizmo: {
        ...
        icon: "icons:code",
        color: "yellow",
        tags: ["Resource", "md", "markdown", "content", "text", "code", "codeblock", "code-block", "code block", "html"],
        handles: [],
        meta: {
          author: "HAXTheWeb",
