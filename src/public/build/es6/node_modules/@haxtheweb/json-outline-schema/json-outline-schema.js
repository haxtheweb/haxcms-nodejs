...
globalThis.JSONOutlineSchema.requestAvailability = () => {
  ...
  if (!globalThis.JSONOutlineSchema.instance && globalThis.document && globalThis.document.body) {
    globalThis.JSONOutlineSchema.instance = globalThis.document.createElement("json-outline-schema");
...
<slot></slot>`;
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("json-outline-schema-debug-toggle", this._toggleDebug.bind(this), {
  ...
  treeToNodes(tree, appendTarget) {
    for (var i in tree) {
      ...
      if (tree[i].children && tree[i].children.length > 0) {
        appendTarget.appendChild(this.treeToNodes(tree[i].children, globalThis.document.createElement("ul")));
      }
    }
    return appendTarget;
  }
