import { SimpleTourManager } from "./simple-tour.js";
    ...
    discoverSimpleTourStops() {
      ...
      items.forEach(el => {
        try {
          ...
          let content = el.querySelector("[data-stop-content]").innerHTML ? el.querySelector("[data-stop-content]").innerHTML : "";
          SimpleTourManager.createTourStop(this.tourName, el, title, content, "live");
        } catch (e) {
          console.warn(e);
        }
      });
