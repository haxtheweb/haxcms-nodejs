import { LitElement, html, render } from "../../../lit/index.js";
...
class SimpleTour extends LitElement {
  constructor() {
    ...
    this.stop = -1;
    globalThis.addEventListener("simple-tour-register", this.registerNewTourEvent.bind(this));
    globalThis.addEventListener("simple-tour-create-tour-stop", this.createTourStopEvent.bind(this));
  }
  ...
  stopTour(e) {
    globalThis.SimplePopoverManager.requestAvailability().setPopover(this, this, false, this.orientation);
    this.stop = -1;
    this.active = null;
    this.dispatchEvent(new CustomEvent("tour-changed", {
      bubbles: true,
  ...
  updated(changedProperties) {
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName == "stop" && this.stop != -1 || propName == "active" && this.active) {
        render(globalThis.document.createElement("div"), globalThis.SimplePopoverManager.requestAvailability());
        ...
        let content = html`${this.tourButtons()}
          ...
          ${unsafeHTML('<p slot="body">' + description + "</p>")}${this.tourInfo[this.active].style ? unsafeHTML("<style>" + this.tourInfo[this.active].style + "</style>") : ""}`;
        render(content, globalThis.SimplePopoverManager.requestAvailability());
        globalThis.SimplePopoverManager.requestAvailability().setPopover(this, this.stacks[this.active][this.stop].target, true, this.orientation, this.active);
