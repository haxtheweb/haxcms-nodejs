import { html, LitElement, render } from "../../../lit/index.js";
...
class SimplePopoverSelection extends LitElement {
  ...
  openedChanged(state) {
    if (state) {
      ...
      if (this.querySelector('[slot="style"]')) {
        ...
        content = html`${unsafeHTML(div.innerHTML)}${unsafeHTML(style.outerHTML)}`;
      } else {
      ...
      setTimeout(() => {
        ...
        let children = globalThis.SimplePopoverManager.requestAvailability().querySelectorAll("*");
        ...
        if (globalThis.SimplePopoverManager.requestAvailability().querySelector("[data-simple-popover-selection-active]")) {
          globalThis.SimplePopoverManager.requestAvailability().querySelector("[data-simple-popover-selection-active]").focus();
        } else if (globalThis.SimplePopoverManager.requestAvailability() && globalThis.SimplePopoverManager.requestAvailability().querySelector(":first-child")) {
          globalThis.SimplePopoverManager.requestAvailability().querySelector(":first-child").focus();
        }
      }, 0);
    }
    globalThis.SimplePopoverManager.requestAvailability().setPopover(this, this.querySelector('[slot="button"]'), state);
  }
  /**
  ...
  itemSelect(e) {
    ...
    this.opened = false;
    setTimeout(() => {
      globalThis.SimplePopoverManager.requestAvailability().setPopover(this, this.querySelector('[slot="button"]'), false);
