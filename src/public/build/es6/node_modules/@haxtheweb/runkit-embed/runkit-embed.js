...
class RunkitEmbed extends DDD {
  ...
  updated(changedProperties) {
    ...
    if (!this._haxstate && !this.dataHaxActive && this.__runkitloaded && (changedProperties.has("source") || changedProperties.has("nodeVersion") || changedProperties.has("mode")) && this.nodeVersion && this.mode && this.source) {
      this.buildRunKit();
    }
  }
  buildRunKit() {
