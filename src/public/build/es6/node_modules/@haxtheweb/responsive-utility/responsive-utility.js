...
class ResponsiveUtility extends LitElement {
  ...
  _getObserver(detail) {
    return new ResizeObserver(en => en.forEach(e => globalThis.ResponsiveUtility.setSize(detail, e.contentBoxSize || e.borderBoxSize || e.contentRect || e.target ? e.target.offsetWidth : 0)));
  }
  /**
  ...
  constructor() {
    super();
    this.details = [];
    globalThis.addEventListener("responsive-element", this.responiveElementEvent.bind(this));

    /* handle element deregistration */
    globalThis.addEventListener("delete-responsive-element", this.deleteResponiveElementEvent.bind(this));
    if (globalThis.ResponsiveUtility.instance == null) globalThis.ResponsiveUtility.instance = this;
  }
}
...
globalThis.ResponsiveUtility.requestAvailability = () => {
  if (globalThis.ResponsiveUtility.instance == null && globalThis.document && globalThis.document.body) {
    globalThis.ResponsiveUtility.instance = globalThis.document.createElement("responsive-utility");
