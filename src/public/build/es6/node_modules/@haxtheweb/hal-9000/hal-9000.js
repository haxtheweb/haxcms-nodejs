...
import "../super-daemon/lib/super-daemon-toast.js";
...
class Hal9000 extends LitElement {
  ...
  constructor() {
    ...
    const location = `${new URL("./lib/annyang/annyang.min.js", import.meta.url).href}`;
    globalThis.addEventListener("es-bridge-annyang-loaded", this._annyangLoaded.bind(this), {
  ...
  setToast(text, alwaysvisible = false, awaitingInput = true) {
    ...
    globalThis.dispatchEvent(new CustomEvent("super-daemon-toast-show", {
      bubbles: true,
      composed: true,
      cancelable: true,
      detail: {
