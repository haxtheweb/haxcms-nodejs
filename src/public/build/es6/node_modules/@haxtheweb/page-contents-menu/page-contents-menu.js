...
class PageContentsMenu extends DDD {
  ...
  updated(changedProperties) {
    ...
    changedProperties.forEach((oldValue, propName) => {
      ...
      if (propName == "mobile") {
        if (this[propName]) {
          import("../simple-popover/simple-popover.js").then(module => {
            setTimeout(() => {
  ...
  updateMenu() {
    ...
    for (var i = 0; i < this.contentContainer.childNodes.length; i++) {
      ...
      if (typeof item.tagName !== typeof undefined && validTags.includes(item.tagName.toLowerCase())) {
        ...
        let reference = {
          title: title,
          link: item.id ? globalThis.document.location.pathname + "#" + item.id : null,
          id: item.id,
  ...
  scrollFinished() {
    if (this.items) {
      ...
      // viewport height
      let browserViewport = globalThis.innerHeight || globalThis.document.documentElement.clientHeight;
