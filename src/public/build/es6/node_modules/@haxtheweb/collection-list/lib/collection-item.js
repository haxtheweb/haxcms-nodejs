...
import { DDDFontSizing, DDDLineHeight } from "../../d-d-d/lib/DDDStyles.js";
class CollectionItem extends DDD {
  ...
  static get styles() {
    return [super.styles, DDDFontSizing, DDDLineHeight, css`
        :host {
          display: block;
  ...
  render() {
    return html`
      ...
      >
        <div class="wrap">
          ${this.tags ? html`<simple-tags
                tags="${this.tags}"
                accent-color="${this.accentColor}"
                auto-accent-color
              ></simple-tags>` : html`<div class="no-tags"></div>`}
          <div
          ...
          ${this.icon ? html`<div class="icon">
                <simple-icon
                  ...
                  accent-color="${this.accentColor}"
                ></simple-icon>
              </div>` : html`<div class="no-icon"></div>`}
          <div><slot></slot></div>
  ...
  _handleClick(e) {
    if (this._haxstate || this.parentNode && this.parentNode.getAttribute("lock-items") !== null) {
      e.preventDefault();
      e.stopPropagation();
