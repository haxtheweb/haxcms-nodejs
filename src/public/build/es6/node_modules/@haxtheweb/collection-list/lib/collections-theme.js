...
import "../../haxcms-elements/lib/ui-components/navigation/site-top-menu.js";
 ...
 */
class CollectionsTheme extends HAXCMSOperationButtons(HAXCMSRememberRoute(PDFPageMixin(PrintBranchMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(DDDSuper(HAXCMSLitElementTheme)))))))) {
  ...
  firstUpdated(changedProperties) {
    ...
    this.HAXCMSThemeSettings.scrollTarget = this.shadowRoot.querySelector("#contentcontainer");
  ...
  constructor() {
    ...
    autorun(() => {
      ...
      if (badDevice === false) {
        ...
        link.setAttribute("href", "https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400&display=swap");
