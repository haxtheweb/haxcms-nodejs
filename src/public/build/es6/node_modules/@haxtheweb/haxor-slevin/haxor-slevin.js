...
import "../disqus-embed/lib/haxcms-site-disqus.js";
...
import "../full-width-image/full-width-image.js";
import "../haxcms-elements/lib/ui-components/query/site-query.js";
import "../date-card/lib/date-chip.js";
 ...
 */
class HaxorSlevin extends HAXCMSThemeParts(SimpleColorsSuper(DDDSuper(HAXCMSLitElementTheme))) {
  static get styles() {
      ...
      <div class="wrapper">
        <div id="home">
          <site-query
            ...
            sort='{"created": "ASC"}'
          ></site-query>
          ${this.__mainPosts.map(post => html` <a class="article-link" href="${post.slug}">
                <accent-card
                  image-align="center"
                  image-valign="top"
                  accent-background
        ...
        <main class="contentcontainer-wrapper">
          <article id="contentcontainer">
            ...
            ${this.activeItem && this.activeItem.metadata && this.activeItem.metadata.image ? html`<full-width-image
                  source="${this.activeItem.metadata.image}"
                  caption="${this.activeItem.title}"
                ></full-width-image>` : html`<site-active-title></site-active-title>`}
  ...
  siteModalClick(e) {
    // prettier-ignore
    import("../haxcms-elements/lib/ui-components/site/site-search.js");
  }
  constructor() {
    super();
    // to avoid error
  ...
  firstUpdated(changedProperties) {
    ...
    // prettier-ignore
    import("../haxcms-elements/lib/ui-components/active-item/site-share-widget.js");
    // prettier-ignore
    ...
    import("../social-share-link/social-share-link.js");
    // prettier-ignore
