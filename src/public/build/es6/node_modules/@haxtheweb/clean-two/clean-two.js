...
import "../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";
 ...
 * @element clean-two
 */
class CleanTwo extends LTIResizingMixin(HAXCMSOperationButtons(HAXCMSRememberRoute(EmailPageMixin(PDFPageMixin(PrintBranchMixin(QRCodeMixin(HAXCMSThemeParts(HAXCMSMobileMenuMixin(DDDSuper(HAXCMSLitElementTheme)))))))))) {
  //styles function
  static get styles() {
  ...
  firstUpdated(changedProperties) {
    ...
    this.HAXCMSThemeSettings.siteMenuContent = this.shadowRoot.querySelector(".body-wrapper");
    this.HAXCMSThemeSettings.scrollTarget = this.shadowRoot.querySelector(".content-wrapper");
  ...
  searchChanged(e) {
    ...
    if (target.value) {
      // prettier-ignore
      import("../haxcms-elements/lib/ui-components/site/site-search.js").then(() => {
      ...
      <div class="body-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <header class="header">
              ${!["xl"].includes(this.responsiveSize) ? html`
              ...
              ${MicroFrontendRegistry.has("@core/htmlToPdf") ? this.PDFPageButton() : ``}
