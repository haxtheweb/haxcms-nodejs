...
const si = {
  ...
  patchDirectiveResolve: (e, t) => {
    if (e.prototype._$AS !== t) {
      ...
      for (let r = e.prototype; r !== Object.prototype; r = Object.getPrototypeOf(r)) if (r.hasOwnProperty(Me)) return void (r[Me] = t);
  ...
  getAttributePartCommittedValue: (e, t, r) => {
    let i = R;
    return e.j = e => i = e, e._$AI(t, e, r), i;
  },
  connectedDisconnectable: e => ({
    ...e,
    _$AU: !0
  }),
  resolveDirective: X.V,
  AttributePart: X.H,
  PropertyPart: X.B,
  BooleanAttributePart: X.N,
  EventPart: X.U,
  ElementPart: X.F,
  TemplateInstance: X.R,
  isIterable: X.D,
  ChildPart: X.I
};
export { si as _$LH };