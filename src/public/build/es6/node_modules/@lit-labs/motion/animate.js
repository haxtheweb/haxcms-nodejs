...
import { directive as i, PartType as s } from "../../lit/directive.js";
import { AsyncDirective as e } from "../../lit/async-directive.js";
import { controllerMap as h } from "./animate-controller.js";
...
class x extends e {
  constructor(t) {
    if (super(t), this.t = !1, this.i = null, this.o = null, this.h = !0, this.shouldLog = !1, t.type === s.CHILD) throw Error("The `animate` directive must be used in attribute position.");
    this.createFinished();
  }
  createFinished() {
...
const F = i(x);
export { x as Animate, F as animate, a as animationFrame, b as defaultCssProperties, A as defaultKeyframeOptions, p as fade, v as fadeIn, y as fadeInSlow, f as fadeOut, l as flyAbove, c as flyBelow, d as flyLeft, u as flyRight, m as none, N as transformProps };