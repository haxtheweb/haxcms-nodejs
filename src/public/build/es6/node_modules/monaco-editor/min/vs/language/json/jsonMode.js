...
define("vs/language/json/jsonMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var En = (e, t) => () => (t || e((t = {
      ...
      _n = (e, t) => {
        for (var i in t) X(e, i, {
          get: t[i],
          enumerable: !0
        });
      },
      Y = (e, t, i, r) => {
        if (t && typeof t == "object" || typeof t == "function") for (let n of Cn(t)) !In.call(e, n) && (i || n !== "default") && X(e, n, {
          get: () => t[n],
          enumerable: !(r = bn(t, n)) || r.enumerable
        });
        return e;
      },
      be = (e, t) => Y(Te(X(e != null ? Tn(wn(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      An = (e => (t, i) => e && e.get(t) || (i = Y(Te({}), t, 1), e && e.set(t, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var we = En((gr, Ce) => {
    ...
    (function (e) {
      function t(r, n) {
        return r === Number.MAX_VALUE && (r = G.MAX_VALUE), n === Number.MAX_VALUE && (n = G.MAX_VALUE), {
          line: r,
          character: n
        };
      }
    ...
    (function (e) {
      function t(r, n, a, o) {
        if (s.uinteger(r) && s.uinteger(n) && s.uinteger(a) && s.uinteger(o)) return {
          start: _.create(r, n),
          end: _.create(a, o)
        };
        if (_.is(r) && _.is(n)) return {
          start: r,
          end: n
        };
    ...
    (function (e) {
      ...
      function i(r) {
        var n = r;
        return s.string(n.label) && (s.undefined(n.textEdit) || P.is(n)) && (s.undefined(n.additionalTextEdits) || s.typedArray(n.additionalTextEdits, P.is));
      }
      e.is = i;
    })(_e || (_e = {}));
    var D;
    ...
    (function (e) {
      function t(r, n, a, o, u, c) {
        ...
        return s.defined(a) && (h.severity = a), s.defined(o) && (h.code = o), s.defined(u) && (h.source = u), s.defined(c) && (h.relatedInformation = c), h;
      }
      e.create = t;
      function i(r) {
        var n,
    ...
    var $ = function () {
        ...
        return e.prototype.insert = function (t, i, r) {
          var n, a;
          if (r === void 0 ? n = P.insert(t, i) : T.is(r) ? (a = r, n = A.insert(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), n = A.insert(t, i, a)), this.edits.push(n), a !== void 0) return a;
        }, e.prototype.replace = function (t, i, r) {
          var n, a;
          if (r === void 0 ? n = P.replace(t, i) : T.is(r) ? (a = r, n = A.replace(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), n = A.replace(t, i, a)), this.edits.push(n), a !== void 0) return a;
        }, e.prototype.delete = function (t, i) {
          var r, n;
          if (i === void 0 ? r = P.del(t) : T.is(i) ? (n = i, r = A.del(t, i)) : (this.assertChangeAnnotations(this.changeAnnotations), n = this.changeAnnotations.manage(i), r = A.del(t, n)), this.edits.push(r), n !== void 0) return n;
      ...
      yr = function () {
        function e(t) {
          var i = this;
          this._textEditChanges = Object.create(null), t !== void 0 ? (this._workspaceEdit = t, t.documentChanges ? (this._changeAnnotations = new Le(t.changeAnnotations), t.changeAnnotations = this._changeAnnotations.all(), t.documentChanges.forEach(function (r) {
            if (Z.is(r)) {
        ...
        return Object.defineProperty(e.prototype, "edit", {
          ...
          if (ee.is(t)) {
            ...
            if (!r) {
              ...
              this._workspaceEdit.documentChanges.push(a), r = new $(n, this._changeAnnotations), this._textEditChanges[i.uri] = r;
            }
            return r;
          } else {
            ...
            if (!r) {
              var n = [];
              this._workspaceEdit.changes[t] = n, r = new $(n), this._textEditChanges[t] = r;
            }
            return r;
          }
        }, e.prototype.initDocumentChanges = function () {
          this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new Le(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
          ...
          var a, o;
          if (n === void 0 ? a = H.create(t, r) : (o = T.is(n) ? n : this._changeAnnotations.manage(n), a = H.create(t, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
        }, e.prototype.renameFile = function (t, i, r, n) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var a;
          W.is(r) || T.is(r) ? a = r : n = r;
          var o, u;
          if (a === void 0 ? o = J.create(t, i, n) : (u = T.is(a) ? a : this._changeAnnotations.manage(a), o = J.create(t, i, n, u)), this._workspaceEdit.documentChanges.push(o), u !== void 0) return u;
        }, e.prototype.deleteFile = function (t, i, r) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var n;
          W.is(i) || T.is(i) ? n = i : r = i;
          var a, o;
          if (n === void 0 ? a = B.create(t, r) : (o = T.is(n) ? n : this._changeAnnotations.manage(n), a = B.create(t, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
        }, e;
      }();
    var Oe;
    (function (e) {
    ...
    (function (e) {
      function t(i) {
        var r = i;
        return !!r && s.objectLiteral(r) && (ve.is(r.contents) || re.is(r.contents) || s.typedArray(r.contents, re.is)) && (i.range === void 0 || k.is(i.range));
      }
      e.is = t;
    })(Ue || (Ue = {}));
    var Ve;
    ...
    (function (e) {
      ...
      function i(r) {
        var n = r;
        return s.defined(n) && s.typedArray(n.diagnostics, Q.is) && (n.only === void 0 || s.typedArray(n.only, s.string));
      }
      e.is = i;
    })(Xe || (Xe = {}));
    var Ye;
    (function (e) {
      function t(r, n, a) {
        var o = {
          ...
          u = !0;
        return typeof n == "string" ? (u = !1, o.kind = n) : K.is(n) ? o.command = n : o.edit = n, u && a !== void 0 && (o.kind = a), o;
      }
      e.create = t;
      function i(r) {
        var n = r;
        return n && s.string(n.title) && (n.diagnostics === void 0 || s.typedArray(n.diagnostics, Q.is)) && (n.kind === void 0 || s.string(n.kind)) && (n.edit !== void 0 || n.command !== void 0) && (n.command === void 0 || K.is(n.command)) && (n.isPreferred === void 0 || s.boolean(n.isPreferred)) && (n.edit === void 0 || me.is(n.edit));
      }
      e.is = i;
    })(Ye || (Ye = {}));
    var $e;
    ...
    (function (e) {
      ...
      function r(a, o) {
        for (var u = a.getText(), c = n(o, function (E, R) {
            ...
            return U === 0 ? E.range.start.character - R.range.start.character : U;
          }), h = u.length, p = c.length - 1; p >= 0; p--) {
          var d = c[p],
            b = a.offsetAt(d.range.start),
            g = a.offsetAt(d.range.end);
          if (g <= h) u = u.substring(0, b) + d.newText + u.substring(g, u.length);else throw new Error("Overlapping edit");
          h = b;
        }
        return u;
      }
    ...
    var Ln = function () {
        function e(t, i, r, n) {
          this._uri = t, this._languageId = i, this._version = r, this._content = n, this._lineOffsets = void 0;
        }
...
` && n++;
    ...
    var te = class {
      constructor(t, i, r) {
        ...
        this._disposables.push(l.editor.onDidCreateModel(n)), this._disposables.push(l.editor.onWillDisposeModel(a)), this._disposables.push(l.editor.onDidChangeModelLanguage(o => {
          a(o.model), n(o.model);
    ...
    var ie = class {
      ...
      provideCompletionItems(t, i, r, n) {
        let a = t.uri;
        return this._worker(a).then(o => o.doComplete(a.toString(), S(i))).then(o => {
          if (!o) return;
          let u = t.getWordUntilPosition(i),
            ...
            h = o.items.map(p => {
              ...
              return p.textEdit && (Dn(p.textEdit) ? d.range = {
                insert: C(p.textEdit.insert),
                replace: C(p.textEdit.replace)
              } : d.range = C(p.textEdit.range), d.insertText = p.textEdit.newText), p.additionalTextEdits && (d.additionalTextEdits = p.additionalTextEdits.map(M)), p.insertTextFormat === ne.Snippet && (d.insertTextRules = l.languages.CompletionItemInsertTextRule.InsertAsSnippet), d;
            });
          return {
    ...
    var ae = class {
      ...
      provideHover(t, i, r) {
        let n = t.uri;
        return this._worker(n).then(a => a.doHover(n.toString(), S(i))).then(a => {
          if (!!a) return {
            range: C(a.range),
...
` + e.value + "\n```\n"
    ...
    var rn = class {
      ...
      provideDocumentHighlights(t, i, r) {
        let n = t.uri;
        return this._worker(n).then(a => a.findDocumentHighlights(n.toString(), S(i))).then(a => {
          if (!!a) return a.map(o => ({
            range: C(o.range),
            kind: Un(o.kind)
          }));
    ...
    var tn = class {
      ...
      provideDefinition(t, i, r) {
        let n = t.uri;
        return this._worker(n).then(a => a.findDefinition(n.toString(), S(i))).then(a => {
          if (!!a) return [an(a)];
        });
      }
    };
    ...
    var on = class {
        ...
        provideReferences(t, i, r, n) {
          let a = t.uri;
          return this._worker(a).then(o => o.findReferences(a.toString(), S(i))).then(o => {
      ...
      sn = class {
        ...
        provideRenameEdits(t, i, r, n) {
          let a = t.uri;
          return this._worker(a).then(o => o.doRename(a.toString(), S(i), r)).then(o => Vn(o));
        }
      };
    function Vn(e) {
      ...
      for (let i in e.changes) {
        let r = l.Uri.parse(i);
        for (let n of e.changes[i]) t.push({
          resource: r,
          edit: {
            range: C(n.range),
            text: n.newText
    ...
    var un = class {
      ...
      se = class {
        ...
        provideDocumentFormattingEdits(t, i, r) {
          let n = t.uri;
          return this._worker(n).then(a => a.format(n.toString(), null, cn(i)).then(o => {
      ...
      ue = class {
        ...
        provideDocumentRangeFormattingEdits(t, i, r, n) {
          let a = t.uri;
          return this._worker(a).then(o => o.format(a.toString(), ke(i), cn(r)).then(u => {
    ...
    var ce = class {
        ...
        provideColorPresentations(t, i, r) {
          let n = t.uri;
          return this._worker(n).then(a => a.getColorPresentations(n.toString(), i.color, ke(i.range))).then(a => {
            if (!!a) return a.map(o => {
              let u = {
                label: o.label
              };
              return o.textEdit && (u.textEdit = M(o.textEdit)), o.additionalTextEdits && (u.additionalTextEdits = o.additionalTextEdits.map(M)), u;
            });
          });
        }
      },
    ...
    var de = class {
      ...
      provideSelectionRanges(t, i, r) {
        let n = t.uri;
        return this._worker(n).then(a => a.getSelectionRanges(n.toString(), i.map(S))).then(a => {
          if (!!a) return a.map(o => {
            let u = [];
            for (; o;) u.push({
              range: C(o.range)
    ...
    function fe(e, t) {
      ...
      function b(f, w) {
        for (var x = 0, I = 0; x < f || !w;) {
          ...
          if (y >= 48 && y <= 57) I = I * 16 + y - 48;else if (y >= 65 && y <= 70) I = I * 16 + y - 65 + 10;else if (y >= 97 && y <= 102) I = I * 16 + y - 97 + 10;else break;
          r++, x++;
        }
        return x < f && (I = -1), I;
      }
      ...
      function E() {
        var f = r;
        if (e.charCodeAt(r) === 48) r++;else for (r++; r < e.length && F(e.charCodeAt(r));) r++;
        if (r < e.length && e.charCodeAt(r) === 46) if (r++, r < e.length && F(e.charCodeAt(r))) for (r++; r < e.length && F(e.charCodeAt(r));) r++;else return d = 3, e.substring(f, r);
        var w = r;
        if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101)) if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && F(e.charCodeAt(r))) {
...
`;
      ...
      function U() {
        if (n = "", d = 0, a = r, c = u, p = h, r >= i) return a = i, o = 17;
        var f = e.charCodeAt(r);
        if (ye(f)) {
          do r++, n += String.fromCharCode(f), f = e.charCodeAt(r); while (ye(f));
          return o = 15;
        }
        if (q(f)) return r++, n += String.fromCharCode(f), f === 13 && e.charCodeAt(r) === 10 && (r++, n += `
`), u++, h = r, o = 14;
        switch (f) {
          case 123:
            return r++, o = 1;
          ...
          case 47:
            ...
            if (e.charCodeAt(r + 1) === 42) {
              ...
              for (var x = i - 1, I = !1; r < x;) {
                ...
                r++, q(y) && (y === 13 && e.charCodeAt(r) === 10 && r++, u++, h = r);
              }
              return I || (r++, d = 1), n = e.substring(w, r), o = 13;
            }
            return n += String.fromCharCode(f), r++, o = 16;
          case 45:
            if (n += String.fromCharCode(f), r++, r === i || !F(e.charCodeAt(r))) return o = 16;
          case 48:
          case 49:
          case 50:
          case 51:
    ...
    var L = class {
      ...
      j = class {
        ...
        clone() {
          return new j(this._state, this.scanError, this.lastWasColon, this.parents);
        }
        equals(t) {
          return t === this ? !0 : !t || !(t instanceof j) ? !1 : this.scanError === t.scanError && this.lastWasColon === t.lastWasColon && L.equals(this.parents, t.parents);
        }
        getStateData() {
          return this._state;
        }
    ...
    function ur(e, t, i, r = 0) {
      ...
      for (;;) {
        let p = r + o.getPosition(),
          ...
          b = o.scan();
        if (b === 17) break;
        if (p === r + o.getPosition()) throw new Error("Scanner did not advance, next 3 characters are: " + t.substr(o.getPosition(), 3));
        ...
        h.endState = new j(i.getStateData(), o.getTokenError(), u, c), h.tokens.push({
          startIndex: p,
          scopes: d
        });
      }
