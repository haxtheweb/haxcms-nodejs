...
define("vs/language/html/htmlWorker", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var Cn = t => Je(t, "__esModule", {
      value: !0
    });
    var Ln = (t, i) => {
        for (var o in i) Je(t, o, {
          get: i[o],
          enumerable: !0
        });
      },
      Mn = (t, i, o, n) => {
        if (i && typeof i == "object" || typeof i == "function") for (let e of Dn(i)) !En.call(t, e) && (o || e !== "default") && Je(t, e, {
          get: () => i[e],
          enumerable: !(n = xn(i, e)) || n.enumerable
        });
        return t;
      };
    var Rn = (t => (i, o) => t && t.get(i) || (o = Mn(Cn({}), i, 1), t && t.set(i, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var zi = {};
    Ln(zi, {
      HTMLWorker: () => bt,
      create: () => Ri
    ...
    function zn(t, i) {
      let o;
      return i.length === 0 ? o = t : o = t.replace(/\{(\d+)\}/g, (n, e) => {
        let a = e[0];
    ...
    (function (t) {
      function i(n, e) {
        return n === Number.MAX_VALUE && (n = Ue.MAX_VALUE), e === Number.MAX_VALUE && (e = Ue.MAX_VALUE), {
          line: n,
          character: e
        };
      }
    ...
    (function (t) {
      function i(n, e, a, c) {
        if (_.uinteger(n) && _.uinteger(e) && _.uinteger(a) && _.uinteger(c)) return {
          start: X.create(n, e),
          end: X.create(a, c)
        };
        if (X.is(n) && X.is(e)) return {
          start: n,
          end: e
        };
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return _.defined(e) && P.is(e.targetRange) && _.string(e.targetUri) && (P.is(e.targetSelectionRange) || _.undefined(e.targetSelectionRange)) && (P.is(e.originSelectionRange) || _.undefined(e.originSelectionRange));
      }
      t.is = o;
    })(Tt || (Tt = {}));
    var We;
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return _.numberRange(e.red, 0, 1) && _.numberRange(e.green, 0, 1) && _.numberRange(e.blue, 0, 1) && _.numberRange(e.alpha, 0, 1);
      }
      t.is = o;
    })(We || (We = {}));
    var Ye;
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return _.string(e.label) && (_.undefined(e.textEdit) || Y.is(e)) && (_.undefined(e.additionalTextEdits) || _.typedArray(e.additionalTextEdits, Y.is));
      }
      t.is = o;
    })($e || ($e = {}));
    var we;
    ...
    (function (t) {
      function i(n, e, a, c, l) {
        ...
        return _.defined(a) && (r.startCharacter = a), _.defined(c) && (r.endCharacter = c), _.defined(l) && (r.kind = l), r;
      }
      t.create = i;
      function o(n) {
        var e = n;
        return _.uinteger(e.startLine) && _.uinteger(e.startLine) && (_.undefined(e.startCharacter) || _.uinteger(e.startCharacter)) && (_.undefined(e.endCharacter) || _.uinteger(e.endCharacter)) && (_.undefined(e.kind) || _.string(e.kind));
      }
      t.is = o;
    })(Qe || (Qe = {}));
    var Ze;
    ...
    (function (t) {
      function i(n, e, a, c, l, r) {
        ...
        return _.defined(a) && (s.severity = a), _.defined(c) && (s.code = c), _.defined(l) && (s.source = l), _.defined(r) && (s.relatedInformation = r), s;
      }
      t.create = i;
      function o(n) {
        var e,
          a = n;
        return _.defined(a) && P.is(a.range) && _.string(a.message) && (_.number(a.severity) || _.undefined(a.severity)) && (_.integer(a.code) || _.string(a.code) || _.undefined(a.code)) && (_.undefined(a.codeDescription) || _.string((e = a.codeDescription) === null || e === void 0 ? void 0 : e.href)) && (_.string(a.source) || _.undefined(a.source)) && (_.undefined(a.relatedInformation) || _.typedArray(a.relatedInformation, Ze.is));
      }
      t.is = o;
    })(xe || (xe = {}));
    var _e;
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return e !== void 0 && _.objectLiteral(e) && _.string(e.label) && (_.boolean(e.needsConfirmation) || e.needsConfirmation === void 0) && (_.string(e.description) || e.description === void 0);
      }
      t.is = o;
    })(be || (be = {}));
    var Z;
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return e && e.kind === "create" && _.string(e.uri) && (e.options === void 0 || (e.options.overwrite === void 0 || _.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || _.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
      }
      t.is = o;
    })(De || (De = {}));
    var Ee;
    (function (t) {
      function i(n, e, a, c) {
        ...
        return a !== void 0 && (a.overwrite !== void 0 || a.ignoreIfExists !== void 0) && (l.options = a), c !== void 0 && (l.annotationId = c), l;
      }
      t.create = i;
      function o(n) {
        var e = n;
        return e && e.kind === "rename" && _.string(e.oldUri) && _.string(e.newUri) && (e.options === void 0 || (e.options.overwrite === void 0 || _.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || _.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
      }
      t.is = o;
    })(Ee || (Ee = {}));
    var Ce;
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return e && e.kind === "delete" && _.string(e.uri) && (e.options === void 0 || (e.options.recursive === void 0 || _.boolean(e.options.recursive)) && (e.options.ignoreIfNotExists === void 0 || _.boolean(e.options.ignoreIfNotExists))) && (e.annotationId === void 0 || Z.is(e.annotationId));
      }
      t.is = o;
    })(Ce || (Ce = {}));
    var Fe;
    (function (t) {
      function i(o) {
        var n = o;
        return n && (n.changes !== void 0 || n.documentChanges !== void 0) && (n.documentChanges === void 0 || n.documentChanges.every(function (e) {
    ...
    var Ie = function () {
        ...
        return t.prototype.insert = function (i, o, n) {
          var e, a;
          if (n === void 0 ? e = Y.insert(i, o) : Z.is(n) ? (a = n, e = ce.insert(i, o, n)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(n), e = ce.insert(i, o, a)), this.edits.push(e), a !== void 0) return a;
        }, t.prototype.replace = function (i, o, n) {
          var e, a;
          if (n === void 0 ? e = Y.replace(i, o) : Z.is(n) ? (a = n, e = ce.replace(i, o, n)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(n), e = ce.replace(i, o, a)), this.edits.push(e), a !== void 0) return a;
        }, t.prototype.delete = function (i, o) {
          var n, e;
          if (o === void 0 ? n = Y.del(i) : Z.is(o) ? (e = o, n = ce.del(i, o)) : (this.assertChangeAnnotations(this.changeAnnotations), e = this.changeAnnotations.manage(o), n = ce.del(i, e)), this.edits.push(n), e !== void 0) return e;
      ...
      xt = function () {
        ...
        return t.prototype.all = function () {
          ...
          var n;
          if (Z.is(i) ? n = i : (n = this.nextId(), o = i), this._annotations[n] !== void 0) throw new Error("Id " + n + " is already in use.");
      ...
      Ii = function () {
        function t(i) {
          var o = this;
          this._textEditChanges = Object.create(null), i !== void 0 ? (this._workspaceEdit = i, i.documentChanges ? (this._changeAnnotations = new xt(i.changeAnnotations), i.changeAnnotations = this._changeAnnotations.all(), i.documentChanges.forEach(function (n) {
            if (Be.is(n)) {
              var e = new Ie(n.edits, o._changeAnnotations);
              o._textEditChanges[n.textDocument.uri] = e;
            }
          })) : i.changes && Object.keys(i.changes).forEach(function (n) {
        ...
        return Object.defineProperty(t.prototype, "edit", {
          ...
          if (Pe.is(i)) {
            ...
            if (!n) {
              ...
              this._workspaceEdit.documentChanges.push(a), n = new Ie(e, this._changeAnnotations), this._textEditChanges[o.uri] = n;
            }
            return n;
          } else {
            ...
            if (!n) {
              var e = [];
              this._workspaceEdit.changes[i] = e, n = new Ie(e), this._textEditChanges[i] = n;
            }
            return n;
          }
        }, t.prototype.initDocumentChanges = function () {
          this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new xt(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
          ...
          var a, c;
          if (e === void 0 ? a = De.create(i, n) : (c = Z.is(e) ? e : this._changeAnnotations.manage(e), a = De.create(i, n, c)), this._workspaceEdit.documentChanges.push(a), c !== void 0) return c;
        }, t.prototype.renameFile = function (i, o, n, e) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var a;
          be.is(n) || Z.is(n) ? a = n : e = n;
          var c, l;
          if (a === void 0 ? c = Ee.create(i, o, e) : (l = Z.is(a) ? a : this._changeAnnotations.manage(a), c = Ee.create(i, o, e, l)), this._workspaceEdit.documentChanges.push(c), l !== void 0) return l;
        }, t.prototype.deleteFile = function (i, o, n) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var e;
          be.is(o) || Z.is(o) ? e = o : n = o;
          var a, c;
          if (e === void 0 ? a = Ce.create(i, n) : (c = Z.is(e) ? e : this._changeAnnotations.manage(e), a = Ce.create(i, n, c)), this._workspaceEdit.documentChanges.push(a), c !== void 0) return c;
        }, t;
      }();
    var Dt;
    (function (t) {
    ...
    (function (t) {
      function i(o) {
        var n = o;
        return !!n && _.objectLiteral(n) && (Ne.is(n.contents) || Le.is(n.contents) || _.typedArray(n.contents, Le.is)) && (o.range === void 0 || P.is(o.range));
      }
      t.is = i;
    })(rt || (rt = {}));
    var Lt;
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return e && _.string(e.name) && _.number(e.kind) && P.is(e.range) && P.is(e.selectionRange) && (e.detail === void 0 || _.string(e.detail)) && (e.deprecated === void 0 || _.boolean(e.deprecated)) && (e.children === void 0 || Array.isArray(e.children)) && (e.tags === void 0 || Array.isArray(e.tags));
      }
      t.is = o;
    })(zt || (zt = {}));
    var Ht;
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return _.defined(e) && _.typedArray(e.diagnostics, xe.is) && (e.only === void 0 || _.typedArray(e.only, _.string));
      }
      t.is = o;
    })(It || (It = {}));
    var Ut;
    (function (t) {
      function i(n, e, a) {
        var c = {
          ...
          l = !0;
        return typeof e == "string" ? (l = !1, c.kind = e) : _e.is(e) ? c.command = e : c.edit = e, l && a !== void 0 && (c.kind = a), c;
      }
      t.create = i;
      function o(n) {
        var e = n;
        return e && _.string(e.title) && (e.diagnostics === void 0 || _.typedArray(e.diagnostics, xe.is)) && (e.kind === void 0 || _.string(e.kind)) && (e.edit !== void 0 || e.command !== void 0) && (e.command === void 0 || _e.is(e.command)) && (e.isPreferred === void 0 || _.boolean(e.isPreferred)) && (e.edit === void 0 || Fe.is(e.edit));
      }
      t.is = o;
    })(Ut || (Ut = {}));
    var Wt;
    ...
    (function (t) {
      ...
      function o(a) {
        var c = a;
        return !!(_.defined(c) && _.string(c.uri) && (_.undefined(c.languageId) || _.string(c.languageId)) && _.uinteger(c.lineCount) && _.func(c.getText) && _.func(c.positionAt) && _.func(c.offsetAt));
      }
      t.is = o;
      function n(a, c) {
        for (var l = a.getText(), r = e(c, function (y, m) {
            var A = y.range.start.line - m.range.start.line;
            return A === 0 ? y.range.start.character - m.range.start.character : A;
          }), s = l.length, u = r.length - 1; u >= 0; u--) {
          var h = r[u],
            d = a.offsetAt(h.range.start),
            g = a.offsetAt(h.range.end);
          if (g <= s) l = l.substring(0, d) + h.newText + l.substring(g, l.length);else throw new Error("Overlapping edit");
          s = d;
        }
        return l;
      }
    ...
    var In = function () {
        function t(i, o, n, e) {
          this._uri = i, this._languageId = o, this._version = n, this._content = e, this._lineOffsets = void 0;
        }
...
` && e++;
    ...
    var ke = class {
        ...
        update(i, o) {
          for (let n of i) if (ke.isIncremental(n)) {
            let e = Pt(n.range),
            ...
            let l = Math.max(e.start.line, 0),
              ...
              s = this._lineOffsets,
              u = Ft(n.text, !1, a);
            if (r - l === u.length) for (let d = 0, g = u.length; d < g; d++) s[d + l + 1] = u[d];else u.length < 1e4 ? s.splice(l + 1, r - l, ...u) : this._lineOffsets = s = s.slice(0, l + 1).concat(u, s.slice(r + 1));
            let h = n.text.length - (c - a);
            if (h !== 0) for (let d = l + 1 + u.length, g = s.length; d < g; d++) s[d] = s[d] + h;
          } else if (ke.isFull(n)) this._content = n.text, this._lineOffsets = void 0;else throw new Error("Unknown change event received");
          this._version = o;
        }
        getLineOffsets() {
    ...
    function Ft(t, i, o = 0) {
      ...
      for (let e = 0; e < t.length; e++) {
        ...
        (a === 13 || a === 10) && (a === 13 && e + 1 < t.length && t.charCodeAt(e + 1) === 10 && e++, n.push(o + e + 1));
      }
      return n;
    }
    function Pt(t) {
    ...
    var he = ge(),
      Wn = function () {
        ...
        return t.prototype.eos = function () {
          ...
          for (var o = this.position; this.position < this.len && i(this.source.charCodeAt(this.position));) this.position++;
...
`.charCodeAt(0),
    ...
    function $(t, i, o, n) {
      ...
      function A() {
        var w = e.pos(),
          M = a,
          B = E();
        return B !== S.EOS && w === e.pos() && !(n && (B === S.StartTagClose || B === S.EndTagClose)) ? (console.log("Scanner.scan has not advanced at offset " + w + ", state before: " + M + " after: " + a), e.advance(1), m(w, S.Unknown)) : B;
      }
      function E() {
        var w = e.pos();
        ...
        switch (a) {
          case W.WithinComment:
            return e.advanceIfChars([Se, Se, se]) ? (a = W.WithinContent, m(w, S.EndCommentTag)) : (e.advanceUntilChars([Se, Se, se]), m(w, S.Comment));
          case W.WithinDoctype:
            return e.advanceIfChar(se) ? (a = W.WithinContent, m(w, S.EndDoctypeTag)) : (e.advanceUntilChar(se), m(w, S.Doctype));
          case W.WithinContent:
            if (e.advanceIfChar(qe)) {
              if (!e.eos() && e.peekChar() === Ot) {
                if (e.advanceIfChars([Ot, Se, Se])) return a = W.WithinComment, m(w, S.StartCommentTag);
                if (e.advanceIfRegExp(/^!doctype/i)) return a = W.WithinDoctype, m(w, S.StartDoctypeTag);
              }
              return e.advanceIfChar(ct) ? (a = W.AfterOpeningEndTag, m(w, S.EndTagOpen)) : (a = W.AfterOpeningStartTag, m(w, S.StartTagOpen));
            }
            return e.advanceUntilChar(qe), m(w, S.Content);
          case W.AfterOpeningEndTag:
            var B = g();
            return B.length > 0 ? (a = W.WithinEndTag, m(w, S.EndTag)) : e.skipWhitespace() ? m(w, S.Whitespace, he("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = W.WithinEndTag, e.advanceUntilChar(se), w < e.pos() ? m(w, S.Unknown, he("error.endTagNameExpected", "End tag name expected.")) : E());
          case W.WithinEndTag:
            if (e.skipWhitespace()) return m(w, S.Whitespace);
            if (e.advanceIfChar(se)) return a = W.WithinContent, m(w, S.EndTagClose);
            if (n && e.peekChar() === qe) return a = W.WithinContent, m(w, S.EndTagClose, he("error.closingBracketMissing", "Closing bracket missing."));
            M = he("error.closingBracketExpected", "Closing bracket expected.");
            break;
          case W.AfterOpeningStartTag:
            return u = g(), d = void 0, h = void 0, u.length > 0 ? (s = !1, a = W.WithinTag, m(w, S.StartTag)) : e.skipWhitespace() ? m(w, S.Whitespace, he("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = W.WithinTag, e.advanceUntilChar(se), w < e.pos() ? m(w, S.Unknown, he("error.startTagNameExpected", "Start tag name expected.")) : E());
          case W.WithinTag:
            return e.skipWhitespace() ? (s = !0, m(w, S.Whitespace)) : s && (h = y(), h.length > 0) ? (a = W.AfterAttributeName, s = !1, m(w, S.AttributeName)) : e.advanceIfChars([ct, se]) ? (a = W.WithinContent, m(w, S.StartTagSelfClose)) : e.advanceIfChar(se) ? (u === "script" ? d && Vn[d] ? a = W.WithinContent : a = W.WithinScriptContent : u === "style" ? a = W.WithinStyleContent : a = W.WithinContent, m(w, S.StartTagClose)) : n && e.peekChar() === qe ? (a = W.WithinContent, m(w, S.StartTagClose, he("error.closingBracketMissing", "Closing bracket missing."))) : (e.advance(1), m(w, S.Unknown, he("error.unexpectedCharacterInTag", "Unexpected character in tag.")));
          case W.AfterAttributeName:
            return e.skipWhitespace() ? (s = !0, m(w, S.Whitespace)) : e.advanceIfChar(Bn) ? (a = W.BeforeAttributeValue, m(w, S.DelimiterAssign)) : (a = W.WithinTag, E());
          case W.BeforeAttributeValue:
            if (e.skipWhitespace()) return m(w, S.Whitespace);
            var G = e.advanceIfRegExp(/^[^\s"'`=<>]+/);
            if (G.length > 0) return e.peekChar() === se && e.peekChar(-1) === ct && (e.goBack(1), G = G.substr(0, G.length - 1)), h === "type" && (d = G), a = W.WithinTag, s = !1, m(w, S.AttributeValue);
            var J = e.peekChar();
            return J === Pn || J === Fn ? (e.advance(1), e.advanceUntilChar(J) && e.advance(1), h === "type" && (d = e.getSource().substring(w + 1, e.pos() - 1)), a = W.WithinTag, s = !1, m(w, S.AttributeValue)) : (a = W.WithinTag, s = !1, E());
          case W.WithinScriptContent:
            for (var f = 1; !e.eos();) {
              var p = e.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
              if (p.length === 0) return e.goToEnd(), m(w, S.Script);
              if (p === "<!--") f === 1 && (f = 2);else if (p === "-->") f = 1;else if (p[1] !== "/") f === 2 && (f = 3);else if (f === 3) f = 2;else {
                e.goBack(p.length);
                break;
              }
            }
    ...
    function qt(t, i, o) {
      for (var n = 0, e = t.length - 1; n <= e;) {
        var a = (n + e) / 2 | 0,
          c = o(t[a], i);
        if (c < 0) n = a + 1;else if (c > 0) e = a - 1;else return a;
      }
      return -(n + 1);
    }
    var Xn = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"];
    function pe(t) {
      return !!t && qt(Xn, t.toLowerCase(), function (i, o) {
    ...
    var jt = function () {
      ...
      return Object.defineProperty(t.prototype, "attributeNames", {
        ...
        return this.tag === void 0 ? i === void 0 : i !== void 0 && this.tag.length === i.length && this.tag.toLowerCase() === i;
        ...
        var o = ht(this.children, function (a) {
          return i <= a.start;
        }) - 1;
        if (o >= 0) {
        ...
        var o = ht(this.children, function (e) {
          return i <= e.start;
        }) - 1;
        if (o >= 0) {
          var n = this.children[o];
    ...
    function je(t) {
      for (var i = $(t, void 0, void 0, !0), o = new jt(0, t.length, [], void 0), n = o, e = -1, a = void 0, c = null, l = i.scan(); l !== S.EOS;) {
        switch (l) {
          case S.StartTagOpen:
          ...
          case S.StartTagClose:
            n.parent && (n.end = i.getTokenEnd(), i.getTokenLength() ? (n.startTagEnd = i.getTokenEnd(), n.tag && pe(n.tag) && (n.closed = !0, n = n.parent)) : n = n.parent);
            break;
...
`,
    ...
    function fe(t, i) {
      ...
      return Yn <= o && o <= $n || Qn <= o && o <= Zn || Kn <= o && o <= ei;
    }
    function Ae(t) {
      return typeof t < "u";
    }
    ...
    var Ge = function () {
      function t(i, o) {
        var n = this;
        this.id = i, this._tags = [], this._tagMap = {}, this._valueSetMap = {}, this._tags = o.tags || [], this._globalAttributes = o.globalAttributes || [], this._tags.forEach(function (e) {
      ...
      return t.prototype.isApplicable = function () {
        ...
        var a = function (l) {
            l.forEach(function (r) {
              r.name.toLowerCase() === o && (r.values && r.values.forEach(function (s) {
                e.push(s);
              }), r.valueSet && n._valueSetMap[r.valueSet] && n._valueSetMap[r.valueSet].forEach(function (s) {
                e.push(s);
              }));
            });
          },
    ...
    function le(t, i, o) {
      ...
      if (t.references && t.references.length > 0 && i.references !== !1 && (n.value.length && (n.value += `

`), o ? n.value += t.references.map(function (a) {
        return "[" + a.name + "](" + a.url + ")";
      }).join(" | ") : n.value += t.references.map(function (a) {
        return a.name + ": " + a.url;
      }).join(`
`)), n.value !== "") return n;
    }
    var Jt = function (t, i, o, n) {
        function e(a) {
          return a instanceof o ? a : new o(function (c) {
            c(a);
          });
        }
      ...
      Xt = function (t, i) {
        ...
        function r(s) {
          ...
          for (; o;) try {
            if (n = 1, e && (a = s[0] & 2 ? e.return : s[0] ? e.throw || ((a = e.return) && a.call(e), 0) : e.next) && !(a = a.call(e, s[1])).done) return a;
      ...
      Yt = function () {
        ...
        return t.prototype.onHtmlAttributeValue = function (i) {
              ...
              switch (g.label) {
                case 0:
                  n = {
                    items: [],
                    isIncomplete: !1
                  }, e = 0, a = this.atributeCompletions, g.label = 1;
                case 1:
                  return e < a.length ? (c = a[e], l = ii(i.getText(c.range)), ri(l) ? l === "." || l === ".." ? (n.isIncomplete = !0, [3, 4]) : [3, 2] : [3, 4]) : [3, 5];
                case 2:
                  return r = oi(c.value, l, c.range), [4, this.providePathSuggestions(c.value, r, i, o)];
                case 3:
          ...
          return Jt(this, void 0, void 0, function () {
            ...
            return Xt(this, function (m) {
              switch (m.label) {
                case 0:
                  if (a = i.substring(0, i.lastIndexOf("/") + 1), c = e.resolveReference(a || ".", n.uri), !c) return [3, 4];
                  m.label = 1;
                case 1:
                  return m.trys.push([1, 3,, 4]), l = [], [4, this.readDirectory(c)];
                case 2:
                  for (r = m.sent(), s = 0, u = r; s < u.length; s++) h = u[s], d = h[0], g = h[1], d.charCodeAt(0) !== ni && l.push(si(d, g === Oe.Directory, o));
                  return [2, l];
                case 3:
                  return y = m.sent(), [3, 4];
                case 4:
    ...
    var ci = function (t, i, o, n) {
      ...
      Qt = function () {
        ...
        return t.prototype.setCompletionParticipants = function (i) {
          ...
          return ci(this, void 0, void 0, function () {
            ...
            return hi(this, function (u) {
              switch (u.label) {
                case 0:
                  if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory) return [2, this.doComplete(i, o, n, a)];
                  c = new Yt(this.lsOptions.fileSystemProvider.readDirectory), l = this.completionParticipants, this.completionParticipants = [c].concat(l), r = this.doComplete(i, o, n, a), u.label = 1;
                case 1:
          ...
          var d = $(s, h.start),
            ...
            y;
          function m(x, D) {
            return D === void 0 && (D = u), x > u && (x = u), {
              start: i.positionAt(x),
              end: i.positionAt(D)
            };
          }
          function A(x, D) {
          ...
          function E(x) {
            for (var D = x; D > 0;) {
              var L = s.charAt(D - 1);
              if (`
\r`.indexOf(L) >= 0) return s.substring(D, x);
              if (!Ve(L)) return null;
              D--;
            }
          ...
          function w(x, D, L) {
            ...
            return D || l.forEach(function (de) {
          ...
          function G() {
            ...
            return h.attributeNames.forEach(function (D) {
              x[D] = !0;
            }), x;
          }
          function J(x, D) {
            ...
            if (!$t(s, D, W.AfterAttributeName, S.DelimiterAssign)) {
              var K = (L = e == null ? void 0 : e.attributeDefaultValue) !== null && L !== void 0 ? L : "doublequotes";
              K === "empty" ? V = "=$1" : K === "singlequotes" ? V = "='$1'" : V = '="$1"';
            }
            var oe = G();
            return oe[j] = !1, l.forEach(function (ue) {
              ue.provideAttributes(g).forEach(function (te) {
                if (!oe[te.name]) {
                  oe[te.name] = !0;
                  var de = te.name,
                    re;
                  te.valueSet !== "v" && V.length && (de = de + V, (te.valueSet || te.name === "style") && (re = {
                    title: "Suggest",
                    command: "editor.action.triggerSuggest"
                  })), a.items.push({
                    label: te.name,
          ...
          function p(x, D) {
            ...
            if (c.length > 0) for (var ue = g.toLowerCase(), te = y.toLowerCase(), de = m(x, D), re = 0, vt = c; re < vt.length; re++) {
              var wt = vt[re];
              wt.onHtmlAttributeValue && wt.onHtmlAttributeValue({
                document: i,
                position: o,
                tag: ue,
                attribute: te,
          ...
          function b(x) {
            return u === d.getTokenEnd() && (H = d.scan(), H === x && d.getTokenOffset() === u) ? d.getTokenEnd() : u;
          }
          function N() {
            for (var x = 0, D = c; x < D.length; x++) {
              var L = D[x];
              L.onHtmlContent && L.onHtmlContent({
                document: i,
                position: o
              });
            }
          ...
          function R() {
            ...
            if (x >= 0 && s[x] === "&") {
              ...
              for (var q in me) if (Gt(q, ";")) {
                var j = "&" + q;
                a.items.push({
                  label: j,
                  kind: Q.Keyword,
                  documentation: di("entity.propose", "Character entity representing '" + me[q] + "'"),
          ...
          for (var H = d.scan(); H !== S.EOS && d.getTokenOffset() <= u;) {
            switch (H) {
              ...
              case S.AttributeValue:
                ...
                break;
              case S.Whitespace:
                if (u <= d.getTokenEnd()) switch (d.getScannerState()) {
                  case W.AfterOpeningStartTag:
              ...
              case S.EndTagOpen:
                ...
                break;
              case S.EndTag:
                if (u <= d.getTokenEnd()) for (var k = d.getTokenOffset() - 1; k >= 0;) {
                  var C = s.charAt(k);
          ...
          var a,
            c = i.offsetAt(o);
          if (c <= 0) return null;
          var l = (a = e == null ? void 0 : e.attributeDefaultValue) !== null && a !== void 0 ? a : "doublequotes";
          if (l === "empty") return null;
          var r = i.getText().charAt(c - 1);
          if (r !== "=") return null;
          var s = l === "doublequotes" ? '"$1"' : "'$1'",
            u = n.findNodeBefore(c);
          if (u && u.attributes && u.start < c && (!u.endTagStart || u.endTagStart > c)) for (var h = $(i.getText(), u.start), d = h.scan(); d !== S.EOS && h.getTokenEnd() <= c;) {
            if (d === S.AttributeName && h.getTokenEnd() === c - 1) return d = h.scan(), d !== S.DelimiterAssign || (d = h.scan(), d === S.Unknown || d === S.AttributeValue) ? null : s;
            d = h.scan();
          }
          return null;
          ...
          if (a === ">") {
            ...
            if (c && c.tag && !pe(c.tag) && c.start < e && (!c.endTagStart || c.endTagStart > e)) for (var l = $(i.getText(), c.start), r = l.scan(); r !== S.EOS && l.getTokenEnd() <= e;) {
              if (r === S.StartTagClose && l.getTokenEnd() === e) return "$0</" + c.tag + ">";
              r = l.scan();
            }
          } else if (a === "/") {
            for (var c = n.findNodeBefore(e); c && c.closed && !(c.endTagStart && c.endTagStart > e);) c = c.parent;
            if (c && c.tag) for (var l = $(i.getText(), c.start), r = l.scan(); r !== S.EOS && l.getTokenEnd() <= e;) {
              if (r === S.EndTagOpen && l.getTokenEnd() === e) return c.tag + ">";
              r = l.scan();
            }
          }
          return null;
        }, t.prototype.convertCompletionList = function (i) {
          return this.doesSupportMarkdown() || i.items.forEach(function (o) {
          ...
          if (!Ae(this.supportsMarkdown)) {
            if (!Ae(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
            var e = (n = (o = (i = this.lsOptions.clientCapabilities.textDocument) === null || i === void 0 ? void 0 : i.completion) === null || o === void 0 ? void 0 : o.completionItem) === null || n === void 0 ? void 0 : n.documentationFormat;
    ...
    var gi = ge(),
      Zt = function () {
        ...
        return t.prototype.doHover = function (i, o, n, e) {
          ...
          function h(U, H, z) {
            for (var I = function (C) {
                var x = null;
                if (C.provideTags().forEach(function (D) {
                ...
                }), x) return x.contents = a(x.contents), {
                  value: x
                };
              }, F = 0, T = u; F < T.length; F++) {
              var v = T[F],
                k = I(v);
          ...
          function d(U, H, z) {
            for (var I = function (C) {
                var x = null;
                if (C.provideAttributes(U).forEach(function (D) {
          ...
          function g(U, H, z, I) {
            for (var F = function (x) {
                var D = null;
                if (x.provideValues(U, H).forEach(function (L) {
                ...
                }), D) return D.contents = a(D.contents), {
                  value: D
                };
              }, T = 0, v = u; T < v.length; T++) {
              var k = v[T],
                C = F(k);
          ...
          function y(U, H) {
            ...
            for (var I in me) {
              ...
              if (z === T) {
                ...
                k += v;
                var D = gi("entity.propose", "Character entity representing '" + me[I] + "', unicode equivalent '" + k + "'");
                D ? F = {
                  contents: D,
                  range: H
                } : F = null;
          ...
          function m(U, H) {
            for (var z = $(i.getText(), H), I = z.scan(); I !== S.EOS && (z.getTokenEnd() < l || z.getTokenEnd() === l && I !== U);) I = z.scan();
          ...
          function A() {
            ...
            if (U >= 0 && s[U] === "&") {
              var F = null;
              return s[z] === ";" ? F = P.create(X.create(o.line, H), X.create(o.line, I + 1)) : F = P.create(X.create(o.line, H), X.create(o.line, I)), F;
            }
            return null;
          }
          function E(U) {
          ...
          if (f) return y(s, f);
          function p(U, H) {
            for (var z = $(i.getText(), U), I = z.scan(), F = void 0; I !== S.EOS && z.getTokenEnd() <= H;) I = z.scan(), I === S.AttributeName && (F = z.getTokenText());
            return F;
          }
          ...
          if (!this.doesSupportMarkdown()) {
            ...
            if (Array.isArray(i)) i.map(function (o) {
          ...
          if (!Ae(this.supportsMarkdown)) {
            if (!Ae(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
            var e = (n = (o = (i = this.lsOptions.clientCapabilities) === null || i === void 0 ? void 0 : i.textDocument) === null || o === void 0 ? void 0 : o.hover) === null || n === void 0 ? void 0 : n.contentFormat;
            this.supportsMarkdown = Array.isArray(e) && e.indexOf(ee.Markdown) !== -1;
          }
          return this.supportsMarkdown;
        }, t;
...
`);
          ...
          function c(r, s) {
            this.__cache = [""], this.__indent_size = r.indent_size, this.__indent_string = r.indent_char, r.indent_with_tabs || (this.__indent_string = new Array(r.indent_size + 1).join(r.indent_char)), s = s || "", r.indent_level > 0 && (s = new Array(r.indent_level + 1).join(this.__indent_string)), this.__base_string = s, this.__base_string_length = s.length;
          }
          c.prototype.get_indent_size = function (r, s) {
            ...
            return s = s || 0, r < 0 && (r = 0, u = ""), s += r * this.__indent_size, this.__ensure_cache(s), u += this.__cache[s], u;
            ...
            var r = this.__cache.length,
              s = 0,
              u = "";
            this.__indent_size && r >= this.__indent_size && (s = Math.floor(r / this.__indent_size), r -= s * this.__indent_size, u = new Array(s + 1).join(this.__indent_string)), r && (u += new Array(r + 1).join(" ")), this.__cache.push(u);
          };
          function l(r, s) {
            this.__indent_cache = new c(r, s), this.raw = !1, this._end_with_newline = r.end_with_newline, this.indent_size = r.indent_size, this.wrap_line_length = r.wrap_line_length, this.indent_empty_lines = r.indent_empty_lines, this.__lines = [], this.previous_line = null, this.current_line = null, this.next_line = new a(this), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1, this.__add_outputline();
          }
...
` && (u = u.replace(/[\n]/g, r)), u;
            ...
            for (var u = this.__lines.length - 2; u >= 0;) {
              ...
              if (h.item(0).indexOf(r) !== 0 && h.item(-1) !== s) {
                this.__lines.splice(u + 1, 0, new a(this)), this.previous_line = this.__lines[this.__lines.length - 2];
                break;
              }
              u--;
            }
...
You passed in: '` + this.raw_options[r] + "'");
            ...
            if (!this._is_valid_selection(h, s)) throw new Error("Invalid Option Value: The option '" + r + `' can contain only the following values:
` + s + `
You passed in: '` + this.raw_options[r] + "'");
            return h;
          }, a.prototype._is_valid_selection = function (r, s) {
            return r.length && s.length && !r.some(function (u) {
          ...
          c.prototype.restart = function () {
            ...
            var r = null;
            return l = l || 0, l += this.__position, l >= 0 && l < this.__input_length && (r = this.__input.charAt(l)), r;
            ...
            return r = r || 0, r += this.__position, r >= 0 && r < this.__input_length ? !!this.__match(l, r) : !1;
            ...
            return h ? (u = h.index, r && (u += h[0].length)) : u = this.__input_length, s = this.__input.substring(this.__position, u), this.__position = u, s;
          }, c.prototype.readUntilAfter = function (l) {
            return this.readUntil(l, !0);
          }, c.prototype.get_regexp = function (l, r) {
            var s = null,
              u = "g";
            return r && a && (u = "y"), typeof l == "string" && l !== "" ? s = new RegExp(l, u) : l && (s = new RegExp(l.source, u)), s;
          ...
          function a(c, l) {
            c = typeof c == "string" ? c : c.source, l = typeof l == "string" ? l : l.source, this.__directives_block_pattern = new RegExp(c + / beautify( \w+[:]\w+)+ /.source + l, "g"), this.__directive_pattern = / (\w+)[:](\w+)/g, this.__directives_end_ignore_pattern = new RegExp(c + /\sbeautify\signore:end\s/.source + l, "g");
          }
          a.prototype.get_directives = function (c) {
            if (!c.match(this.__directives_block_pattern)) return null;
            var l = {};
            this.__directive_pattern.lastIndex = 0;
            for (var r = this.__directive_pattern.exec(c); r;) l[r[1]] = r[2], r = this.__directive_pattern.exec(c);
            return l;
          ...
          var l = c(17).Options,
            ...
            E = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
          function w(M, B) {
            this._source_text = M || "", this._options = new l(B), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
              "@page": !0,
              "@font-face": !0,
              "@keyframes": !0,
              "@media": !0,
          ...
          w.prototype.eatString = function (M) {
            ...
            for (this._ch = this._input.next(); this._ch;) {
              if (B += this._ch, this._ch === "\\") B += this._input.next();else if (M.indexOf(this._ch) !== -1 || this._ch === `
`) break;
              this._ch = this._input.next();
            }
            return B;
          }, w.prototype.eatWhitespace = function (M) {
            for (var B = y.test(this._input.peek()), G = 0; y.test(this._input.peek());) this._ch = this._input.next(), M && this._ch === `
` && (G === 0 || G < this._options.max_preserve_newlines) && (G++, this._output.add_new_line(!0));
            return B;
...
`);
          ...
          var l = c(6).Options;
          function r(s) {
            l.call(this, s, "css"), this.selector_separator_newline = this._get_boolean("selector_separator_newline", !0), this.newline_between_rules = this._get_boolean("newline_between_rules", !0);
            ...
            for (var d = 0; d < h.length; d++) h[d] !== "expand" ? this.brace_style = "collapse" : this.brace_style = h[d];
          }
...
` && (u = u.replace(/[\n]/g, r)), u;
          ...
          function a(c, l, r, s) {
            this.type = c, this.text = l, this.comments_before = null, this.newlines = r || 0, this.whitespace_before = s || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
          }
          e.exports.Token = a;
        },,, function (e) {
          function a(r, s) {
...
You passed in: '` + this.raw_options[r] + "'");
          ...
          var l = c(8).InputScanner,
            ...
            d = function (g, y) {
              this._input = new l(g), this._options = y || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new u(this._input);
            };
          d.prototype.tokenize = function () {
            ...
            for (var g, y = new r(h.START, ""), m = null, A = [], E = new s(); y.type !== h.EOF;) {
              ...
              E.isEmpty() || (g.comments_before = E, E = new s()), g.parent = m, this._is_opening(g) ? (A.push(m), m = g) : m && this._is_closing(g, m) && (g.opened = m, m.closed = g, m = A.pop(), g.parent = m), g.previous = y, y.next = g, this.__tokens.add(g), y = g;
            }
            return this.__tokens;
          }, d.prototype._is_first_token = function () {
            return this.__tokens.isEmpty();
          }, d.prototype._reset = function () {}, d.prototype._get_next_token = function (g, y) {
            ...
            var m = new r(g, y, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
            return m;
          }, d.prototype._readWhitespace = function () {
            return this._patterns.whitespace.read();
          }, e.exports.Tokenizer = d, e.exports.TOKEN = h;
        }, function (e) {
          function a(c) {
            this.__tokens = [], this.__tokens_length = this.__tokens.length, this.__position = 0, this.__parent_token = c;
          }
          a.prototype.restart = function () {
            ...
            var l = null;
            return c = c || 0, c += this.__position, c >= 0 && c < this.__tokens_length && (l = this.__tokens[c]), l;
          }, a.prototype.add = function (c) {
            this.__parent_token && (c.parent = this.__parent_token), this.__tokens.push(c), this.__tokens_length += 1;
          }, e.exports.TokenStream = a;
        }, function (e, a, c) {
          var l = c(12).Pattern;
          function r(s, u) {
            l.call(this, s, u), u ? this._line_regexp = this._input.get_regexp(u._line_regexp) : this.__set_whitespace_patterns("", ""), this.newline_count = 0, this.whitespace_before_token = "";
          }
          r.prototype = new l(), r.prototype.__set_whitespace_patterns = function (s, u) {
            ...
            if (s === " ") this.whitespace_before_token = " ";else if (s) {
            ...
            s.lastIndex = 0;
            for (var h = 0, d = [], g = s.exec(u); g;) d.push(u.substring(h, g.index)), h = g.index + g[0].length, g = s.exec(u);
          ...
          a.prototype.read = function () {
            ...
            return (!this._starting_pattern || c) && (c += this._input.read(this._match_pattern, this._until_pattern, this._until_after)), c;
          ...
          }, a.prototype._update = function () {}, e.exports.Pattern = a;
        }, function (e) {
          function a(c, l) {
            c = typeof c == "string" ? c : c.source, l = typeof l == "string" ? l : l.source, this.__directives_block_pattern = new RegExp(c + / beautify( \w+[:]\w+)+ /.source + l, "g"), this.__directive_pattern = / (\w+)[:](\w+)/g, this.__directives_end_ignore_pattern = new RegExp(c + /\sbeautify\signore:end\s/.source + l, "g");
          }
          ...
          function s(u, h) {
            l.call(this, u, h), this.__template_pattern = null, this._disabled = Object.assign({}, r), this._excluded = Object.assign({}, r), h && (this.__template_pattern = this._input.get_regexp(h.__template_pattern), this._excluded = Object.assign(this._excluded, h._excluded), this._disabled = Object.assign(this._disabled, h._disabled));
            var d = new l(u);
            this.__patterns = {
          ...
          s.prototype = new l(), s.prototype._create = function () {
            ...
            var u = "";
            this._match_pattern ? u = this._input.read(this._starting_pattern) : u = this._input.read(this._starting_pattern, this.__template_pattern);
            for (var h = this._read_template(); h;) this._match_pattern ? h += this._input.read(this._match_pattern) : h += this._input.readUntil(this.__template_pattern), u += h, h = this._read_template();
            return this._until_after && (u += this._input.readUntilAfter(this._until_pattern)), u;
          }, s.prototype.__set_templated_pattern = function () {
            var u = [];
            this._disabled.php || u.push(this.__patterns.php._starting_pattern.source), this._disabled.handlebars || u.push(this.__patterns.handlebars._starting_pattern.source), this._disabled.erb || u.push(this.__patterns.erb._starting_pattern.source), this._disabled.django || (u.push(this.__patterns.django._starting_pattern.source), u.push(this.__patterns.django_value._starting_pattern.source), u.push(this.__patterns.django_comment._starting_pattern.source)), this._disabled.smarty || u.push(this.__patterns.smarty._starting_pattern.source), this._until_pattern && u.push(this._until_pattern.source), this.__template_pattern = this._input.get_regexp("(?:" + u.join("|") + ")");
          }, s.prototype._read_template = function () {
            var u = "",
              h = this._input.peek();
            if (h === "<") {
              var d = this._input.peek(1);
              !this._disabled.php && !this._excluded.php && d === "?" && (u = u || this.__patterns.php.read()), !this._disabled.erb && !this._excluded.erb && d === "%" && (u = u || this.__patterns.erb.read());
            } else h === "{" && (!this._disabled.handlebars && !this._excluded.handlebars && (u = u || this.__patterns.handlebars_comment.read(), u = u || this.__patterns.handlebars_unescaped.read(), u = u || this.__patterns.handlebars.read()), this._disabled.django || (!this._excluded.django && !this._excluded.handlebars && (u = u || this.__patterns.django_value.read()), this._excluded.django || (u = u || this.__patterns.django_comment.read(), u = u || this.__patterns.django.read())), this._disabled.smarty || this._disabled.django && this._disabled.handlebars && (u = u || this.__patterns.smarty_comment.read(), u = u || this.__patterns.smarty_literal.read(), u = u || this.__patterns.smarty.read()));
            return u;
          ...
          var l = c(20).Options,
            ...
            d = /\r\n|[\r\n]/g,
            g = function (f, p) {
              this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = f.max_preserve_newlines, this.preserve_newlines = f.preserve_newlines, this._output = new r(f, p);
            };
          g.prototype.current_line_has_match = function (f) {
            ...
            var p = 0;
            f.type !== u.TEXT && f.previous.type !== u.TEXT && (p = f.newlines ? 1 : 0), this.preserve_newlines && (p = f.newlines < this.max_preserve_newlines + 1 ? f.newlines : this.max_preserve_newlines + 1);
            for (var b = 0; b < p; b++) this.print_newline(b > 0);
            return p !== 0;
          }, g.prototype.traverse_whitespace = function (f) {
            return f.whitespace_before || f.newlines ? (this.print_preserved_newlines(f) || (this._output.space_before_token = !0), !0) : !1;
          ...
          var y = function (f) {
              for (var p = null, b = f.next; b.type !== u.EOF && f.closed !== b;) {
                if (b.type === u.ATTRIBUTE && b.text === "type") {
                  b.next && b.next.type === u.EQUALS && b.next.next && b.next.next.type === u.VALUE && (p = b.next.next.text);
                  break;
                }
                b = b.next;
              }
            ...
            m = function (f, p) {
              var b = null,
                N = null;
              return p.closed ? (f === "script" ? b = "text/javascript" : f === "style" && (b = "text/css"), b = y(p) || b, b.search("text/css") > -1 ? N = "css" : b.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? N = "javascript" : b.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? N = "html" : b.search(/test\/null/) > -1 && (N = "null"), N) : null;
            };
          function A(f, p) {
            return p.indexOf(f) !== -1;
          }
          function E(f, p, b) {
            this.parent = f || null, this.tag = p ? p.tag_name : "", this.indent_level = b || 0, this.parser_token = p || null;
          }
          function w(f) {
          ...
          w.prototype.get_parser_token = function () {
            ...
            var p = null;
            return f && (p = f.parser_token, this._printer.indent_level = f.indent_level, this._current_frame = f.parent), p;
          ...
          function M(f, p, b, N) {
            this._source_text = f || "", p = p || {}, this._js_beautify = b, this._css_beautify = N, this._tag_stack = null;
            var R = new l(p, "html");
...
`);
            ...
            return f.alignment_size = 0, b.tag_complete = !0, f.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), b.is_unformatted ? f.add_raw_token(p) : (b.tag_start_char === "<" && (f.set_space_before_token(p.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && b.has_wrapped_attrs && f.print_newline(!1)), f.print_token(p)), b.indent_content && !(b.is_unformatted || b.is_content_unformatted) && (f.indent(), b.indent_content = !1), !b.is_inline_element && !(b.is_unformatted || b.is_content_unformatted) && f.set_wrap_point(), N;
            ...
            if (f.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), b.is_unformatted) f.add_raw_token(p);else if (b.tag_start_char === "{" && p.type === u.TEXT) f.print_preserved_newlines(p) ? (p.newlines = 0, f.add_raw_token(p)) : f.print_token(p);else {
              if (p.type === u.ATTRIBUTE ? (f.set_space_before_token(!0), b.attr_count += 1) : (p.type === u.EQUALS || p.type === u.VALUE && p.previous.type === u.EQUALS) && f.set_space_before_token(!1), p.type === u.ATTRIBUTE && b.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (f.traverse_whitespace(p), R = R || p.newlines !== 0), this._is_wrap_attributes_force)) {
            ...
            return b.custom_beautifier_name ? this._print_custom_beatifier_text(f, p, b) : b.is_unformatted || b.is_content_unformatted ? f.add_raw_token(p) : (f.traverse_whitespace(p), f.print_token(p)), N;
            ...
            if (p.text !== "") {
              var R = p.text,
                ...
                z = "",
                I = "";
              b.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? U = this._js_beautify : b.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? U = this._css_beautify : b.custom_beautifier_name === "html" && (U = function (x, D) {
                var L = new M(x, D, N._js_beautify, N._css_beautify);
                return L.beautify();
              }), this._options.indent_scripts === "keep" ? H = 0 : this._options.indent_scripts === "separate" && (H = -f.indent_level);
...
`) !== -1) && (T = T[3].match(/[ \t]+$/), T && (p.whitespace_before = T[0]));
              }
              if (R) if (U) {
                var v = function () {
                  this.eol = `
`;
                ...
                C && (R = R.replace(new RegExp(`
(` + C + ")?", "g"), `
`)), R = F + R.replace(/\n/g, `
` + F);
              }
              z && (R ? R = z + R + `
` + I : R = z + I), f.print_newline(!1), R && (p.text = R, p.whitespace_before = "", p.newlines = 0, f.add_raw_token(p), f.print_newline(!0));
            }
          }, M.prototype._handle_tag_open = function (f, p, b, N) {
            var R = this._get_tag_open_token(p);
            return (b.is_unformatted || b.is_content_unformatted) && !b.is_empty_element && p.type === u.TAG_OPEN && p.text.indexOf("</") === 0 ? (f.add_raw_token(p), R.start_tag_token = this._tag_stack.try_pop(R.tag_name)) : (f.traverse_whitespace(p), this._set_tag_position(f, p, R, b, N), R.is_inline_element || f.set_wrap_point(), f.print_token(p)), (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (R.alignment_size = p.text.length + 1), !R.tag_complete && !R.is_unformatted && (f.alignment_size = R.alignment_size), R;
          };
          var B = function (f, p) {
          ...
          M.prototype._get_tag_open_token = function (f) {
            ...
            if (b.is_empty_element || (b.is_end_tag ? b.start_tag_token = this._tag_stack.try_pop(b.tag_name) : (this._do_optional_end_element(b) && (b.is_inline_element || f.print_newline(!1)), this._tag_stack.record_tag(b), (b.tag_name === "script" || b.tag_name === "style") && !(b.is_unformatted || b.is_content_unformatted) && (b.custom_beautifier_name = m(b.tag_check, p)))), A(b.tag_check, this._options.extra_liners) && (f.print_newline(!1), f._output.just_added_blankline() || f.print_newline(!0)), b.is_empty_element) {
              ...
              b.tag_name === "!--" && R.type === u.TAG_CLOSE && N.is_end_tag && b.text.indexOf(`
`) === -1 || (b.is_inline_element || b.is_unformatted || f.print_newline(!1), this._calcluate_parent_multiline(f, b));
            } else if (b.is_end_tag) {
              var H = !1;
              H = b.start_tag_token && b.start_tag_token.multiline_content, H = H || !b.is_inline_element && !(N.is_inline_element || N.is_unformatted) && !(R.type === u.TAG_CLOSE && b.start_tag_token === N) && R.type !== "TK_CONTENT", (b.is_content_unformatted || b.is_unformatted) && (H = !1), H && f.print_newline(!1);
            } else b.indent_content = !b.custom_beautifier_name, b.tag_start_char === "<" && (b.tag_name === "html" ? b.indent_content = this._options.indent_inner_html : b.tag_name === "head" ? b.indent_content = this._options.indent_head_inner_html : b.tag_name === "body" && (b.indent_content = this._options.indent_body_inner_html)), !(b.is_inline_element || b.is_unformatted) && (R.type !== "TK_CONTENT" || b.is_content_unformatted) && f.print_newline(!1), this._calcluate_parent_multiline(f, b);
          }, M.prototype._calcluate_parent_multiline = function (f, p) {
            p.parent && f._output.just_added_newline() && !((p.is_inline_element || p.is_unformatted) && p.parent.is_inline_element) && (p.parent.multiline_content = !0);
          };
          ...
          M.prototype._do_optional_end_element = function (f) {
            ...
            if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
              if (f.tag_name === "body") p = p || this._tag_stack.try_pop("head");else if (f.tag_name === "li") p = p || this._tag_stack.try_pop("li", ["ol", "ul"]);else if (f.tag_name === "dd" || f.tag_name === "dt") p = p || this._tag_stack.try_pop("dt", ["dl"]), p = p || this._tag_stack.try_pop("dd", ["dl"]);else if (f.parent.tag_name === "p" && G.indexOf(f.tag_name) !== -1) {
                var b = f.parent.parent;
                (!b || J.indexOf(b.tag_name) === -1) && (p = p || this._tag_stack.try_pop("p"));
              } else f.tag_name === "rp" || f.tag_name === "rt" ? (p = p || this._tag_stack.try_pop("rt", ["ruby", "rtc"]), p = p || this._tag_stack.try_pop("rp", ["ruby", "rtc"])) : f.tag_name === "optgroup" ? p = p || this._tag_stack.try_pop("optgroup", ["select"]) : f.tag_name === "option" ? p = p || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]) : f.tag_name === "colgroup" ? p = p || this._tag_stack.try_pop("caption", ["table"]) : f.tag_name === "thead" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"])) : f.tag_name === "tbody" || f.tag_name === "tfoot" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("thead", ["table"]), p = p || this._tag_stack.try_pop("tbody", ["table"])) : f.tag_name === "tr" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])) : (f.tag_name === "th" || f.tag_name === "td") && (p = p || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"]), p = p || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"]));
          ...
          y.prototype = new l(), y.prototype._is_comment = function (m) {
            return !1;
          }, y.prototype._is_opening = function (m) {
            return m.type === d.TAG_OPEN;
          }, y.prototype._is_closing = function (m, A) {
            return m.type === d.TAG_CLOSE && A && ((m.text === ">" || m.text === "/>") && A.text[0] === "<" || m.text === "}}" && A.text[0] === "{" && A.text[1] === "{");
            ...
            if (m === "<") {
              ...
              M === "!" && (E = this.__patterns.comment.read(), E ? (w = g.get_directives(E), w && w.ignore === "start" && (E += g.readIgnored(this._input))) : E = this.__patterns.cdata.read()), E && (A = this._create_token(d.COMMENT, E), A.directives = w);
            }
            return A;
            ...
            if (m === "<") {
              var M = this._input.peek(1);
              (M === "!" || M === "?") && (E = this.__patterns.conditional_comment.read(), E = E || this.__patterns.processing.read()), E && (A = this._create_token(d.COMMENT, E), A.directives = w);
            }
            return A;
          }, y.prototype._read_open = function (m, A) {
            var E = null,
              w = null;
            return A || m === "<" && (E = this._input.next(), this._input.peek() === "/" && (E += this._input.next()), E += this.__patterns.element_name.read(), w = this._create_token(d.TAG_OPEN, E)), w;
          }, y.prototype._read_open_handlebars = function (m, A) {
            var E = null,
              w = null;
            return A || this._options.indent_handlebars && m === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (E = this.__patterns.handlebars_comment.read(), E = E || this.__patterns.handlebars.read(), w = this._create_token(d.COMMENT, E)) : (E = this.__patterns.handlebars_open.read(), w = this._create_token(d.TAG_OPEN, E))), w;
          }, y.prototype._read_close = function (m, A) {
            var E = null,
              w = null;
            return A && (A.text[0] === "<" && (m === ">" || m === "/" && this._input.peek(1) === ">") ? (E = this._input.next(), m === "/" && (E += this._input.next()), w = this._create_token(d.TAG_CLOSE, E)) : A.text[0] === "{" && m === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), w = this._create_token(d.TAG_CLOSE, "}}"))), w;
          }, y.prototype._read_attribute = function (m, A, E) {
            var w = null,
              M = "";
            if (E && E.text[0] === "<") if (m === "=") w = this._create_token(d.EQUALS, this._input.next());else if (m === '"' || m === "'") {
              var B = this._input.next();
              m === '"' ? B += this.__patterns.double_quote.read() : B += this.__patterns.single_quote.read(), w = this._create_token(d.VALUE, B);
            } else M = this.__patterns.attribute.read(), M && (A.type === d.EQUALS ? w = this._create_token(d.VALUE, M) : w = this._create_token(d.ATTRIBUTE, M));
            return w;
          }, y.prototype._is_content_unformatted = function (m) {
            return this._options.void_elements.indexOf(m) === -1 && (this._options.content_unformatted.indexOf(m) !== -1 || this._options.unformatted.indexOf(m) !== -1);
          }, y.prototype._read_raw_content = function (m, A, E) {
            var w = "";
            if (E && E.text[0] === "{") w = this.__patterns.handlebars_raw_close.read();else if (A.type === d.TAG_CLOSE && A.opened.text[0] === "<" && A.text[0] !== "/") {
              ...
              } else this._is_content_unformatted(M) && (w = this._input.readUntil(new RegExp("</" + M + "[\\n\\r\\t ]*?>", "ig")));
            }
            return w ? this._create_token(d.TEXT, w) : null;
          }, y.prototype._read_content_word = function (m) {
            var A = "";
            if (this._options.unformatted_content_delimiter && m === this._options.unformatted_content_delimiter[0] && (A = this.__patterns.unformatted_content_delimiter.read()), A || (A = this.__patterns.word.read()), A) return this._create_token(d.TEXT, A);
          }, e.exports.Tokenizer = y, e.exports.TOKEN = d;
        }],
        i = {};
      function o(e) {
        var a = i[e];
    ...
    function sn(t, i, o) {
      ...
      if (i) {
        ...
        if (new RegExp(/.*[<][^>]*$/).test(h)) return n = n.substring(l, s), [{
          range: i,
          newText: n
        }];
...
` + m), i.start.character === 0 && (y = m + y);
    ...
    function pt(t, i, o) {
      var n = ie(t, i, null);
      return typeof n == "string" ? n.length > 0 ? n.split(",").map(function (e) {
    ...
    function _i(t, i, o) {
      for (var n = i, e = 0, a = o.tabSize || 4; n < t.length;) {
        var c = t.charAt(n);
        if (c === " ") e++;else if (c === "	") e += a;else break;
        n++;
      }
...
`.indexOf(t.charAt(i)) !== -1;
    ...
    ln = (() => {
      ...
      var t = {
          470: n => {
            ...
            function a(l, r) {
              for (var s, u = "", h = 0, d = -1, g = 0, y = 0; y <= l.length; ++y) {
                if (y < l.length) s = l.charCodeAt(y);else {
                  if (s === 47) break;
                  s = 47;
                }
                if (s === 47) {
                  if (!(d === y - 1 || g === 1)) if (d !== y - 1 && g === 2) {
                    if (u.length < 2 || h !== 2 || u.charCodeAt(u.length - 1) !== 46 || u.charCodeAt(u.length - 2) !== 46) {
                      if (u.length > 2) {
                        var m = u.lastIndexOf("/");
                        if (m !== u.length - 1) {
                          m === -1 ? (u = "", h = 0) : h = (u = u.slice(0, m)).length - 1 - u.lastIndexOf("/"), d = y, g = 0;
                          continue;
                        }
            ...
            var c = {
              resolve: function () {
                for (var l, r = "", s = !1, u = arguments.length - 1; u >= -1 && !s; u--) {
                  var h;
                  u >= 0 ? h = arguments[u] : (l === void 0 && (l = process.cwd()), h = l), e(h), h.length !== 0 && (r = h + "/" + r, s = h.charCodeAt(0) === 47);
                }
              ...
              relative: function (l, r) {
                ...
                var w = "";
                for (A = s + m + 1; A <= u; ++A) A !== u && l.charCodeAt(A) !== 47 || (w.length === 0 ? w += ".." : w += "/..");
              ...
              dirname: function (l) {
                if (e(l), l.length === 0) return ".";
                for (var r = l.charCodeAt(0), s = r === 47, u = -1, h = !0, d = l.length - 1; d >= 1; --d) if ((r = l.charCodeAt(d)) === 47) {
                  if (!h) {
                    u = d;
                    break;
                  }
              ...
              basename: function (l, r) {
                ...
                if (r !== void 0 && r.length > 0 && r.length <= l.length) {
                  ...
                  for (s = l.length - 1; s >= 0; --s) {
                    ...
                    } else y === -1 && (d = !1, y = s + 1), g >= 0 && (m === r.charCodeAt(g) ? --g == -1 && (h = s) : (g = -1, h = y));
                  }
                  return u === h ? h = y : h === -1 && (h = l.length), l.slice(u, h);
                }
                for (s = l.length - 1; s >= 0; --s) if (l.charCodeAt(s) === 47) {
                  if (!d) {
                    u = s + 1;
                    break;
                  }
              ...
              extname: function (l) {
                ...
                for (var r = -1, s = 0, u = -1, h = !0, d = 0, g = l.length - 1; g >= 0; --g) {
                  ...
                  if (y !== 47) u === -1 && (h = !1, u = g + 1), y === 46 ? r === -1 ? r = g : d !== 1 && (d = 1) : r !== -1 && (d = -1);else if (!h) {
                    s = g + 1;
                    break;
                  }
                }
              ...
              parse: function (l) {
                ...
                var s,
                  ...
                  h = u === 47;
                h ? (r.root = "/", s = 1) : s = 0;
                for (var d = -1, g = 0, y = -1, m = !0, A = l.length - 1, E = 0; A >= s; --A) if ((u = l.charCodeAt(A)) !== 47) y === -1 && (m = !1, y = A + 1), u === 46 ? d === -1 ? d = A : E !== 1 && (E = 1) : d !== -1 && (E = -1);else if (!m) {
                  g = A + 1;
                  break;
                }
                return d === -1 || y === -1 || E === 0 || E === 1 && d === y - 1 && d === g + 1 ? y !== -1 && (r.base = r.name = g === 0 && h ? l.slice(1, y) : l.slice(g, y)) : (g === 0 && h ? (r.name = l.slice(1, d), r.base = l.slice(1, y)) : (r.name = l.slice(g, d), r.base = l.slice(g, y)), r.ext = l.slice(d, y)), g > 0 ? r.dir = l.slice(0, g - 1) : h && (r.dir = "/"), r;
              },
              sep: "/",
              delimiter: ":",
              win32: null,
          ...
          447: (n, e, a) => {
            ...
            if (a.r(e), a.d(e, {
              URI: () => w,
              Utils: () => H
            }), typeof process == "object") c = process.platform === "win32";else if (typeof navigator == "object") {
            ...
            var r,
              ...
              g = /^\/\//;
            function y(T, v) {
              if (!T.scheme && v) throw new Error('[UriError]: Scheme is missing: {scheme: "", authority: "'.concat(T.authority, '", path: "').concat(T.path, '", query: "').concat(T.query, '", fragment: "').concat(T.fragment, '"}'));
              if (T.scheme && !h.test(T.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
              if (T.path) {
                if (T.authority) {
                  if (!d.test(T.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
                } else if (g.test(T.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
              }
            }
            var m = "",
              A = "/",
              ...
              w = function () {
                function T(v, k, C, x, D, L) {
                  L === void 0 && (L = !1), typeof v == "object" ? (this.scheme = v.scheme || m, this.authority = v.authority || m, this.path = v.path || m, this.query = v.query || m, this.fragment = v.fragment || m) : (this.scheme = function (q, j) {
                    return q || j ? q : "file";
                  }(v, L), this.authority = k || m, this.path = function (q, j) {
                    switch (q) {
                      case "https":
                      case "http":
                      case "file":
                    ...
                    return j;
                  }(this.scheme, C || m), this.query = x || m, this.fragment = D || m, y(this, L));
                }
                return T.isUri = function (v) {
                  return v instanceof T || !!v && typeof v.authority == "string" && typeof v.fragment == "string" && typeof v.path == "string" && typeof v.query == "string" && typeof v.scheme == "string" && typeof v.fsPath == "string" && typeof v.with == "function" && typeof v.toString == "function";
                  ...
                  var k = v.scheme,
                    ...
                    D = v.query,
                    L = v.fragment;
                  return k === void 0 ? k = this.scheme : k === null && (k = m), C === void 0 ? C = this.authority : C === null && (C = m), x === void 0 ? x = this.path : x === null && (x = m), D === void 0 ? D = this.query : D === null && (D = m), L === void 0 ? L = this.fragment : L === null && (L = m), k === this.scheme && C === this.authority && x === this.path && D === this.query && L === this.fragment ? this : new B(k, C, x, D, L);
                }, T.parse = function (v, k) {
                  k === void 0 && (k = !1);
                  var C = E.exec(v);
                  return C ? new B(C[2] || m, U(C[4] || m), U(C[5] || m), U(C[7] || m), U(C[9] || m), k) : new B(m, m, m, m, m);
                }, T.file = function (v) {
                  var k = m;
              ...
              B = function (T) {
                ...
                return u(v, T), Object.defineProperty(v.prototype, "fsPath", {
                  get: function () {
                  ...
                  return k === void 0 && (k = !1), k ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)), this._formatted);
            ...
            function J(T, v) {
              for (var k = void 0, C = -1, x = 0; x < T.length; x++) {
                ...
                if (D >= 97 && D <= 122 || D >= 65 && D <= 90 || D >= 48 && D <= 57 || D === 45 || D === 46 || D === 95 || D === 126 || v && D === 47) C !== -1 && (k += encodeURIComponent(T.substring(C, x)), C = -1), k !== void 0 && (k += T.charAt(x));else {
                  k === void 0 && (k = T.substr(0, x));
                  var L = G[D];
                  L !== void 0 ? (C !== -1 && (k += encodeURIComponent(T.substring(C, x)), C = -1), k += L) : C === -1 && (C = x);
                }
              }
            ...
            function b(T, v) {
              ...
              if (x && (C += x, C += ":"), (D || x === "file") && (C += A, C += A), D) {
                ...
                if (O !== -1) {
                  var V = D.substr(0, O);
                  D = D.substr(O + 1), (O = V.indexOf(":")) === -1 ? C += k(V, !1) : (C += k(V.substr(0, O), !1), C += ":", C += k(V.substr(O + 1), !1)), C += "@";
                }
                (O = (D = D.toLowerCase()).indexOf(":")) === -1 ? C += k(D, !1) : (C += k(D.substr(0, O), !1), C += D.substr(O));
              }
              if (L) {
                if (L.length >= 3 && L.charCodeAt(0) === 47 && L.charCodeAt(2) === 58) (K = L.charCodeAt(1)) >= 65 && K <= 90 && (L = "/".concat(String.fromCharCode(K + 32), ":").concat(L.substr(3)));else if (L.length >= 2 && L.charCodeAt(1) === 58) {
                  var K;
                  (K = L.charCodeAt(0)) >= 65 && K <= 90 && (L = "".concat(String.fromCharCode(K + 32), ":").concat(L.substr(2)));
                }
                C += k(L, !0);
              }
            ...
            function U(T) {
              return T.match(R) ? T.replace(R, function (v) {
                return N(v);
              }) : T;
            }
            var H,
              z = a(470),
              I = function (T, v, k) {
                if (k || arguments.length === 2) for (var C, x = 0, D = v.length; x < D; x++) !C && x in v || (C || (C = Array.prototype.slice.call(v, 0, x)), C[x] = v[x]);
            ...
            (function (T) {
              T.joinPath = function (v) {
                ...
                return k.length === 1 && k.charCodeAt(0) === 46 ? v : v.with({
                  path: k
                });
      ...
      return o.d = (n, e) => {
        for (var a in e) o.o(e, a) && !o.o(n, a) && Object.defineProperty(n, a, {
          enumerable: !0,
          get: e[a]
        });
      }, o.o = (n, e) => Object.prototype.hasOwnProperty.call(n, e), o.r = n => {
    ...
    function yi(t, i) {
      return !t.length || i === "handlebars" && /{{|}}/.test(t) ? !1 : /\b(w[\w\d+.-]*:\/\/)?[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|\/?))/.test(t);
    }
    function Ti(t, i, o, n) {
        ...
        switch (e) {
          ...
          case S.AttributeValue:
            if (a === "src" || a === "href") {
              ...
              c && typeof l > "u" && (l = mt(u), l && i && (l = i.resolveReference(l, t.uri))), c = !1, a = void 0;
            } else if (a === "id") {
    ...
    function mn(t, i, o) {
      ...
      return (c && dn(c, i) || l && dn(l, i)) && (c && a.push({
        kind: ye.Read,
        range: c
      }), l && a.push({
        kind: ye.Read,
    ...
    function fn(t, i) {
      var o = [];
      return i.roots.forEach(function (n) {
        gn(t, n, "", o);
      }), o;
    }
    function gn(t, i, o, n) {
      ...
      n.push(c), i.children.forEach(function (l) {
        gn(t, l, e, n);
      });
    }
    function Ai(t) {
      ...
      if (t.attributes) {
        ...
        o && (i += "#" + o.replace(/[\"\']/g, "")), n && (i += n.replace(/[\"\']/g, "").split(/\s+/).map(function (e) {
          return "." + e;
        }).join(""));
      }
      return i || "?";
    ...
    function xi(t, i, o) {
      return t.endTagStart && t.endTagStart + "</".length <= i && i <= t.endTagStart + "</".length + o.length ? !0 : t.start + "<".length <= i && i <= t.start + "<".length + o.length;
    }
    function vn(t, i, o) {
      var n = t.offsetAt(i),
        e = o.findNodeAt(n);
      if (!e.tag || !e.endTagStart) return null;
      if (e.start + "<".length <= n && n <= e.start + "<".length + e.tag.length) {
        var a = n - "<".length - e.start + e.endTagStart + "</".length;
        return t.positionAt(a);
      }
      if (e.endTagStart + "</".length <= n && n <= e.endTagStart + "</".length + e.tag.length) {
    ...
    function ft(t, i, o) {
      ...
      return e.endTagStart && (e.start + "<".length <= n && n <= e.start + "<".length + a || e.endTagStart + "</".length <= n && n <= e.endTagStart + "</".length + a) ? [P.create(t.positionAt(e.start + "<".length), t.positionAt(e.start + "<".length + a)), P.create(t.positionAt(e.endTagStart + "</".length), t.positionAt(e.endTagStart + "</".length + a))] : null;
    }
    function Di(t, i) {
      ...
      for (var o = void 0, n = [], e = [], a = [], c = function (y, m) {
          e[y] = m, m < 30 && (a[m] = (a[m] || 0) + 1);
        }, l = 0; l < t.length; l++) {
        var r = t[l];
        if (!o) o = r, c(l, 0);else if (r.startLine > o.startLine) {
          if (r.endLine <= o.endLine) n.push(o), o = r, c(l, n.length);else if (r.startLine > o.endLine) {
            do o = n.pop(); while (o && r.startLine > o.endLine);
    ...
    function yn(t, i) {
      function o(n) {
        for (var e = Ei(t, n), a = void 0, c = void 0, l = e.length - 1; l >= 0; l--) {
          var r = e[l];
          (!a || r[0] !== a[0] || r[1] !== a[1]) && (c = Te.create(P.create(t.positionAt(e[l][0]), t.positionAt(e[l][1])), c)), a = r;
        }
    ...
    function Ei(t, i) {
      ...
      if (a.unshift([e.start, e.end]), e.start < n && n < e.startTagEnd) {
        ...
        var r = _n(t, e, n);
        return a = r.concat(a), a;
      } else return e.startTagEnd <= n && n <= e.endTagStart ? (a.unshift([e.startTagEnd, e.endTagStart]), a) : (n >= e.endTagStart + 2 && a.unshift([e.endTagStart + 2, e.end - 1]), a);
    }
    function Ci(t) {
      for (var i = t, o = function (e) {
          return e.startTagEnd && e.endTagStart && e.startTagEnd < e.endTagStart ? [[e.startTagEnd, e.endTagStart], [e.start, e.end]] : [[e.start, e.end]];
        }, n = []; i.parent;) i = i.parent, o(i).forEach(function (e) {
        return n.push(e);
      });
      return n;
    }
    function _n(t, i, o) {
      for (var n = P.create(t.positionAt(i.start), t.positionAt(i.end)), e = t.getText(n), a = o - i.start, c = $(e), l = c.scan(), r = i.start, s = [], u = !1, h = -1; l !== S.EOS;) {
        switch (l) {
          case S.AttributeName:
            {
          ...
          case S.AttributeValue:
            {
              ...
              a >= c.getTokenOffset() && a <= c.getTokenEnd() && (s.unshift([c.getTokenOffset(), c.getTokenEnd()]), (d[0] === '"' && d[d.length - 1] === '"' || d[0] === "'" && d[d.length - 1] === "'") && a >= c.getTokenOffset() + 1 && a <= c.getTokenEnd() - 1 && s.unshift([c.getTokenOffset() + 1, c.getTokenEnd() - 1]), s.push([h, c.getTokenEnd()]));
              break;
            }
        }
        l = c.scan();
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
    ...
    var Tn = function () {
      ...
      return t.prototype.setDataProviders = function (i, o) {
        var n;
        this.dataProviders = [], i && this.dataProviders.push(new Ge("html5", gt)), (n = this.dataProviders).push.apply(n, o);
    ...
    var bt = class {
      ...
      async doComplete(i, o) {
        ...
        return Promise.resolve(this._languageService.doComplete(n, o, e, this._languageSettings && this._languageSettings.suggest));
      }
      async format(i, o, n) {
      ...
      _getTextDocument(i) {
        ...
        for (let n of o) if (n.uri.toString() === i) return Re.create(i, this._languageId, n.version, n.getValue());
        return null;
      }
    };
    function Ri(t, i) {
