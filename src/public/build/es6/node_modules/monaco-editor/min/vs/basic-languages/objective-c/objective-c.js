...
define("vs/basic-languages/objective-c/objective-c", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = (o, e) => {
      ...
      d = (o, e, n, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of c(e)) !a.call(o, t) && (n || t !== "default") && s(o, t, {
          get: () => e[t],
          enumerable: !(i = r(e, t)) || i.enumerable
        });
        return o;
      };
    var g = (o => (e, n) => o && o.get(e) || (n = d(l({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    p(f, {
      conf: () => m,
      language: () => u
