...
define("vs/basic-languages/go/go", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = n => s(n, "__esModule", {
      value: !0
    });
    var l = (n, e) => {
        for (var o in e) s(n, o, {
          get: e[o],
          enumerable: !0
        });
      },
      g = (n, e, o, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !c.call(n, t) && (o || t !== "default") && s(n, t, {
          get: () => e[t],
          enumerable: !(r = i(e, t)) || r.enumerable
        });
        return n;
      };
    var p = (n => (e, o) => n && n.get(e) || (o = g(m({}), e, 1), n && n.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    l(f, {
      conf: () => u,
      language: () => d
