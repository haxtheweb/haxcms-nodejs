...
define("vs/basic-languages/java/java", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (t, e) => {
      ...
      g = (t, e, n, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of r(e)) !c.call(t, o) && (n || o !== "default") && s(t, o, {
          get: () => e[o],
          enumerable: !(i = a(e, o)) || i.enumerable
        });
        return t;
      };
    var m = (t => (e, n) => t && t.get(e) || (n = g(l({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    d(u, {
      conf: () => p,
      language: () => f
