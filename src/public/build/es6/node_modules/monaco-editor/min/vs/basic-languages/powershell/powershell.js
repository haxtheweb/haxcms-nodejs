...
define("vs/basic-languages/powershell/powershell", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var g = (n, e) => {
      ...
      p = (n, e, s, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of i(e)) !l.call(n, t) && (s || t !== "default") && o(n, t, {
          get: () => e[t],
          enumerable: !(a = r(e, t)) || a.enumerable
        });
        return n;
      };
    var d = (n => (e, s) => n && n.get(e) || (s = p(c({}), e, 1), n && n.set(e, s), s))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    g(f, {
      conf: () => m,
      language: () => u
