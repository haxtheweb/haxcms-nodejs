...
define("vs/basic-languages/powerquery/powerquery", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = (t, e) => {
      ...
      u = (t, e, a, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of s(e)) !l.call(t, n) && (a || n !== "default") && i(t, n, {
          get: () => e[n],
          enumerable: !(o = r(e, n)) || o.enumerable
        });
        return t;
      };
    var d = (t => (e, a) => t && t.get(e) || (a = u(T({}), e, 1), t && t.set(e, a), a))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var y = {};
    m(y, {
      conf: () => c,
      language: () => b
