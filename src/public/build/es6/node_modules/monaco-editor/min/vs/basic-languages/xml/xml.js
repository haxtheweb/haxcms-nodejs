...
define("vs/basic-languages/xml/xml", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var w = (e, t) => () => (t || e((t = {
      ...
      m = (e, t, n, r) => {
        if (t && typeof t == "object" || typeof t == "function") for (let o of p(t)) !x.call(e, o) && (n || o !== "default") && i(e, o, {
          get: () => t[o],
          enumerable: !(r = g(t, o)) || r.enumerable
        });
        return e;
      },
      c = (e, t) => m(l(i(e != null ? u(k(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      q = (e => (t, n) => e && e.get(t) || (n = m(l({}), t, 1), e && e.set(t, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var s = w((v, d) => {
