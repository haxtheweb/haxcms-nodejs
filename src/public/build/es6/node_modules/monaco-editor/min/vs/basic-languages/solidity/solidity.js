...
define("vs/basic-languages/solidity/solidity", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var o = e => f(e, "__esModule", {
      value: !0
    });
    var r = (e, x) => {
        for (var i in x) f(e, i, {
          get: x[i],
          enumerable: !0
        });
      },
      a = (e, x, i, u) => {
        if (x && typeof x == "object" || typeof x == "function") for (let d of n(x)) !s.call(e, d) && (i || d !== "default") && f(e, d, {
          get: () => x[d],
          enumerable: !(u = t(x, d)) || u.enumerable
        });
        return e;
      };
    var c = (e => (x, i) => e && e.get(x) || (i = a(o({}), x, 1), e && e.set(x, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    r(b, {
      conf: () => m,
      language: () => l
