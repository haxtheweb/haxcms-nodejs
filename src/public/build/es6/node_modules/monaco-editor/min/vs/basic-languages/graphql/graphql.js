...
define("vs/basic-languages/graphql/graphql", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (n, e) => {
      ...
      p = (n, e, o, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of i(e)) !l.call(n, t) && (o || t !== "default") && s(n, t, {
          get: () => e[t],
          enumerable: !(r = a(e, t)) || r.enumerable
        });
        return n;
      };
    var g = (n => (e, o) => n && n.get(e) || (o = p(c({}), e, 1), n && n.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var m = {};
    d(m, {
      conf: () => I,
      language: () => u
