...
define("vs/basic-languages/systemverilog/systemverilog", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = (n, e) => {
      ...
      p = (n, e, i, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !c.call(n, t) && (i || t !== "default") && r(n, t, {
          get: () => e[t],
          enumerable: !(o = s(e, t)) || o.enumerable
        });
        return n;
      };
    var u = (n => (e, i) => n && n.get(e) || (i = p(d({}), e, 1), n && n.set(e, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var g = {};
    l(g, {
      conf: () => m,
      language: () => f
