...
define("vs/basic-languages/restructuredtext/restructuredtext", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = (n, e) => {
      ...
      p = (n, e, s, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of l(e)) !r.call(n, i) && (s || i !== "default") && t(n, i, {
          get: () => e[i],
          enumerable: !(o = a(e, i)) || o.enumerable
        });
        return n;
      };
    var u = (n => (e, s) => n && n.get(e) || (s = p(k({}), e, 1), n && n.set(e, s), s))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    c(f, {
      conf: () => m,
      language: () => g
