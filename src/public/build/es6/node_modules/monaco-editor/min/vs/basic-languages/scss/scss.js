...
define("vs/basic-languages/scss/scss", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = (t, e) => {
      ...
      s = (t, e, n, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of l(e)) !d.call(t, o) && (n || o !== "default") && i(t, o, {
          get: () => e[o],
          enumerable: !(r = a(e, o)) || r.enumerable
        });
        return t;
      };
    var u = (t => (e, n) => t && t.get(e) || (n = s(c({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    m(f, {
      conf: () => p,
      language: () => k
