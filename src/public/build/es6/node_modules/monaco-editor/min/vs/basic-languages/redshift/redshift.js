...
define("vs/basic-languages/redshift/redshift", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = _ => i(_, "__esModule", {
      value: !0
    });
    var l = (_, e) => {
        for (var t in e) i(_, t, {
          get: e[t],
          enumerable: !0
        });
      },
      g = (_, e, t, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of o(e)) !n.call(_, r) && (t || r !== "default") && i(_, r, {
          get: () => e[r],
          enumerable: !(a = s(e, r)) || a.enumerable
        });
        return _;
      };
    var c = (_ => (e, t) => _ && _.get(e) || (t = g(p({}), e, 1), _ && _.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    l(u, {
      conf: () => d,
      language: () => m
