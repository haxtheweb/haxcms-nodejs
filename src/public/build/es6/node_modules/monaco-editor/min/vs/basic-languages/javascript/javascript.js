...
define("vs/basic-languages/javascript/javascript", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var w = (e, t) => () => (t || e((t = {
      ...
      a = (e, t, o, c) => {
        if (t && typeof t == "object" || typeof t == "function") for (let i of f(t)) !k.call(e, i) && (o || i !== "default") && s(e, i, {
          get: () => t[i],
          enumerable: !(c = u(t, i)) || c.enumerable
        });
        return e;
      },
      p = (e, t) => a(g(s(e != null ? x(b(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      v = (e => (t, o) => e && e.get(t) || (o = a(g({}), t, 1), e && e.set(t, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = w((C, l) => {
