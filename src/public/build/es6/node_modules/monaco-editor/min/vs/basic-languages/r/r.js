...
define("vs/basic-languages/r/r", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = o => a(o, "__esModule", {
      value: !0
    });
    var p = (o, e) => {
        for (var r in e) a(o, r, {
          get: e[r],
          enumerable: !0
        });
      },
      m = (o, e, r, n) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of i(e)) !c.call(o, t) && (r || t !== "default") && a(o, t, {
          get: () => e[t],
          enumerable: !(n = s(e, t)) || n.enumerable
        });
        return o;
      };
    var d = (o => (e, r) => o && o.get(e) || (r = m(l({}), e, 1), o && o.set(e, r), r))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    p(f, {
      conf: () => g,
      language: () => u
