...
define("vs/basic-languages/cpp/cpp", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = (n, e) => {
      ...
      d = (n, e, t, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of s(e)) !_.call(n, i) && (t || i !== "default") && r(n, i, {
          get: () => e[i],
          enumerable: !(o = a(e, i)) || o.enumerable
        });
        return n;
      };
    var p = (n => (e, t) => n && n.get(e) || (t = d(c({}), e, 1), n && n.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    l(u, {
      conf: () => m,
      language: () => g
