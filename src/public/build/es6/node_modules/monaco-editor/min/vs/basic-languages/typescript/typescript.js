...
define("vs/basic-languages/typescript/typescript", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var k = (e, t) => () => (t || e((t = {
      ...
      s = (e, t, n, c) => {
        if (t && typeof t == "object" || typeof t == "function") for (let r of x(t)) !u.call(e, r) && (n || r !== "default") && i(e, r, {
          get: () => t[r],
          enumerable: !(c = m(t, r)) || c.enumerable
        });
        return e;
      },
      p = (e, t) => s(a(i(e != null ? l(b(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      w = (e => (t, n) => e && e.get(t) || (n = s(a({}), t, 1), e && e.set(t, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = k((T, g) => {
