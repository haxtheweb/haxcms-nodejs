...
define("vs/language/css/cssMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var an = (n, t) => () => (t || n((t = {
      ...
      un = (n, t) => {
        for (var i in t) K(n, i, {
          get: t[i],
          enumerable: !0
        });
      },
      U = (n, t, i, r) => {
        if (t && typeof t == "object" || typeof t == "function") for (let e of tn(t)) !on.call(n, e) && (i || e !== "default") && K(n, e, {
          get: () => t[e],
          enumerable: !(r = nn(t, e)) || r.enumerable
        });
        return n;
      },
      ge = (n, t) => U(le(K(n != null ? en(rn(n)) : {}, "default", !t && n && n.__esModule ? {
        get: () => n.default,
        enumerable: !0
      } : {
        value: n,
      ...
      dn = (n => (t, i) => n && n.get(t) || (i = U(le({}), t, 1), n && n.set(t, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var pe = an((Pn, fe) => {
    ...
    (function (n) {
      function t(r, e) {
        return r === Number.MAX_VALUE && (r = O.MAX_VALUE), e === Number.MAX_VALUE && (e = O.MAX_VALUE), {
          line: r,
          character: e
        };
      }
    ...
    (function (n) {
      function t(r, e, o, s) {
        if (a.uinteger(r) && a.uinteger(e) && a.uinteger(o) && a.uinteger(s)) return {
          start: x.create(r, e),
          end: x.create(o, s)
        };
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return a.defined(e) && v.is(e.targetRange) && a.string(e.targetUri) && (v.is(e.targetSelectionRange) || a.undefined(e.targetSelectionRange)) && (v.is(e.originSelectionRange) || a.undefined(e.originSelectionRange));
      }
      n.is = i;
    })(me || (me = {}));
    var oe;
    ...
    (function (n) {
      function t(r, e, o, s, u) {
        ...
        return a.defined(o) && (l.startCharacter = o), a.defined(s) && (l.endCharacter = s), a.defined(u) && (l.kind = u), l;
      }
      n.create = t;
      function i(r) {
        var e = r;
    ...
    (function (n) {
      function t(r, e, o, s, u, l) {
        ...
        return a.defined(o) && (f.severity = o), a.defined(s) && (f.code = s), a.defined(u) && (f.source = u), a.defined(l) && (f.relatedInformation = l), f;
      }
      n.create = t;
      function i(r) {
        var e,
          o = r;
        return a.defined(o) && v.is(o.range) && a.string(o.message) && (a.number(o.severity) || a.undefined(o.severity)) && (a.integer(o.code) || a.string(o.code) || a.undefined(o.code)) && (a.undefined(o.codeDescription) || a.string((e = o.codeDescription) === null || e === void 0 ? void 0 : e.href)) && (a.string(o.source) || a.undefined(o.source)) && (a.undefined(o.relatedInformation) || a.typedArray(o.relatedInformation, se.is));
      }
      n.is = i;
    })(N || (N = {}));
    var D;
    ...
    (function (n) {
      function t(r, e, o) {
        ...
        return e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (s.options = e), o !== void 0 && (s.annotationId = o), s;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && e.kind === "create" && a.string(e.uri) && (e.options === void 0 || (e.options.overwrite === void 0 || a.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || a.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || y.is(e.annotationId));
      }
      n.is = i;
    })(L || (L = {}));
    var A;
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return e && e.kind === "rename" && a.string(e.oldUri) && a.string(e.newUri) && (e.options === void 0 || (e.options.overwrite === void 0 || a.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || a.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || y.is(e.annotationId));
      }
      n.is = i;
    })(A || (A = {}));
    var F;
    (function (n) {
      function t(r, e, o) {
        ...
        return e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (s.options = e), o !== void 0 && (s.annotationId = o), s;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && e.kind === "delete" && a.string(e.uri) && (e.options === void 0 || (e.options.recursive === void 0 || a.boolean(e.options.recursive)) && (e.options.ignoreIfNotExists === void 0 || a.boolean(e.options.ignoreIfNotExists))) && (e.annotationId === void 0 || y.is(e.annotationId));
      }
      n.is = i;
    })(F || (F = {}));
    var ae;
    ...
    var j = function () {
        ...
        return n.prototype.insert = function (t, i, r) {
          var e, o;
          if (r === void 0 ? e = C.insert(t, i) : y.is(r) ? (o = r, e = I.insert(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), o = this.changeAnnotations.manage(r), e = I.insert(t, i, o)), this.edits.push(e), o !== void 0) return o;
        }, n.prototype.replace = function (t, i, r) {
          var e, o;
          if (r === void 0 ? e = C.replace(t, i) : y.is(r) ? (o = r, e = I.replace(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), o = this.changeAnnotations.manage(r), e = I.replace(t, i, o)), this.edits.push(e), o !== void 0) return o;
        }, n.prototype.delete = function (t, i) {
          var r, e;
          if (i === void 0 ? r = C.del(t) : y.is(i) ? (e = i, r = I.del(t, i)) : (this.assertChangeAnnotations(this.changeAnnotations), e = this.changeAnnotations.manage(i), r = I.del(t, e)), this.edits.push(r), e !== void 0) return e;
      ...
      Ie = function () {
        ...
        return n.prototype.all = function () {
          ...
          var r;
          if (y.is(t) ? r = t : (r = this.nextId(), i = t), this._annotations[r] !== void 0) throw new Error("Id " + r + " is already in use.");
        ...
        return Object.defineProperty(n.prototype, "edit", {
          ...
          if (z.is(t)) {
            ...
            if (!r) {
              ...
              this._workspaceEdit.documentChanges.push(o), r = new j(e, this._changeAnnotations), this._textEditChanges[i.uri] = r;
            }
            return r;
          } else {
            ...
            if (!r) {
              var e = [];
              this._workspaceEdit.changes[t] = e, r = new j(e), this._textEditChanges[t] = r;
            }
            return r;
          }
          ...
          var o, s;
          if (e === void 0 ? o = L.create(t, r) : (s = y.is(e) ? e : this._changeAnnotations.manage(e), o = L.create(t, r, s)), this._workspaceEdit.documentChanges.push(o), s !== void 0) return s;
        }, n.prototype.renameFile = function (t, i, r, e) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var o;
          E.is(r) || y.is(r) ? o = r : e = r;
          var s, u;
          if (o === void 0 ? s = A.create(t, i, e) : (u = y.is(o) ? o : this._changeAnnotations.manage(o), s = A.create(t, i, e, u)), this._workspaceEdit.documentChanges.push(s), u !== void 0) return u;
        }, n.prototype.deleteFile = function (t, i, r) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var e;
          E.is(i) || y.is(i) ? e = i : r = i;
          var o, s;
          if (e === void 0 ? o = F.create(t, r) : (s = y.is(e) ? e : this._changeAnnotations.manage(e), o = F.create(t, r, s)), this._workspaceEdit.documentChanges.push(o), s !== void 0) return s;
        }, n;
      }();
    var Ce;
    (function (n) {
    ...
    (function (n) {
      function t(i) {
        var r = i;
        return !!r && a.objectLiteral(r) && (ue.is(r.contents) || B.is(r.contents) || a.typedArray(r.contents, B.is)) && (i.range === void 0 || v.is(i.range));
      }
      n.is = t;
    })(We || (We = {}));
    var De;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return e && a.string(e.name) && a.number(e.kind) && v.is(e.range) && v.is(e.selectionRange) && (e.detail === void 0 || a.string(e.detail)) && (e.deprecated === void 0 || a.boolean(e.deprecated)) && (e.children === void 0 || Array.isArray(e.children)) && (e.tags === void 0 || Array.isArray(e.tags));
      }
      n.is = i;
    })(He || (He = {}));
    var Ke;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return a.defined(e) && a.typedArray(e.diagnostics, N.is) && (e.only === void 0 || a.typedArray(e.only, a.string));
      }
      n.is = i;
    })(Ue || (Ue = {}));
    var je;
    (function (n) {
      function t(r, e, o) {
        var s = {
          ...
          u = !0;
        return typeof e == "string" ? (u = !1, s.kind = e) : D.is(e) ? s.command = e : s.edit = e, u && o !== void 0 && (s.kind = o), s;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && a.string(e.title) && (e.diagnostics === void 0 || a.typedArray(e.diagnostics, N.is)) && (e.kind === void 0 || a.string(e.kind)) && (e.edit !== void 0 || e.command !== void 0) && (e.command === void 0 || D.is(e.command)) && (e.isPreferred === void 0 || a.boolean(e.isPreferred)) && (e.edit === void 0 || ae.is(e.edit));
      }
      n.is = i;
    })(je || (je = {}));
    var Oe;
    ...
    (function (n) {
      ...
      n.is = i;
      function r(o, s) {
        for (var u = o.getText(), l = e(s, function (w, H) {
            var ce = w.range.start.line - H.range.start.line;
            return ce === 0 ? w.range.start.character - H.range.start.character : ce;
          }), f = u.length, g = l.length - 1; g >= 0; g--) {
          var m = l[g],
            k = o.offsetAt(m.range.start),
            c = o.offsetAt(m.range.end);
          if (c <= f) u = u.substring(0, k) + m.newText + u.substring(c, u.length);else throw new Error("Overlapping edit");
          f = k;
        }
        return u;
      }
...
` && e++;
    ...
    var $ = class {
      constructor(t, i, r) {
        ...
        this._disposables.push(d.editor.onDidCreateModel(e)), this._disposables.push(d.editor.onWillDisposeModel(o)), this._disposables.push(d.editor.onDidChangeModelLanguage(s => {
          o(s.model), e(s.model);
        })), this._disposables.push(r(s => {
    ...
    var q = class {
      ...
      provideCompletionItems(t, i, r, e) {
        let o = t.uri;
        return this._worker(o).then(s => s.doComplete(o.toString(), _(i))).then(s => {
          if (!s) return;
          let u = t.getWordUntilPosition(i),
            ...
            f = s.items.map(g => {
              ...
              return g.textEdit && (mn(g.textEdit) ? m.range = {
                insert: T(g.textEdit.insert),
                replace: T(g.textEdit.replace)
              } : m.range = T(g.textEdit.range), m.insertText = g.textEdit.newText), g.additionalTextEdits && (m.additionalTextEdits = g.additionalTextEdits.map(S)), g.insertTextFormat === X.Snippet && (m.insertTextRules = d.languages.CompletionItemInsertTextRule.InsertAsSnippet), m;
            });
          return {
    ...
    var Q = class {
      ...
      provideHover(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.doHover(e.toString(), _(i))).then(o => {
          if (!!o) return {
            range: T(o.range),
...
` + n.value + "\n```\n"
    ...
    var G = class {
      ...
      provideDocumentHighlights(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.findDocumentHighlights(e.toString(), _(i))).then(o => {
          if (!!o) return o.map(s => ({
            range: T(s.range),
            kind: kn(s.kind)
          }));
    ...
    var J = class {
      ...
      provideDefinition(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.findDefinition(e.toString(), _(i))).then(o => {
          if (!!o) return [$e(o)];
        });
      }
    };
    ...
    var Y = class {
        ...
        provideReferences(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(s => s.findReferences(o.toString(), _(i))).then(s => {
            if (!!s) return s.map($e);
          });
        }
      },
      Z = class {
        ...
        provideRenameEdits(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(s => s.doRename(o.toString(), _(i), r)).then(s => In(s));
        }
      };
    function In(n) {
    ...
    var qe = class {
      ...
      Qe = class {
        ...
        provideDocumentFormattingEdits(t, i, r) {
          let e = t.uri;
          return this._worker(e).then(o => o.format(e.toString(), null, Je(i)).then(s => {
      ...
      Ge = class {
        ...
        provideDocumentRangeFormattingEdits(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(s => s.format(o.toString(), de(i), Je(r)).then(u => {
    ...
    var ne = class {
        ...
        provideColorPresentations(t, i, r) {
          let e = t.uri;
          return this._worker(e).then(o => o.getColorPresentations(e.toString(), i.color, de(i.range))).then(o => {
            if (!!o) return o.map(s => {
              let u = {
                label: s.label
              };
              return s.textEdit && (u.textEdit = S(s.textEdit)), s.additionalTextEdits && (u.additionalTextEdits = s.additionalTextEdits.map(S)), u;
            });
          });
        }
      },
    ...
    var re = class {
      ...
      provideSelectionRanges(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.getSelectionRanges(e.toString(), i.map(_))).then(o => {
          if (!!o) return o.map(s => {
            let u = [];
            for (; s;) u.push({
              range: T(s.range)
    ...
    function wn(n) {
      ...
      function o() {
        ...
        Ze(i), u.completionItems && i.push(d.languages.registerCompletionItemProvider(s, new q(e, ["/", "-", ":"]))), u.hovers && i.push(d.languages.registerHoverProvider(s, new Q(e))), u.documentHighlights && i.push(d.languages.registerDocumentHighlightProvider(s, new G(e))), u.definitions && i.push(d.languages.registerDefinitionProvider(s, new J(e))), u.references && i.push(d.languages.registerReferenceProvider(s, new Y(e))), u.documentSymbols && i.push(d.languages.registerDocumentSymbolProvider(s, new ee(e))), u.rename && i.push(d.languages.registerRenameProvider(s, new Z(e))), u.colors && i.push(d.languages.registerColorProvider(s, new ne(e))), u.foldingRanges && i.push(d.languages.registerFoldingRangeProvider(s, new te(e))), u.diagnostics && i.push(new $(s, e, n.onDidChange)), u.selectionRanges && i.push(d.languages.registerSelectionRangeProvider(s, new re(e)));
      }
