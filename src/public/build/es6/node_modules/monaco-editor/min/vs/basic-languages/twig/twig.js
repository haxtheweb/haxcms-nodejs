...
define("vs/basic-languages/twig/twig", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var s = e => m(e, "__esModule", {
      value: !0
    });
    var d = (e, t) => {
        for (var i in t) m(e, i, {
          get: t[i],
          enumerable: !0
        });
      },
      p = (e, t, i, o) => {
        if (t && typeof t == "object" || typeof t == "function") for (let r of n(t)) !a.call(e, r) && (i || r !== "default") && m(e, r, {
          get: () => t[r],
          enumerable: !(o = l(t, r)) || o.enumerable
        });
        return e;
      };
    var h = (e => (t, i) => e && e.get(t) || (i = p(s({}), t, 1), e && e.set(t, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    d(u, {
      conf: () => c,
      language: () => g
