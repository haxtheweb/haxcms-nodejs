...
define("vs/basic-languages/fsharp/fsharp", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var g = (n, e) => {
        for (var t in e) s(n, t, {
          get: e[t],
          enumerable: !0
        });
      },
      f = (n, e, t, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of a(e)) !l.call(n, o) && (t || o !== "default") && s(n, o, {
          get: () => e[o],
          enumerable: !(i = r(e, o)) || i.enumerable
        });
        return n;
      };
    var m = (n => (e, t) => n && n.get(e) || (t = f(c({}), e, 1), n && n.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var p = {};
    g(p, {
      conf: () => u,
      language: () => d
