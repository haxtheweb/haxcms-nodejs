...
define("vs/basic-languages/apex/apex", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var g = (e, t) => {
      ...
      p = (e, t, o, a) => {
        if (t && typeof t == "object" || typeof t == "function") for (let s of c(t)) !l.call(e, s) && (o || s !== "default") && i(e, s, {
          get: () => t[s],
          enumerable: !(a = r(t, s)) || a.enumerable
        });
        return e;
      };
    var m = (e => (t, o) => e && e.get(t) || (o = p(d({}), t, 1), e && e.set(t, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var y = {};
    g(y, {
      conf: () => u,
      language: () => h
