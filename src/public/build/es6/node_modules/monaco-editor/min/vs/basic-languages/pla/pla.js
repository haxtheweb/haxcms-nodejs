...
define("vs/basic-languages/pla/pla", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = o => s(o, "__esModule", {
      value: !0
    });
    var c = (o, e) => {
        for (var t in e) s(o, t, {
          get: e[t],
          enumerable: !0
        });
      },
      d = (o, e, t, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of r(e)) !p.call(o, n) && (t || n !== "default") && s(o, n, {
          get: () => e[n],
          enumerable: !(i = a(e, n)) || i.enumerable
        });
        return o;
      };
    var k = (o => (e, t) => o && o.get(e) || (t = d(l({}), e, 1), o && o.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    c(f, {
      conf: () => m,
      language: () => u
