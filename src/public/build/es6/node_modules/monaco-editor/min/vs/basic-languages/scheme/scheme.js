...
define("vs/basic-languages/scheme/scheme", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = (o, e) => {
      ...
      p = (o, e, n, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of i(e)) !l.call(o, t) && (n || t !== "default") && s(o, t, {
          get: () => e[t],
          enumerable: !(a = r(e, t)) || a.enumerable
        });
        return o;
      };
    var d = (o => (e, n) => o && o.get(e) || (n = p(c({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    m(f, {
      conf: () => g,
      language: () => u
