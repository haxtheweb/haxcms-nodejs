...
define("vs/basic-languages/yaml/yaml", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var s = (n, e) => {
      ...
      d = (n, e, t, l) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of i(e)) !c.call(n, r) && (t || r !== "default") && o(n, r, {
          get: () => e[r],
          enumerable: !(l = a(e, r)) || l.enumerable
        });
        return n;
      };
    var m = (n => (e, t) => n && n.get(e) || (t = d(u({}), e, 1), n && n.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var p = {};
    s(p, {
      conf: () => b,
      language: () => g
