...
define("vs/basic-languages/dart/dart", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var g = (n, e) => {
      ...
      l = (n, e, o, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of c(e)) !a.call(n, t) && (o || t !== "default") && r(n, t, {
          get: () => e[t],
          enumerable: !(s = i(e, t)) || s.enumerable
        });
        return n;
      };
    var d = (n => (e, o) => n && n.get(e) || (o = l(p({}), e, 1), n && n.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    g(u, {
      conf: () => m,
      language: () => x
