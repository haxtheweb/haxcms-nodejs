...
define("vs/basic-languages/kotlin/kotlin", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (n, e) => {
      ...
      g = (n, e, t, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of r(e)) !c.call(n, i) && (t || i !== "default") && o(n, i, {
          get: () => e[i],
          enumerable: !(s = a(e, i)) || s.enumerable
        });
        return n;
      };
    var m = (n => (e, t) => n && n.get(e) || (t = g(l({}), e, 1), n && n.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    d(u, {
      conf: () => p,
      language: () => f
