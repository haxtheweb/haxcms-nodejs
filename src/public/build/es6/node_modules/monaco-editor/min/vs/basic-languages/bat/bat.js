...
define("vs/basic-languages/bat/bat", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var g = o => n(o, "__esModule", {
      value: !0
    });
    var c = (o, e) => {
        for (var s in e) n(o, s, {
          get: e[s],
          enumerable: !0
        });
      },
      p = (o, e, s, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of l(e)) !i.call(o, t) && (s || t !== "default") && n(o, t, {
          get: () => e[t],
          enumerable: !(a = r(e, t)) || a.enumerable
        });
        return o;
      };
    var d = (o => (e, s) => o && o.get(e) || (s = p(g({}), e, 1), o && o.set(e, s), s))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    c(u, {
      conf: () => m,
      language: () => k
