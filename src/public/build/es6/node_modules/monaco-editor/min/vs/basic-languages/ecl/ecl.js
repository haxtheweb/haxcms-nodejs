...
define("vs/basic-languages/ecl/ecl", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (o, e) => {
      ...
      p = (o, e, n, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of s(e)) !l.call(o, t) && (n || t !== "default") && r(o, t, {
          get: () => e[t],
          enumerable: !(a = i(e, t)) || a.enumerable
        });
        return o;
      };
    var m = (o => (e, n) => o && o.get(e) || (n = p(c({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    d(f, {
      conf: () => u,
      language: () => g
