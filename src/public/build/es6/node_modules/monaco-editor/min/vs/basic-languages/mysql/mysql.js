...
define("vs/basic-languages/mysql/mysql", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var o = T => A(T, "__esModule", {
      value: !0
    });
    var O = (T, E) => {
        for (var S in E) A(T, S, {
          get: E[S],
          enumerable: !0
        });
      },
      t = (T, E, S, _) => {
        if (E && typeof E == "object" || typeof E == "function") for (let R of I(E)) !N.call(T, R) && (S || R !== "default") && A(T, R, {
          get: () => E[R],
          enumerable: !(_ = e(E, R)) || _.enumerable
        });
        return T;
      };
    var n = (T => (E, S) => T && T.get(E) || (S = t(o({}), E, 1), T && T.set(E, S), S))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var i = {};
    O(i, {
      conf: () => C,
      language: () => L
