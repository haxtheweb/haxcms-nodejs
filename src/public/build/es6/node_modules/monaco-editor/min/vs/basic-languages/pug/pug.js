...
define("vs/basic-languages/pug/pug", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = (t, e) => {
      ...
      d = (t, e, n, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of l(e)) !r.call(t, o) && (n || o !== "default") && a(t, o, {
          get: () => e[o],
          enumerable: !(s = i(e, o)) || s.enumerable
        });
        return t;
      };
    var m = (t => (e, n) => t && t.get(e) || (n = d(p({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var k = {};
    c(k, {
      conf: () => u,
      language: () => g
