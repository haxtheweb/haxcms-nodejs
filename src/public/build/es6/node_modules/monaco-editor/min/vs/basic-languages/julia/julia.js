...
define("vs/basic-languages/julia/julia", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = (t, e) => {
      ...
      d = (t, e, r, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of s(e)) !p.call(t, n) && (r || n !== "default") && o(t, n, {
          get: () => e[n],
          enumerable: !(a = i(e, n)) || a.enumerable
        });
        return t;
      };
    var g = (t => (e, r) => t && t.get(e) || (r = d(c({}), e, 1), t && t.set(e, r), r))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var y = {};
    l(y, {
      conf: () => m,
      language: () => u
