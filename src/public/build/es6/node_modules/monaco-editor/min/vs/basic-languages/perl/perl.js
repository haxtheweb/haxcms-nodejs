...
define("vs/basic-languages/perl/perl", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var $ = (t, e) => {
      ...
      c = (t, e, s, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of l(e)) !d.call(t, n) && (s || n !== "default") && r(t, n, {
          get: () => e[n],
          enumerable: !(i = o(e, n)) || i.enumerable
        });
        return t;
      };
    var g = (t => (e, s) => t && t.get(e) || (s = c(a({}), e, 1), t && t.set(e, s), s))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var E = {};
    $(E, {
      conf: () => p,
      language: () => m
