...
define("vs/basic-languages/sophia/sophia", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = (t, e) => {
      ...
      d = (t, e, n, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of a(e)) !c.call(t, o) && (n || o !== "default") && s(t, o, {
          get: () => e[o],
          enumerable: !(r = i(e, o)) || r.enumerable
        });
        return t;
      };
    var f = (t => (e, n) => t && t.get(e) || (n = d(l({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var p = {};
    m(p, {
      conf: () => g,
      language: () => u
