...
define("vs/basic-languages/clojure/clojure", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = (t, e) => {
      ...
      p = (t, e, n, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of i(e)) !c.call(t, r) && (n || r !== "default") && a(t, r, {
          get: () => e[r],
          enumerable: !(s = o(e, r)) || s.enumerable
        });
        return t;
      };
    var u = (t => (e, n) => t && t.get(e) || (n = p(d({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    l(f, {
      conf: () => m,
      language: () => h
