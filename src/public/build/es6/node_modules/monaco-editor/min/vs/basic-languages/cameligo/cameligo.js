...
define("vs/basic-languages/cameligo/cameligo", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = (o, e) => {
      ...
      p = (o, e, t, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of a(e)) !l.call(o, n) && (t || n !== "default") && s(o, n, {
          get: () => e[n],
          enumerable: !(r = i(e, n)) || r.enumerable
        });
        return o;
      };
    var d = (o => (e, t) => o && o.get(e) || (t = p(c({}), e, 1), o && o.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var k = {};
    m(k, {
      conf: () => g,
      language: () => u
