...
define("vs/basic-languages/freemarker2/freemarker2", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var m = t => s(t, "__esModule", {
      value: !0
    });
    var w = (t => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(t, {
    ...
    var h = (t, n) => () => (n || t((n = {
      ...
      S = (t, n) => {
        for (var i in n) s(t, i, {
          get: n[i],
          enumerable: !0
        });
      },
      d = (t, n, i, e) => {
        if (n && typeof n == "object" || typeof n == "function") for (let o of D(n)) !v.call(t, o) && (i || o !== "default") && s(t, o, {
          get: () => n[o],
          enumerable: !(e = C(n, o)) || e.enumerable
        });
        return t;
      },
      x = (t, n) => d(m(s(t != null ? B(T(t)) : {}, "default", !n && t && t.__esModule ? {
        get: () => t.default,
        enumerable: !0
      } : {
        value: t,
      ...
      I = (t => (n, i) => t && t.get(n) || (i = d(m({}), n, 1), t && t.set(n, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var F = h((q, f) => {
...
\r	 }]),.:;=`,
        ...
        onEnterRules: [{
          beforeText: new RegExp(`${t.open}#(?!(?:${l.join("|")}))([a-zA-Z_]+)([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`),
    ...
    function a(t, n) {
      ...
      return {
        ...
        tokenizer: {
          ...
          [e("directive_token__id__")]: [[o(/(?:@startTag__id__)(@directiveStartCloseTag1)(?:@closeTag1__id__)/), t.id === "auto" ? {
            cases: {
              "$1==<": {
                token: "@rematch",
          ...
          [e("interpolation_and_text_token__id__")]: [[o(/(@iOpen1__id__)(@iOpen2__id__)/), [{
          ...
          [e("blank_and_expression_comment_token__id__")]: [[/(?:@blank)+/, {
            token: ""
          }], [/[<\[][#!]--/, {
            token: "comment",
            next: e("@expressionComment__id__")
          }]],
          [e("directive_end_token__id__")]: [[/>/, t.id === "bracket" ? {
            token: "operators"
          } : {
            token: "@brackets.directive",
            next: "@popall"
          ...
          [e("no_space_expression_end_token__id__")]: [[/(?:@blank)+/, {
            token: "",
            switchTo: e("@fmExpression__id__.directive")
          }]],
          [e("unified_call_token__id__")]: [[/(@id)((?:@blank)+)/, [{
            token: "tag"
          }, {
            token: "",
            next: e("@fmExpression__id__.directive")
          ...
          [e("no_parse_token__id__")]: [[o(/(@open__id__)(\/#?)([a-zA-Z]+)((?:@blank)*)(@close__id__)/), {
            cases: {
              "$S2==$3": [{
                token: "@brackets.directive"
              }, {
          ...
          [e("terse_comment_token__id__")]: [[o(/--(?:@close__id__)/), {
            token: "comment",
            next: "@popall"
          }], [/[^<\[\-]+|[<\[\-]/, {
            token: "comment"
