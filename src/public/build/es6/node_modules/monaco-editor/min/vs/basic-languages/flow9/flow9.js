...
define("vs/basic-languages/flow9/flow9", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = o => s(o, "__esModule", {
      value: !0
    });
    var m = (o, e) => {
        for (var n in e) s(o, n, {
          get: e[n],
          enumerable: !0
        });
      },
      p = (o, e, n, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !l.call(o, t) && (n || t !== "default") && s(o, t, {
          get: () => e[t],
          enumerable: !(i = r(e, t)) || i.enumerable
        });
        return o;
      };
    var g = (o => (e, n) => o && o.get(e) || (n = p(c({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = {};
    m(d, {
      conf: () => f,
      language: () => u
