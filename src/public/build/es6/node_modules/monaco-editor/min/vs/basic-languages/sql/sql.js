...
define("vs/basic-languages/sql/sql", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var e = (T, E) => {
      ...
      P = (T, E, R, N) => {
        if (E && typeof E == "object" || typeof E == "function") for (let A of O(E)) !C.call(T, A) && (R || A !== "default") && I(T, A, {
          get: () => E[A],
          enumerable: !(N = S(E, A)) || N.enumerable
        });
        return T;
      };
    var D = (T => (E, R) => T && T.get(E) || (R = P(L({}), E, 1), T && T.set(E, R), R))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var _ = {};
    e(_, {
      conf: () => U,
      language: () => M
