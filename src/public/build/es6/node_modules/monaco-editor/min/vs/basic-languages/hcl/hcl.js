...
define("vs/basic-languages/hcl/hcl", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (t, e) => {
      ...
      m = (t, e, s, n) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of i(e)) !c.call(t, o) && (s || o !== "default") && r(t, o, {
          get: () => e[o],
          enumerable: !(n = a(e, o)) || n.enumerable
        });
        return t;
      };
    var p = (t => (e, s) => t && t.get(e) || (s = m(l({}), e, 1), t && t.set(e, s), s))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    d(u, {
      conf: () => g,
      language: () => f
