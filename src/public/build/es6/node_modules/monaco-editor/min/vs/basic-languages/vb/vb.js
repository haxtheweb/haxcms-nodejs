...
define("vs/basic-languages/vb/vb", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = (n, e) => {
      ...
      u = (n, e, o, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of d(e)) !l.call(n, t) && (o || t !== "default") && r(n, t, {
          get: () => e[t],
          enumerable: !(s = a(e, t)) || s.enumerable
        });
        return n;
      };
    var g = (n => (e, o) => n && n.get(e) || (o = u(i({}), e, 1), n && n.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var y = {};
    c(y, {
      conf: () => p,
      language: () => k
