...
define("vs/basic-languages/shell/shell", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = r => a(r, "__esModule", {
      value: !0
    });
    var d = (r, e) => {
        for (var t in e) a(r, t, {
          get: e[t],
          enumerable: !0
        });
      },
      p = (r, e, t, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of n(e)) !l.call(r, i) && (t || i !== "default") && a(r, i, {
          get: () => e[i],
          enumerable: !(o = s(e, i)) || o.enumerable
        });
        return r;
      };
    var m = (r => (e, t) => r && r.get(e) || (t = p(c({}), e, 1), r && r.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var h = {};
    d(h, {
      conf: () => u,
      language: () => g
