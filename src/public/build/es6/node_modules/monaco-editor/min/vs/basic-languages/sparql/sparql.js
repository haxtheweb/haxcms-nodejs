...
define("vs/basic-languages/sparql/sparql", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = s => o(s, "__esModule", {
      value: !0
    });
    var c = (s, e) => {
        for (var t in e) o(s, t, {
          get: e[t],
          enumerable: !0
        });
      },
      g = (s, e, t, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of a(e)) !l.call(s, n) && (t || n !== "default") && o(s, n, {
          get: () => e[n],
          enumerable: !(r = i(e, n)) || r.enumerable
        });
        return s;
      };
    var u = (s => (e, t) => s && s.get(e) || (t = g(d({}), e, 1), s && s.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    c(f, {
      conf: () => p,
      language: () => m
