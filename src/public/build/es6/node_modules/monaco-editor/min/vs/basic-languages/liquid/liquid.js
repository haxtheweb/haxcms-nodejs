...
define("vs/basic-languages/liquid/liquid", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = e => r(e, "__esModule", {
      value: !0
    });
    var f = (e => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(e, {
    ...
    var b = (e, t) => () => (t || e((t = {
      ...
      a = (e, t, i, l) => {
        if (t && typeof t == "object" || typeof t == "function") for (let o of w(t)) !q.call(e, o) && (i || o !== "default") && r(e, o, {
          get: () => t[o],
          enumerable: !(l = g(t, o)) || l.enumerable
        });
        return e;
      },
      s = (e, t) => a(d(r(e != null ? p(h(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      k = (e => (t, i) => e && e.get(t) || (i = a(d({}), t, 1), e && e.set(t, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var c = b((y, u) => {
