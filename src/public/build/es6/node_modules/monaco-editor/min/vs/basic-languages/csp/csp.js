...
define("vs/basic-languages/csp/csp", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var a = r => o(r, "__esModule", {
      value: !0
    });
    var c = (r, t) => {
        for (var e in t) o(r, e, {
          get: t[e],
          enumerable: !0
        });
      },
      q = (r, t, e, n) => {
        if (t && typeof t == "object" || typeof t == "function") for (let s of u(t)) !g.call(r, s) && (e || s !== "default") && o(r, s, {
          get: () => t[s],
          enumerable: !(n = i(t, s)) || n.enumerable
        });
        return r;
      };
    var f = (r => (t, e) => r && r.get(t) || (e = q(a({}), t, 1), r && r.set(t, e), e))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = {};
    c(d, {
      conf: () => l,
      language: () => p
