...
define("vs/basic-languages/st/st", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = (n, e) => {
      ...
      _ = (n, e, o, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of c(e)) !i.call(n, t) && (o || t !== "default") && r(n, t, {
          get: () => e[t],
          enumerable: !(a = s(e, t)) || a.enumerable
        });
        return n;
      };
    var p = (n => (e, o) => n && n.get(e) || (o = _(d({}), e, 1), n && n.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    l(b, {
      conf: () => u,
      language: () => m
