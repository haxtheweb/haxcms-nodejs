...
define("vs/basic-languages/python/python", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = e => o(e, "__esModule", {
      value: !0
    });
    var b = (e => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(e, {
    ...
    var y = (e, n) => () => (n || e((n = {
      ...
      i = (e, n, t, a) => {
        if (n && typeof n == "object" || typeof n == "function") for (let r of _(n)) !f.call(e, r) && (t || r !== "default") && o(e, r, {
          get: () => n[r],
          enumerable: !(a = m(n, r)) || a.enumerable
        });
        return e;
      },
      c = (e, n) => i(l(o(e != null ? d(u(e)) : {}, "default", !n && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      x = (e => (n, t) => e && e.get(n) || (t = i(l({}), n, 1), e && e.set(n, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var g = y((v, p) => {
