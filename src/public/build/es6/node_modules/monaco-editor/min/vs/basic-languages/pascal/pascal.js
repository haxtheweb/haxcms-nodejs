...
define("vs/basic-languages/pascal/pascal", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (t, e) => {
      ...
      p = (t, e, o, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of a(e)) !l.call(t, r) && (o || r !== "default") && n(t, r, {
          get: () => e[r],
          enumerable: !(i = s(e, r)) || i.enumerable
        });
        return t;
      };
    var m = (t => (e, o) => t && t.get(e) || (o = p(c({}), e, 1), t && t.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    d(b, {
      conf: () => u,
      language: () => g
