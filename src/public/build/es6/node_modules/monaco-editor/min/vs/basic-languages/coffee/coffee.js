...
define("vs/basic-languages/coffee/coffee", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = (n, e) => {
      ...
      c = (n, e, r, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of g(e)) !a.call(n, t) && (r || t !== "default") && s(n, t, {
          get: () => e[t],
          enumerable: !(o = i(e, t)) || o.enumerable
        });
        return n;
      };
    var d = (n => (e, r) => n && n.get(e) || (r = c(l({}), e, 1), n && n.set(e, r), r))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    p(u, {
      conf: () => x,
      language: () => m
