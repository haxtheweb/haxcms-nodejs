...
define("vs/basic-languages/mips/mips", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (t, e) => {
      ...
      m = (t, e, r, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of o(e)) !g.call(t, n) && (r || n !== "default") && s(t, n, {
          get: () => e[n],
          enumerable: !(i = a(e, n)) || i.enumerable
        });
        return t;
      };
    var p = (t => (e, r) => t && t.get(e) || (r = m(l({}), e, 1), t && t.set(e, r), r))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var c = {};
    d(c, {
      conf: () => u,
      language: () => x
