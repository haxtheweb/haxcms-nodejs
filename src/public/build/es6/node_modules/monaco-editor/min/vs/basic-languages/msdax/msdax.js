...
define("vs/basic-languages/msdax/msdax", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var n = T => e(T, "__esModule", {
      value: !0
    });
    var t = (T, E) => {
        for (var A in E) e(T, A, {
          get: E[A],
          enumerable: !0
        });
      },
      L = (T, E, A, R) => {
        if (E && typeof E == "object" || typeof E == "function") for (let N of O(E)) !S.call(T, N) && (A || N !== "default") && e(T, N, {
          get: () => E[N],
          enumerable: !(R = I(E, N)) || R.enumerable
        });
        return T;
      };
    var C = (T => (E, A) => T && T.get(E) || (A = L(n({}), E, 1), T && T.set(E, A), A))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var i = {};
    t(i, {
      conf: () => o,
      language: () => D
