...
define("vs/basic-languages/m3/m3", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var R = o => r(o, "__esModule", {
      value: !0
    });
    var c = (o, e) => {
        for (var t in e) r(o, t, {
          get: e[t],
          enumerable: !0
        });
      },
      m = (o, e, t, n) => {
        if (e && typeof e == "object" || typeof e == "function") for (let s of a(e)) !i.call(o, s) && (t || s !== "default") && r(o, s, {
          get: () => e[s],
          enumerable: !(n = E(e, s)) || n.enumerable
        });
        return o;
      };
    var A = (o => (e, t) => o && o.get(e) || (t = m(R({}), e, 1), o && o.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var T = {};
    c(T, {
      conf: () => p,
      language: () => N
