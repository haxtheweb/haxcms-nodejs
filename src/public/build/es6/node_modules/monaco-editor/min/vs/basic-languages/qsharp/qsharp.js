...
define("vs/basic-languages/qsharp/qsharp", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var u = (t, e) => {
      ...
      p = (t, e, o, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of r(e)) !l.call(t, n) && (o || n !== "default") && a(t, n, {
          get: () => e[n],
          enumerable: !(s = i(e, n)) || s.enumerable
        });
        return t;
      };
    var d = (t => (e, o) => t && t.get(e) || (o = p(c({}), e, 1), t && t.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var w = {};
    u(w, {
      conf: () => g,
      language: () => m
