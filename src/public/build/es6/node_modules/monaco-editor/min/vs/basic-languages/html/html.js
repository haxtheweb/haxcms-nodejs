...
define("vs/basic-languages/html/html", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = e => o(e, "__esModule", {
      value: !0
    });
    var k = (e => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(e, {
    ...
    var E = (e, t) => () => (t || e((t = {
      ...
      a = (e, t, n, s) => {
        if (t && typeof t == "object" || typeof t == "function") for (let r of x(t)) !y.call(e, r) && (n || r !== "default") && o(e, r, {
          get: () => t[r],
          enumerable: !(s = b(t, r)) || s.enumerable
        });
        return e;
      },
      m = (e, t) => a(d(o(e != null ? u(g(e)) : {}, "default", !t && e && e.__esModule ? {
        get: () => e.default,
        enumerable: !0
      } : {
        value: e,
      ...
      T = (e => (t, n) => e && e.get(t) || (n = a(d({}), t, 1), e && e.set(t, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var l = E((C, p) => {
