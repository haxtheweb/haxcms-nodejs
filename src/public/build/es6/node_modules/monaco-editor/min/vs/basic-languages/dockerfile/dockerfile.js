...
define("vs/basic-languages/dockerfile/dockerfile", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = o => a(o, "__esModule", {
      value: !0
    });
    var g = (o, e) => {
        for (var n in e) a(o, n, {
          get: e[n],
          enumerable: !0
        });
      },
      c = (o, e, n, t) => {
        if (e && typeof e == "object" || typeof e == "function") for (let s of r(e)) !i.call(o, s) && (n || s !== "default") && a(o, s, {
          get: () => e[s],
          enumerable: !(t = l(e, s)) || t.enumerable
        });
        return o;
      };
    var u = (o => (e, n) => o && o.get(e) || (n = c(p({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    g(f, {
      conf: () => d,
      language: () => k
