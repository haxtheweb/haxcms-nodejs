...
define("vs/basic-languages/razor/razor", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var y = (t => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(t, {
    ...
    var T = (t, e) => () => (e || t((e = {
      ...
      m = (t, e, r, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of b(e)) !x.call(t, n) && (r || n !== "default") && i(t, n, {
          get: () => e[n],
          enumerable: !(a = u(e, n)) || a.enumerable
        });
        return t;
      },
      c = (t, e) => m(s(i(t != null ? h(k(t)) : {}, "default", !e && t && t.__esModule ? {
        get: () => t.default,
        enumerable: !0
      } : {
        value: t,
      ...
      g = (t => (e, r) => t && t.get(e) || (r = m(s({}), e, 1), t && t.set(e, r), r))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = T(($, l) => {
