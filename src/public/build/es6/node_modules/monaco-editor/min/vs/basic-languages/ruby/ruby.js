...
define("vs/basic-languages/ruby/ruby", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = t => o(t, "__esModule", {
      value: !0
    });
    var l = (t, e) => {
        for (var n in e) o(t, n, {
          get: e[n],
          enumerable: !0
        });
      },
      a = (t, e, n, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of c(e)) !d.call(t, r) && (n || r !== "default") && o(t, r, {
          get: () => e[r],
          enumerable: !(s = i(e, r)) || s.enumerable
        });
        return t;
      };
    var g = (t => (e, n) => t && t.get(e) || (n = a(p({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var k = {};
    l(k, {
      conf: () => x,
      language: () => m
