...
define("vs/basic-languages/tcl/tcl", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = (t, e) => {
      ...
      u = (t, e, n, i) => {
        if (e && typeof e == "object" || typeof e == "function") for (let o of a(e)) !l.call(t, o) && (n || o !== "default") && s(t, o, {
          get: () => e[o],
          enumerable: !(i = r(e, o)) || i.enumerable
        });
        return t;
      };
    var k = (t => (e, n) => t && t.get(e) || (n = u(c({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    p(b, {
      conf: () => d,
      language: () => g
