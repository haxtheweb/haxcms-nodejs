...
define("vs/basic-languages/lexon/lexon", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var p = (t, e) => {
      ...
      c = (t, e, o, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of d(e)) !a.call(t, i) && (o || i !== "default") && n(t, i, {
          get: () => e[i],
          enumerable: !(r = s(e, i)) || r.enumerable
        });
        return t;
      };
    var m = (t => (e, o) => t && t.get(e) || (o = c(l({}), e, 1), t && t.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var f = {};
    p(f, {
      conf: () => u,
      language: () => k
