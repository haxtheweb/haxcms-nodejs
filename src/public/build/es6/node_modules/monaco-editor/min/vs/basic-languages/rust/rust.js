...
define("vs/basic-languages/rust/rust", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var u = (t, e) => {
      ...
      l = (t, e, o, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of a(e)) !c.call(t, n) && (o || n !== "default") && r(t, n, {
          get: () => e[n],
          enumerable: !(s = i(e, n)) || s.enumerable
        });
        return t;
      };
    var f = (t => (e, o) => t && t.get(e) || (o = l(_({}), e, 1), t && t.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var d = {};
    u(d, {
      conf: () => p,
      language: () => m
