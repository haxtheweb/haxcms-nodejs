...
define("vs/basic-languages/protobuf/protobuf", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var d = (t, e) => {
      ...
      l = (t, e, n, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of c(e)) !a.call(t, i) && (n || i !== "default") && o(t, i, {
          get: () => e[i],
          enumerable: !(s = r(e, i)) || s.enumerable
        });
        return t;
      };
    var k = (t => (e, n) => t && t.get(e) || (n = l(p({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    d(b, {
      conf: () => f,
      language: () => m
