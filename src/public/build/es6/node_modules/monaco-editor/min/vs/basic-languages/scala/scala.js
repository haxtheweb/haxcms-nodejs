...
define("vs/basic-languages/scala/scala", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var l = t => n(t, "__esModule", {
      value: !0
    });
    var c = (t, e) => {
        for (var o in e) n(t, o, {
          get: e[o],
          enumerable: !0
        });
      },
      g = (t, e, o, a) => {
        if (e && typeof e == "object" || typeof e == "function") for (let r of i(e)) !d.call(t, r) && (o || r !== "default") && n(t, r, {
          get: () => e[r],
          enumerable: !(a = s(e, r)) || a.enumerable
        });
        return t;
      };
    var p = (t => (e, o) => t && t.get(e) || (o = g(l({}), e, 1), t && t.set(e, o), o))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var k = {};
    c(k, {
      conf: () => w,
      language: () => m
