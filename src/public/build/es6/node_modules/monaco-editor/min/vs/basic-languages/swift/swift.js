...
define("vs/basic-languages/swift/swift", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var u = (o, e) => {
      ...
      d = (o, e, t, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of s(e)) !l.call(o, n) && (t || n !== "default") && i(o, n, {
          get: () => e[n],
          enumerable: !(r = a(e, n)) || r.enumerable
        });
        return o;
      };
    var p = (o => (e, t) => o && o.get(e) || (t = d(c({}), e, 1), o && o.set(e, t), t))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    u(b, {
      conf: () => m,
      language: () => f
