...
define("vs/basic-languages/elixir/elixir", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = (t, e) => {
      ...
      m = (t, e, n, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of s(e)) !a.call(t, i) && (n || i !== "default") && o(t, i, {
          get: () => e[i],
          enumerable: !(r = l(e, i)) || r.enumerable
        });
        return t;
      };
    var u = (t => (e, n) => t && t.get(e) || (n = m(d({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var S = {};
    c(S, {
      conf: () => g,
      language: () => p
