...
define("vs/basic-languages/php/php", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var h = (t, e) => {
        for (var p in e) i(t, p, {
          get: e[p],
          enumerable: !0
        });
      },
      l = (t, e, p, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of m(e)) !a.call(t, n) && (p || n !== "default") && i(t, n, {
          get: () => e[n],
          enumerable: !(r = o(e, n)) || r.enumerable
        });
        return t;
      };
    var d = (t => (e, p) => t && t.get(e) || (p = l(s({}), e, 1), t && t.set(e, p), p))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var b = {};
    h(b, {
      conf: () => c,
      language: () => u
