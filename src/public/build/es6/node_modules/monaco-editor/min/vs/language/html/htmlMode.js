...
define("vs/language/html/htmlMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var le = n => $(n, "__esModule", {
      value: !0
    });
    var sn = (n => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(n, {
    ...
    var un = (n, t) => () => (t || n((t = {
      ...
      q = (n, t, i, r) => {
        if (t && typeof t == "object" || typeof t == "function") for (let e of rn(t)) !an.call(n, e) && (i || e !== "default") && $(n, e, {
          get: () => t[e],
          enumerable: !(r = tn(t, e)) || r.enumerable
        });
        return n;
      },
      ge = (n, t) => q(le($(n != null ? nn(on(n)) : {}, "default", !t && n && n.__esModule ? {
        get: () => n.default,
        enumerable: !0
      } : {
        value: n,
      ...
      cn = (n => (t, i) => n && n.get(t) || (i = q(le({}), t, 1), n && n.set(t, i), i))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var pe = un((Dn, fe) => {
    ...
    (function (n) {
      function t(r, e) {
        return r === Number.MAX_VALUE && (r = G.MAX_VALUE), e === Number.MAX_VALUE && (e = G.MAX_VALUE), {
          line: r,
          character: e
        };
      }
    ...
    (function (n) {
      function t(r, e, o, a) {
        if (s.uinteger(r) && s.uinteger(e) && s.uinteger(o) && s.uinteger(a)) return {
          start: x.create(r, e),
          end: x.create(o, a)
        };
        if (x.is(r) && x.is(e)) return {
          start: r,
          end: e
        };
        throw new Error("Range#create called with invalid arguments[" + r + ", " + e + ", " + o + ", " + a + "]");
      }
      n.create = t;
      function i(r) {
        var e = r;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && v.is(e.range) && (s.string(e.uri) || s.undefined(e.uri));
      }
      n.is = i;
    })(re || (re = {}));
    var he;
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && v.is(e.targetRange) && s.string(e.targetUri) && (v.is(e.targetSelectionRange) || s.undefined(e.targetSelectionRange)) && (v.is(e.originSelectionRange) || s.undefined(e.originSelectionRange));
      }
      n.is = i;
    })(he || (he = {}));
    var ie;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.string(e.label) && (s.undefined(e.textEdit) || _.is(e)) && (s.undefined(e.additionalTextEdits) || s.typedArray(e.additionalTextEdits, _.is));
      }
      n.is = i;
    })(Te || (Te = {}));
    var P;
    ...
    (function (n) {
      function t(r, e, o, a, u) {
        ...
        return s.defined(o) && (l.startCharacter = o), s.defined(a) && (l.endCharacter = a), s.defined(u) && (l.kind = u), l;
      }
      n.create = t;
      function i(r) {
        var e = r;
    ...
    (function (n) {
      function t(r, e, o, a, u, l) {
        ...
        return s.defined(o) && (f.severity = o), s.defined(a) && (f.code = a), s.defined(u) && (f.source = u), s.defined(l) && (f.relatedInformation = l), f;
      }
      n.create = t;
      function i(r) {
        var e,
          o = r;
        return s.defined(o) && v.is(o.range) && s.string(o.message) && (s.number(o.severity) || s.undefined(o.severity)) && (s.integer(o.code) || s.string(o.code) || s.undefined(o.code)) && (s.undefined(o.codeDescription) || s.string((e = o.codeDescription) === null || e === void 0 ? void 0 : e.href)) && (s.string(o.source) || s.undefined(o.source)) && (s.undefined(o.relatedInformation) || s.typedArray(o.relatedInformation, oe.is));
      }
      n.is = i;
    })(J || (J = {}));
    var L;
    ...
    (function (n) {
      function t(r, e, o) {
        ...
        return e !== void 0 && (a.needsConfirmation = e), o !== void 0 && (a.description = o), a;
      }
      n.create = t;
      function i(r) {
        var e = r;
    ...
    (function (n) {
      function t(r, e, o) {
        ...
        return e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (a.options = e), o !== void 0 && (a.annotationId = o), a;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && e.kind === "create" && s.string(e.uri) && (e.options === void 0 || (e.options.overwrite === void 0 || s.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || s.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || T.is(e.annotationId));
      }
      n.is = i;
    })(S || (S = {}));
    var F;
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return e && e.kind === "rename" && s.string(e.oldUri) && s.string(e.newUri) && (e.options === void 0 || (e.options.overwrite === void 0 || s.boolean(e.options.overwrite)) && (e.options.ignoreIfExists === void 0 || s.boolean(e.options.ignoreIfExists))) && (e.annotationId === void 0 || T.is(e.annotationId));
      }
      n.is = i;
    })(F || (F = {}));
    var M;
    (function (n) {
      function t(r, e, o) {
        ...
        return e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (a.options = e), o !== void 0 && (a.annotationId = o), a;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && e.kind === "delete" && s.string(e.uri) && (e.options === void 0 || (e.options.recursive === void 0 || s.boolean(e.options.recursive)) && (e.options.ignoreIfNotExists === void 0 || s.boolean(e.options.ignoreIfNotExists))) && (e.annotationId === void 0 || T.is(e.annotationId));
      }
      n.is = i;
    })(M || (M = {}));
    var ae;
    ...
    var Q = function () {
        ...
        return n.prototype.insert = function (t, i, r) {
          var e, o;
          if (r === void 0 ? e = _.insert(t, i) : T.is(r) ? (o = r, e = I.insert(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), o = this.changeAnnotations.manage(r), e = I.insert(t, i, o)), this.edits.push(e), o !== void 0) return o;
        }, n.prototype.replace = function (t, i, r) {
          var e, o;
          if (r === void 0 ? e = _.replace(t, i) : T.is(r) ? (o = r, e = I.replace(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), o = this.changeAnnotations.manage(r), e = I.replace(t, i, o)), this.edits.push(e), o !== void 0) return o;
        }, n.prototype.delete = function (t, i) {
          var r, e;
          if (i === void 0 ? r = _.del(t) : T.is(i) ? (e = i, r = I.del(t, i)) : (this.assertChangeAnnotations(this.changeAnnotations), e = this.changeAnnotations.manage(i), r = I.del(t, e)), this.edits.push(r), e !== void 0) return e;
      ...
      Ie = function () {
        ...
        return n.prototype.all = function () {
          ...
          var r;
          if (T.is(t) ? r = t : (r = this.nextId(), i = t), this._annotations[r] !== void 0) throw new Error("Id " + r + " is already in use.");
      ...
      Hn = function () {
        function n(t) {
          var i = this;
          this._textEditChanges = Object.create(null), t !== void 0 ? (this._workspaceEdit = t, t.documentChanges ? (this._changeAnnotations = new Ie(t.changeAnnotations), t.changeAnnotations = this._changeAnnotations.all(), t.documentChanges.forEach(function (r) {
            if (Y.is(r)) {
        ...
        return Object.defineProperty(n.prototype, "edit", {
          ...
          if (Z.is(t)) {
            ...
            if (!r) {
              ...
              this._workspaceEdit.documentChanges.push(o), r = new Q(e, this._changeAnnotations), this._textEditChanges[i.uri] = r;
            }
            return r;
          } else {
            ...
            if (!r) {
              var e = [];
              this._workspaceEdit.changes[t] = e, r = new Q(e), this._textEditChanges[t] = r;
            }
            return r;
          }
          ...
          var o, a;
          if (e === void 0 ? o = S.create(t, r) : (a = T.is(e) ? e : this._changeAnnotations.manage(e), o = S.create(t, r, a)), this._workspaceEdit.documentChanges.push(o), a !== void 0) return a;
        }, n.prototype.renameFile = function (t, i, r, e) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var o;
          R.is(r) || T.is(r) ? o = r : e = r;
          var a, u;
          if (o === void 0 ? a = F.create(t, i, e) : (u = T.is(o) ? o : this._changeAnnotations.manage(o), a = F.create(t, i, e, u)), this._workspaceEdit.documentChanges.push(a), u !== void 0) return u;
        }, n.prototype.deleteFile = function (t, i, r) {
          if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
          var e;
          R.is(i) || T.is(i) ? e = i : r = i;
          var o, a;
          if (e === void 0 ? o = M.create(t, r) : (a = T.is(e) ? e : this._changeAnnotations.manage(e), o = M.create(t, r, a)), this._workspaceEdit.documentChanges.push(o), a !== void 0) return a;
        }, n;
      }();
    var _e;
    (function (n) {
    ...
    (function (n) {
      function t(i) {
        var r = i;
        return !!r && s.objectLiteral(r) && (se.is(r.contents) || ne.is(r.contents) || s.typedArray(r.contents, ne.is)) && (i.range === void 0 || v.is(i.range));
      }
      n.is = t;
    })(De || (De = {}));
    var Le;
    ...
    (function (n) {
      function t(i, r) {
        ...
        return s.defined(r) && (a.documentation = r), s.defined(e) ? a.parameters = e : a.parameters = [], a;
      }
      n.create = t;
    })(Se || (Se = {}));
    var W;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return e && s.string(e.name) && s.number(e.kind) && v.is(e.range) && v.is(e.selectionRange) && (e.detail === void 0 || s.string(e.detail)) && (e.deprecated === void 0 || s.boolean(e.deprecated)) && (e.children === void 0 || Array.isArray(e.children)) && (e.tags === void 0 || Array.isArray(e.tags));
      }
      n.is = i;
    })(He || (He = {}));
    var Ke;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && s.typedArray(e.diagnostics, J.is) && (e.only === void 0 || s.typedArray(e.only, s.string));
      }
      n.is = i;
    })(Ue || (Ue = {}));
    var je;
    (function (n) {
      function t(r, e, o) {
        var a = {
          ...
          u = !0;
        return typeof e == "string" ? (u = !1, a.kind = e) : L.is(e) ? a.command = e : a.edit = e, u && o !== void 0 && (a.kind = o), a;
      }
      n.create = t;
      function i(r) {
        var e = r;
        return e && s.string(e.title) && (e.diagnostics === void 0 || s.typedArray(e.diagnostics, J.is)) && (e.kind === void 0 || s.string(e.kind)) && (e.edit !== void 0 || e.command !== void 0) && (e.command === void 0 || L.is(e.command)) && (e.isPreferred === void 0 || s.boolean(e.isPreferred)) && (e.edit === void 0 || ae.is(e.edit));
      }
      n.is = i;
    })(je || (je = {}));
    var Oe;
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && v.is(e.range) && (s.undefined(e.command) || L.is(e.command));
      }
      n.is = i;
    })(Oe || (Oe = {}));
    var Ne;
    ...
    (function (n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && v.is(e.range) && (s.undefined(e.target) || s.string(e.target));
      }
      n.is = i;
    })(Ve || (Ve = {}));
    var ze;
    ...
    (function (n) {
      ...
      n.is = i;
      function r(o, a) {
        for (var u = o.getText(), l = e(a, function (w, B) {
            var ce = w.range.start.line - B.range.start.line;
            return ce === 0 ? w.range.start.character - B.range.start.character : ce;
          }), f = u.length, g = l.length - 1; g >= 0; g--) {
          var h = l[g],
            k = o.offsetAt(h.range.start),
            c = o.offsetAt(h.range.end);
          if (c <= f) u = u.substring(0, k) + h.newText + u.substring(c, u.length);else throw new Error("Overlapping edit");
          f = k;
        }
        return u;
      }
    ...
    var fn = function () {
        function n(t, i, r, e) {
          this._uri = t, this._languageId = i, this._version = r, this._content = e, this._lineOffsets = void 0;
        }
...
` && e++;
      ...
      constructor(t, i, r) {
        ...
        let e = a => {
            ...
            this._listener[a.uri.toString()] = a.onDidChangeContent(() => {
              window.clearTimeout(l), l = window.setTimeout(() => this._doValidate(a.uri, u), 500);
        ...
        this._disposables.push(d.editor.onDidCreateModel(e)), this._disposables.push(d.editor.onWillDisposeModel(o)), this._disposables.push(d.editor.onDidChangeModelLanguage(a => {
          o(a.model), e(a.model);
        })), this._disposables.push(r(a => {
    ...
    var te = class {
      ...
      provideCompletionItems(t, i, r, e) {
        let o = t.uri;
        return this._worker(o).then(a => a.doComplete(o.toString(), C(i))).then(a => {
          if (!a) return;
          let u = t.getWordUntilPosition(i),
            ...
            f = a.items.map(g => {
              ...
              return g.textEdit && (vn(g.textEdit) ? h.range = {
                insert: y(g.textEdit.insert),
                replace: y(g.textEdit.replace)
              } : h.range = y(g.textEdit.range), h.insertText = g.textEdit.newText), g.additionalTextEdits && (h.additionalTextEdits = g.additionalTextEdits.map(D)), g.insertTextFormat === ee.Snippet && (h.insertTextRules = d.languages.CompletionItemInsertTextRule.InsertAsSnippet), h;
            });
          return {
    ...
    var H = class {
      ...
      provideHover(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.doHover(e.toString(), C(i))).then(o => {
          if (!!o) return {
            range: y(o.range),
...
` + n.value + "\n```\n"
    ...
    var K = class {
      ...
      provideDocumentHighlights(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.findDocumentHighlights(e.toString(), C(i))).then(o => {
          if (!!o) return o.map(a => ({
            range: y(a.range),
            kind: In(a.kind)
          }));
    ...
    var qe = class {
      ...
      provideDefinition(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.findDefinition(e.toString(), C(i))).then(o => {
          if (!!o) return [Qe(o)];
        });
      }
    };
    ...
    var Ge = class {
        ...
        provideReferences(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(a => a.findReferences(o.toString(), C(i))).then(a => {
      ...
      U = class {
        ...
        provideRenameEdits(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(a => a.doRename(o.toString(), C(i), r)).then(a => _n(a));
        }
      };
    function _n(n) {
      ...
      for (let i in n.changes) {
        let r = d.Uri.parse(i);
        for (let e of n.changes[i]) t.push({
          resource: r,
          edit: {
            range: y(e.range),
            text: e.newText
    ...
    var j = class {
      ...
      provideDocumentSymbols(t, i) {
        let r = t.uri;
        return this._worker(r).then(e => e.findDocumentSymbols(r.toString())).then(e => {
          if (!!e) return e.map(o => ({
            name: o.name,
            detail: "",
    ...
    var O = class {
        ...
        provideLinks(t, i) {
          let r = t.uri;
          return this._worker(r).then(e => e.findDocumentLinks(r.toString())).then(e => {
            if (!!e) return {
              links: e.map(o => ({
                range: y(o.range),
                url: o.target
      ...
      N = class {
        ...
        provideDocumentFormattingEdits(t, i, r) {
          let e = t.uri;
          return this._worker(e).then(o => o.format(e.toString(), null, Je(i)).then(a => {
      ...
      V = class {
        ...
        provideDocumentRangeFormattingEdits(t, i, r, e) {
          let o = t.uri;
          return this._worker(o).then(a => a.format(o.toString(), ue(i), Je(r)).then(u => {
    ...
    var Ye = class {
        ...
        provideDocumentColors(t, i) {
          let r = t.uri;
          return this._worker(r).then(e => e.findDocumentColors(r.toString())).then(e => {
            if (!!e) return e.map(o => ({
              color: o.color,
              range: y(o.range)
            }));
        ...
        provideColorPresentations(t, i, r) {
          let e = t.uri;
          return this._worker(e).then(o => o.getColorPresentations(e.toString(), i.color, ue(i.range))).then(o => {
            if (!!o) return o.map(a => {
              let u = {
                label: a.label
              };
              return a.textEdit && (u.textEdit = D(a.textEdit)), a.additionalTextEdits && (u.additionalTextEdits = a.additionalTextEdits.map(D)), u;
            });
          });
        }
      },
      z = class {
        ...
        provideFoldingRanges(t, i, r) {
          let e = t.uri;
          return this._worker(e).then(o => o.getFoldingRanges(e.toString(), i)).then(o => {
            if (!!o) return o.map(a => {
              let u = {
                start: a.startLine + 1,
                end: a.endLine + 1
    ...
    var X = class {
      ...
      provideSelectionRanges(t, i, r) {
        let e = t.uri;
        return this._worker(e).then(o => o.getSelectionRanges(e.toString(), i.map(C))).then(o => {
          if (!!o) return o.map(a => {
            let u = [];
            for (; a;) u.push({
              range: y(a.range)
