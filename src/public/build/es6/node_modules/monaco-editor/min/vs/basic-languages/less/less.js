...
define("vs/basic-languages/less/less", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var u = (t, e) => {
      ...
      c = (t, e, n, o) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of a(e)) !l.call(t, i) && (n || i !== "default") && r(t, i, {
          get: () => e[i],
          enumerable: !(o = s(e, i)) || o.enumerable
        });
        return t;
      };
    var m = (t => (e, n) => t && t.get(e) || (n = c(d({}), e, 1), t && t.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var k = {};
    u(k, {
      conf: () => g,
      language: () => p
