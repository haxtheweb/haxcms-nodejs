...
define("vs/basic-languages/sb/sb", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var c = (o, e) => {
      ...
      g = (o, e, n, s) => {
        if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !l.call(o, t) && (n || t !== "default") && r(o, t, {
          get: () => e[t],
          enumerable: !(s = i(e, t)) || s.enumerable
        });
        return o;
      };
    var p = (o => (e, n) => o && o.get(e) || (n = g(d({}), e, 1), o && o.set(e, n), n))(typeof WeakMap != "undefined" ? new WeakMap() : 0);
    var u = {};
    c(u, {
      conf: () => f,
      language: () => m
